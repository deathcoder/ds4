...
attention, routed/shared FFN, and final HC update. All layer-7 through layer-20 retained
boundaries, full attention outputs, compressor states, and full HC identities
match fresh DwarfStar processes exactly. The complete layers-0--20 command uses
1,085 dispatches and preserves 556/556 no-copy model mappings. Exactly 512 ratio-4
...
logits exactly. Layer-21 prefill, complete native batched model prefill,
