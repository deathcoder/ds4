...
Q/KV state, paired ratio-4 attention/indexer compressors, dense mixed
attention, routed/shared FFN, and final HC update. The complete layers-0--40
command uses 2,255 dispatches and preserves 1,156/1,156
...
logits exactly. Layer-41 prefill, complete native batched model prefill, eligible engine
