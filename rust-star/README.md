...
attention, routed/shared FFN, and final HC update. The complete layers-0--35
command uses 1,951 dispatches and preserves 1,004/1,004
...
logits exactly. Layer-36 prefill, complete native batched model prefill,
