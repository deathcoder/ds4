...
routed/shared FFN, and final HC update. All layer-7 through layer-19 retained
boundaries, full attention outputs, compressor states, and full HC identities
match fresh DwarfStar processes exactly. The complete layers-0--19 command uses
1,015 dispatches and preserves 524/524 no-copy model mappings. Exactly 512 ratio-4
...
logits exactly. Layer-20 prefill, complete native batched model prefill,
