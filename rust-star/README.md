...
Q/KV state, ratio-128 compressor, dense mixed attention, routed/shared FFN,
and final HC update. The complete layers-0--31 command uses 1,717 dispatches
and preserves 884/884 no-copy model mappings.
...
logits exactly. Layer-32 prefill, complete native batched model prefill,
