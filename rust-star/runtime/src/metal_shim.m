...
@property(nonatomic, strong) id<MTLComputePipelineState> routerTopkRowsBatchPipeline;
...
@property(nonatomic, strong) id<MTLBuffer> prefillLayer3AfterAttentionHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer3AfterFfnHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer4FullQ;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer4FullKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer4InputHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer4AttnSplit;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer4AttnCompressed;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer4AttnStateKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer4AttnStateScore;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer4IndexerCompressed;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer4IndexerStateKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer4IndexerStateScore;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer4AfterAttentionHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer4AfterFfnHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer5FullQ;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer5FullKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer5InputHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer5AttnSplit;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer5AttnCompressed;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer5AttnStateKv;
...
@property(nonatomic, strong) id<MTLBuffer> prefillLayer6AfterAttentionHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer6AfterFfnHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer7FullQ;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer7FullKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer7InputHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer7AttnSplit;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer7AttnCompressed;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer7AttnStateKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer7AttnStateScore;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer7AfterAttentionHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer7AfterFfnHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer8FullQ;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer8FullKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer8InputHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer8AttnSplit;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer8AttnCompressed;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer8AttnStateKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer8AttnStateScore;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer8IndexerCompressed;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer8IndexerStateKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer8IndexerStateScore;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer8AfterAttentionHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer8AfterFfnHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer9FullQ;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer9FullKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer9InputHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer9AttnSplit;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer9AttnCompressed;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer9AttnStateKv;
...
@property(nonatomic, strong) id<MTLBuffer> prefillLayer10AttnSplit;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer10AttnCompressed;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer10AttnStateKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer10AttnStateScore;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer10IndexerCompressed;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer10IndexerStateKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer10IndexerStateScore;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer10AfterAttentionHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer10AfterFfnHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer11FullQ;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer11FullKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer11InputHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer11AttnSplit;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer11AttnCompressed;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer11AttnStateKv;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer11AttnStateScore;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer11AfterAttentionHc;
@property(nonatomic, strong) id<MTLBuffer> prefillLayer11AfterFfnHc;
    ...
    size_t error_bytes)
{
    ...
    id<MTLFunction> routerTopkRowsBatch = [library newFunctionWithName:@"rust_star_router_topk_rows_batch"];
    ...
    id<MTLFunction> compressorPoolStrided =
        [library newFunctionWithName:@"rust_star_compressor_softmax_pool_strided"];
    ...
    context.compressorPoolBatchPipeline =
        [context.device newComputePipelineStateWithFunction:compressorPoolBatch
                                                       error:&compile_error];
    context.compressorPoolStridedPipeline =
        [context.device newComputePipelineStateWithFunction:compressorPoolStrided
                                                       error:&compile_error];
    ...
    context.routerTopkRowsBatchPipeline = [context.device newComputePipelineStateWithFunction:routerTopkRowsBatch error:&compile_error];
    ...
    if (!context.repeatF32Pipeline || !context.rmsNormF32Pipeline ||
        ...
        !context.routerTopkRowsBatchPipeline ||
...
typedef struct rust_star_compressor_softmax_pool_strided_args {
    int64_t ne00, ne01, ne02;
    uint64_t nb00, nb01, nb02;
    uint64_t nb10, nb11, nb12;
    int64_t ne0, ne1;
    uint64_t nb0, nb1;
} rust_star_compressor_softmax_pool_strided_args;
...
typedef struct rust_star_argsort_merge_args {
    int64_t ne00, ne01, ne02, ne03;
    uint64_t nb00, nb01, nb02, nb03;
...
static int encode_projected_compressor_batch_ratio128(
    RustStarMetalContext *context,
    id<MTLComputeCommandEncoder> encoder,
    id<MTLBuffer> projected_kv,
    id<MTLBuffer> projected_score,
    ...
    uint32_t rows)
{
    ...
    const uint32_t n_comp = rows/ratio;
    const uint64_t projected_row_bytes = (uint64_t)width*sizeof(float);
    const uint64_t projected_plane_bytes = (uint64_t)ratio*projected_row_bytes;
    const uint64_t output_row_bytes = (uint64_t)head_dim*sizeof(float);
    const uint64_t output_bytes = (uint64_t)n_comp*output_row_bytes;
    ...
    rust_star_compressor_softmax_pool_strided_args pool = {
        .ne00=ratio, .ne01=head_dim, .ne02=n_comp,
        .nb00=projected_row_bytes, .nb01=sizeof(float),
        .nb02=projected_plane_bytes,
        .nb10=projected_row_bytes, .nb11=sizeof(float),
        .nb12=projected_plane_bytes,
        .ne0=head_dim, .ne1=n_comp,
        .nb0=sizeof(float), .nb1=output_row_bytes,
    };
    [encoder setComputePipelineState:context.compressorPoolStridedPipeline];
    [encoder setBytes:&pool length:sizeof(pool) atIndex:0];
    [encoder setBuffer:projected_kv offset:0 atIndex:1];
    [encoder setBuffer:score_with_ape offset:0 atIndex:2];
    [encoder setBuffer:output offset:0 atIndex:3];
    [encoder dispatchThreadgroups:MTLSizeMake(
    ...
    rust_star_norm_args norm = {
        .ne00=head_dim, .ne00_t=head_dim/4u,
        .nb1=output_row_bytes, .nb2=output_bytes, .nb3=output_bytes,
        .eps=1.0e-6f,
        .nef1={(int32_t)n_comp,1,1}, .nef2={1,1,1}, .nef3={1,1,1},
        .nbf1={output_row_bytes,output_row_bytes,output_row_bytes},
        .nbf2={output_bytes,output_row_bytes,output_row_bytes},
        .nbf3={output_bytes,output_row_bytes,output_row_bytes},
    };
    [encoder setComputePipelineState:context.compressorNormPipeline];
    [encoder setBytes:&norm length:sizeof(norm) atIndex:0];
    ...
    rust_star_rope_tail_args rope = {
        .ne00=head_dim, .ne01=1, .ne02=n_comp, .ne03=1,
        .nb00=sizeof(float), .nb01=output_row_bytes,
        .nb02=output_row_bytes, .nb03=output_bytes,
        .nb0=sizeof(float), .nb1=output_row_bytes,
        .nb2=output_row_bytes, .nb3=output_bytes,
        .n_dims=64, .mode=0, .n_ctx_orig=65536, .inverse=0,
        .freq_base=160000.0f, .freq_scale=1.0f/16.0f,
        .ext_factor=1.0f,
        .attn_factor=1.0f/(1.0f+0.1f*logf(16.0f)),
    ...
    rust_star_fp8_quantize_args fp8 = {
        ...
        .nb02=output_row_bytes, .nb03=output_bytes,
        .nb0=sizeof(float), .nb1=output_row_bytes,
        .nb2=output_row_bytes, .nb3=output_bytes, .n_rot=64,
    };
    [encoder setComputePipelineState:context.compressorFp8Pipeline];
    [encoder setBytes:&fp8 length:sizeof(fp8) atIndex:0];
    [encoder setBuffer:output offset:0 atIndex:1];
    ...
    size_t error_bytes)
{
    if (!opaque_context || !model_mapping || !weights || !attention_output ||
        ...
        !layer3_q_lora || !layer3_q_lora_norm || !layer3_kv_raw ||
        !layer3_kv_norm || !layer3_q_raw_final_tile ||
        !layer3_q_cur_final_tile || !layer3_kv_rope || !layer3_kv_cur ||
        !layer3_attn_compressed || !layer3_attn_state_kv ||
        !layer3_attn_state_score || !layer3_kqv_out_row0 ||
        !layer3_kqv_back_row0 || !layer3_attn_low_row0 ||
        !layer3_attention_output ||
        !layer3_after_attention_hc || !layer3_after_ffn_hc ||
        !layer3_ffn_cur_final_tile || !layer3_ffn_norm_final_tile ||
        !layer3_router_selected_final_tile ||
        !layer3_router_weights_final_tile ||
        !layer3_routed_out_final_tile || !layer3_shared_out_final_tile ||
        !layer4_hc_attn_pre_final_tile || !layer4_attn_norm_final_tile ||
        !layer4_q_lora_final_tile || !layer4_q_lora_norm_final_tile ||
        !layer4_kv_raw_final_tile || !layer4_kv_norm_final_tile ||
        !layer4_q_raw_final_tile || !layer4_q_cur_final_tile ||
        !layer4_kv_rope_final_tile || !layer4_kv_cur_final_tile ||
        !layer4_attn_compressed || !layer4_attn_state_kv ||
        !layer4_attn_state_score || !layer4_indexer_compressed ||
        !layer4_indexer_state_kv || !layer4_indexer_state_score ||
        !layer4_kqv_out_row0 || !layer4_kqv_back_row0 ||
        !layer4_attn_low_row0 || !layer4_attention_output ||
        !layer4_after_attention_hc || !layer4_after_ffn_hc ||
        !layer4_ffn_cur_final_tile || !layer4_ffn_norm_final_tile ||
        !layer4_router_selected_final_tile || !layer4_router_weights_final_tile ||
        !layer4_routed_out_final_tile || !layer4_shared_out_final_tile ||
        !layer5_hc_attn_pre_final_tile || !layer5_attn_norm_final_tile ||
        !layer5_q_lora_final_tile || !layer5_q_lora_norm_final_tile ||
        !layer5_kv_raw_final_tile || !layer5_kv_norm_final_tile ||
        !layer5_q_raw_final_tile || !layer5_q_cur_final_tile ||
        !layer5_kv_rope_final_tile || !layer5_kv_cur_final_tile ||
        !layer5_attn_compressed || !layer5_attn_state_kv ||
        !layer5_attn_state_score || !layer5_kqv_out_row0 ||
        !layer5_kqv_back_row0 || !layer5_attn_low_row0 ||
        !layer5_attention_output || !layer5_after_attention_hc ||
        !layer5_after_ffn_hc || !layer5_ffn_cur_final_tile ||
        !layer5_ffn_norm_final_tile || !layer5_router_selected_final_tile ||
        !layer5_router_weights_final_tile || !layer5_routed_out_final_tile ||
        !layer5_shared_out_final_tile || !layer6_hc_attn_pre_final_tile ||
        !layer6_attn_norm_final_tile || !layer6_q_lora_final_tile ||
        ...
        !layer6_indexer_state_score || !layer6_kqv_out_row0 ||
        !layer6_kqv_back_row0 || !layer6_attn_low_row0 ||
        !layer6_attention_output || !layer6_after_attention_hc ||
        !layer6_after_ffn_hc || !layer6_ffn_cur_final_tile ||
        !layer6_ffn_norm_final_tile || !layer6_router_selected_final_tile ||
        !layer6_router_weights_final_tile || !layer6_routed_out_final_tile ||
        !layer6_shared_out_final_tile ||
        !layer7_hc_attn_pre_final_tile || !layer7_attn_norm_final_tile ||
        !layer7_q_lora_final_tile || !layer7_q_lora_norm_final_tile ||
        !layer7_kv_raw_final_tile || !layer7_kv_norm_final_tile ||
        !layer7_q_raw_final_tile || !layer7_q_cur_final_tile ||
        !layer7_kv_rope_final_tile || !layer7_kv_cur_final_tile ||
        !layer7_attn_compressed || !layer7_attn_state_kv ||
        !layer7_attn_state_score || !layer7_kqv_out_row0 ||
        !layer7_kqv_back_row0 || !layer7_attn_low_row0 ||
        !layer7_attention_output || !layer7_after_attention_hc ||
        !layer7_after_ffn_hc || !layer7_ffn_cur_final_tile ||
        !layer7_ffn_norm_final_tile || !layer7_router_selected_final_tile ||
        !layer7_router_weights_final_tile || !layer7_routed_out_final_tile ||
        !layer7_shared_out_final_tile ||
        !layer8_hc_attn_pre_final_tile || !layer8_attn_norm_final_tile ||
        !layer8_q_lora_final_tile || !layer8_q_lora_norm_final_tile ||
        !layer8_kv_raw_final_tile || !layer8_kv_norm_final_tile ||
        !layer8_q_raw_final_tile || !layer8_q_cur_final_tile ||
        !layer8_kv_rope_final_tile || !layer8_kv_cur_final_tile ||
        !layer8_attn_compressed || !layer8_attn_state_kv ||
        !layer8_attn_state_score || !layer8_indexer_compressed ||
        !layer8_indexer_state_kv || !layer8_indexer_state_score ||
        !layer8_kqv_out_row0 || !layer8_kqv_back_row0 ||
        !layer8_attn_low_row0 || !layer8_attention_output ||
        !layer8_after_attention_hc || !layer8_after_ffn_hc ||
        !layer8_ffn_cur_final_tile || !layer8_ffn_norm_final_tile ||
        !layer8_router_selected_final_tile ||
        !layer8_router_weights_final_tile || !layer8_routed_out_final_tile ||
        !layer8_shared_out_final_tile ||
        !layer9_hc_attn_pre_final_tile || !layer9_attn_norm_final_tile ||
        !layer9_q_lora_final_tile || !layer9_q_lora_norm_final_tile ||
        !layer9_kv_raw_final_tile || !layer9_kv_norm_final_tile ||
        !layer9_q_raw_final_tile || !layer9_q_cur_final_tile ||
        !layer9_kv_rope_final_tile || !layer9_kv_cur_final_tile ||
        !layer9_attn_compressed || !layer9_attn_state_kv ||
        !layer9_attn_state_score || !layer9_kqv_out_row0 ||
        !layer9_kqv_back_row0 || !layer9_attn_low_row0 ||
        !layer9_attention_output || !layer9_after_attention_hc ||
        !layer9_after_ffn_hc || !layer9_ffn_cur_final_tile ||
        !layer9_ffn_norm_final_tile || !layer9_router_selected_final_tile ||
        !layer9_router_weights_final_tile || !layer9_routed_out_final_tile ||
        !layer9_shared_out_final_tile ||
        !layer10_hc_attn_pre_final_tile || !layer10_attn_norm_final_tile ||
        !layer10_q_lora_final_tile || !layer10_q_lora_norm_final_tile ||
        !layer10_kv_raw_final_tile || !layer10_kv_norm_final_tile ||
        !layer10_q_raw_final_tile || !layer10_q_cur_final_tile ||
        !layer10_kv_rope_final_tile || !layer10_kv_cur_final_tile ||
        !layer10_attn_compressed || !layer10_attn_state_kv ||
        !layer10_attn_state_score || !layer10_indexer_compressed ||
        !layer10_indexer_state_kv || !layer10_indexer_state_score ||
        !layer10_kqv_out_row0 || !layer10_kqv_back_row0 ||
        !layer10_attn_low_row0 || !layer10_attention_output ||
        !layer10_after_attention_hc || !layer10_after_ffn_hc ||
        !layer10_ffn_cur_final_tile || !layer10_ffn_norm_final_tile ||
        !layer10_router_selected_final_tile ||
        !layer10_router_weights_final_tile || !layer10_routed_out_final_tile ||
        !layer10_shared_out_final_tile ||
        !layer11_hc_attn_pre_final_tile || !layer11_attn_norm_final_tile ||
        !layer11_q_lora_final_tile || !layer11_q_lora_norm_final_tile ||
        !layer11_kv_raw_final_tile || !layer11_kv_norm_final_tile ||
        !layer11_q_raw_final_tile || !layer11_q_cur_final_tile ||
        !layer11_kv_rope_final_tile || !layer11_kv_cur_final_tile ||
        !layer11_attn_compressed || !layer11_attn_state_kv ||
        !layer11_attn_state_score || !layer11_kqv_out_row0 ||
        !layer11_kqv_back_row0 || !layer11_attn_low_row0 ||
        !layer11_attention_output || !layer11_after_attention_hc ||
        !layer11_after_ffn_hc || !layer11_ffn_cur_final_tile ||
        !layer11_ffn_norm_final_tile || !layer11_router_selected_final_tile ||
        !layer11_router_weights_final_tile || !layer11_routed_out_final_tile ||
        !layer11_shared_out_final_tile ||
        !result) {
        return fail_with_message(error, error_bytes,
    ...
    @autoreleasepool {
        ...
        if (weights->q_b_bytes !=
            ...
            weights->layer3_kvnorm.ingress.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer3_kvnorm.ingress.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer3_kvnorm.ingress.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer3_kvnorm.ingress.norm_bytes != n_embd*sizeof(float) ||
            weights->layer3_kvnorm.ingress.q_a_bytes !=
                1024ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer3_kvnorm.q_a_norm_bytes != 1024u*sizeof(float) ||
            weights->layer3_kvnorm.kv_bytes !=
                512ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer3_kvnorm.kv_norm_bytes != 512u*sizeof(float) ||
            weights->layer3_q_b_bytes !=
                (uint64_t)q_dim*(1024u/32u)*34u ||
            weights->layer3_compressor.attn_ape_bytes !=
                (uint64_t)layer3_compressor_ratio*layer3_compressor_width*
                    sizeof(uint16_t) ||
            weights->layer3_compressor.attn_kv_bytes !=
                (uint64_t)n_embd*layer3_compressor_width*sizeof(uint16_t) ||
            weights->layer3_compressor.attn_gate_bytes !=
                (uint64_t)n_embd*layer3_compressor_width*sizeof(uint16_t) ||
            weights->layer3_compressor.attn_norm_bytes !=
                layer3_compressor_width*sizeof(float) ||
            weights->layer3_attn_sinks_bytes != n_head*sizeof(float) ||
            weights->layer3_attn_output_a_bytes !=
                8ull*output_rank*((uint64_t)n_embd/32u)*34u ||
            weights->layer3_attn_output_b_bytes !=
                (uint64_t)n_embd*((uint64_t)(8u*output_rank)/32u)*34u ||
            weights->layer3_ffn.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer3_ffn.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer3_ffn.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer3_ffn.norm_bytes != n_embd*sizeof(float) ||
            weights->layer3_ffn.router_gate_bytes !=
                (uint64_t)n_embd*256u*sizeof(uint16_t) ||
            weights->layer3_ffn.router_hash_bytes != 256u*sizeof(float) ||
            weights->layer3_ffn.routed_gate_bytes != 256ull*2048ull*1056ull ||
            weights->layer3_ffn.routed_up_bytes != 256ull*2048ull*1056ull ||
            weights->layer3_ffn.routed_down_bytes != 256ull*n_embd*672ull ||
            weights->layer3_ffn.shared_gate_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer3_ffn.shared_up_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer3_ffn.shared_down_bytes !=
                n_embd*(2048u/32u)*34u ||
            weights->layer4_kvnorm.ingress.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer4_kvnorm.ingress.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer4_kvnorm.ingress.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer4_kvnorm.ingress.norm_bytes != n_embd*sizeof(float) ||
            weights->layer4_kvnorm.ingress.q_a_bytes !=
                1024ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer4_kvnorm.q_a_norm_bytes != 1024u*sizeof(float) ||
            weights->layer4_kvnorm.kv_bytes !=
                512ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer4_kvnorm.kv_norm_bytes != 512u*sizeof(float) ||
            weights->layer4_q_b_bytes !=
                (uint64_t)q_dim*(1024u/32u)*34u ||
            weights->layer4_compressor.attn_ape_bytes !=
                4ull*layer4_attn_compressor_width*sizeof(uint16_t) ||
            weights->layer4_compressor.attn_kv_bytes !=
                (uint64_t)n_embd*layer4_attn_compressor_width*sizeof(uint16_t) ||
            weights->layer4_compressor.attn_gate_bytes !=
                (uint64_t)n_embd*layer4_attn_compressor_width*sizeof(uint16_t) ||
            weights->layer4_compressor.attn_norm_bytes !=
                layer4_attn_compressor_head*sizeof(float) ||
            weights->layer4_compressor.indexer_ape_bytes !=
                4ull*layer4_indexer_compressor_width*sizeof(uint16_t) ||
            weights->layer4_compressor.indexer_kv_bytes !=
                (uint64_t)n_embd*layer4_indexer_compressor_width*sizeof(uint16_t) ||
            weights->layer4_compressor.indexer_gate_bytes !=
                (uint64_t)n_embd*layer4_indexer_compressor_width*sizeof(uint16_t) ||
            weights->layer4_compressor.indexer_norm_bytes !=
                layer4_indexer_compressor_head*sizeof(float) ||
            weights->layer4_attn_sinks_bytes != n_head*sizeof(float) ||
            weights->layer4_attn_output_a_bytes !=
                8ull*output_rank*((uint64_t)n_embd/32u)*34u ||
            weights->layer4_attn_output_b_bytes !=
                (uint64_t)n_embd*((uint64_t)(8u*output_rank)/32u)*34u ||
            weights->layer4_ffn.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer4_ffn.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer4_ffn.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer4_ffn.norm_bytes != n_embd*sizeof(float) ||
            weights->layer4_ffn.router_gate_bytes !=
                (uint64_t)n_embd*256u*sizeof(uint16_t) ||
            weights->layer4_ffn.router_hash_bytes != 256u*sizeof(float) ||
            weights->layer4_ffn.routed_gate_bytes != 256ull*2048ull*1056ull ||
            weights->layer4_ffn.routed_up_bytes != 256ull*2048ull*1056ull ||
            weights->layer4_ffn.routed_down_bytes != 256ull*n_embd*672ull ||
            weights->layer4_ffn.shared_gate_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer4_ffn.shared_up_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer4_ffn.shared_down_bytes !=
                n_embd*(2048u/32u)*34u ||
            weights->layer5_kvnorm.ingress.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer5_kvnorm.ingress.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer5_kvnorm.ingress.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer5_kvnorm.ingress.norm_bytes != n_embd*sizeof(float) ||
            weights->layer5_kvnorm.ingress.q_a_bytes !=
                1024ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer5_kvnorm.q_a_norm_bytes != 1024u*sizeof(float) ||
            weights->layer5_kvnorm.kv_bytes !=
                512ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer5_kvnorm.kv_norm_bytes != 512u*sizeof(float) ||
            weights->layer5_q_b_bytes !=
                (uint64_t)q_dim*(1024u/32u)*34u ||
            weights->layer5_compressor.attn_ape_bytes !=
                (uint64_t)layer3_compressor_ratio*layer3_compressor_width*
                    sizeof(uint16_t) ||
            weights->layer5_compressor.attn_kv_bytes !=
                (uint64_t)n_embd*layer3_compressor_width*sizeof(uint16_t) ||
            weights->layer5_compressor.attn_gate_bytes !=
                (uint64_t)n_embd*layer3_compressor_width*sizeof(uint16_t) ||
            weights->layer5_compressor.attn_norm_bytes !=
                layer3_compressor_width*sizeof(float) ||
            weights->layer5_attn_sinks_bytes != n_head*sizeof(float) ||
            weights->layer5_attn_output_a_bytes !=
                8ull*output_rank*((uint64_t)n_embd/32u)*34u ||
            weights->layer5_attn_output_b_bytes !=
                (uint64_t)n_embd*((uint64_t)(8u*output_rank)/32u)*34u ||
            weights->layer5_ffn.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer5_ffn.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer5_ffn.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer5_ffn.norm_bytes != n_embd*sizeof(float) ||
            weights->layer5_ffn.router_gate_bytes !=
                (uint64_t)n_embd*256u*sizeof(uint16_t) ||
            weights->layer5_ffn.router_hash_bytes != 256u*sizeof(float) ||
            weights->layer5_ffn.routed_gate_bytes != 256ull*2048ull*1056ull ||
            weights->layer5_ffn.routed_up_bytes != 256ull*2048ull*1056ull ||
            weights->layer5_ffn.routed_down_bytes != 256ull*n_embd*672ull ||
            weights->layer5_ffn.shared_gate_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer5_ffn.shared_up_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer5_ffn.shared_down_bytes !=
                n_embd*(2048u/32u)*34u ||
            weights->layer6_kvnorm.ingress.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer6_kvnorm.ingress.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer6_kvnorm.ingress.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer6_kvnorm.ingress.norm_bytes != n_embd*sizeof(float) ||
            weights->layer6_kvnorm.ingress.q_a_bytes !=
                1024ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer6_kvnorm.q_a_norm_bytes != 1024u*sizeof(float) ||
            ...
            weights->layer6_compressor.indexer_norm_bytes !=
                layer4_indexer_compressor_head*sizeof(float) ||
            weights->layer6_attn_sinks_bytes != n_head*sizeof(float) ||
            weights->layer6_attn_output_a_bytes !=
                8ull*output_rank*((uint64_t)n_embd/32u)*34u ||
            weights->layer6_attn_output_b_bytes !=
                (uint64_t)n_embd*((uint64_t)(8u*output_rank)/32u)*34u ||
            weights->layer6_ffn.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer6_ffn.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer6_ffn.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer6_ffn.norm_bytes != n_embd*sizeof(float) ||
            weights->layer6_ffn.router_gate_bytes !=
                (uint64_t)n_embd*256u*sizeof(uint16_t) ||
            weights->layer6_ffn.router_hash_bytes != 256u*sizeof(float) ||
            weights->layer6_ffn.routed_gate_bytes != 256ull*2048ull*1056ull ||
            weights->layer6_ffn.routed_up_bytes != 256ull*2048ull*1056ull ||
            weights->layer6_ffn.routed_down_bytes != 256ull*n_embd*672ull ||
            weights->layer6_ffn.shared_gate_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer6_ffn.shared_up_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer6_ffn.shared_down_bytes !=
                n_embd*(2048u/32u)*34u ||
            weights->layer7_kvnorm.ingress.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer7_kvnorm.ingress.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer7_kvnorm.ingress.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer7_kvnorm.ingress.norm_bytes != n_embd*sizeof(float) ||
            weights->layer7_kvnorm.ingress.q_a_bytes !=
                1024ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer7_kvnorm.q_a_norm_bytes != 1024u*sizeof(float) ||
            weights->layer7_kvnorm.kv_bytes !=
                512ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer7_kvnorm.kv_norm_bytes != 512u*sizeof(float) ||
            weights->layer7_q_b_bytes !=
                (uint64_t)q_dim*(1024u/32u)*34u ||
            weights->layer7_compressor.attn_ape_bytes !=
                (uint64_t)layer3_compressor_ratio*layer3_compressor_width*
                    sizeof(uint16_t) ||
            weights->layer7_compressor.attn_kv_bytes !=
                (uint64_t)n_embd*layer3_compressor_width*sizeof(uint16_t) ||
            weights->layer7_compressor.attn_gate_bytes !=
                (uint64_t)n_embd*layer3_compressor_width*sizeof(uint16_t) ||
            weights->layer7_compressor.attn_norm_bytes !=
                layer3_compressor_width*sizeof(float) ||
            weights->layer7_attn_sinks_bytes != n_head*sizeof(float) ||
            weights->layer7_attn_output_a_bytes !=
                8ull*output_rank*((uint64_t)n_embd/32u)*34u ||
            weights->layer7_attn_output_b_bytes !=
                (uint64_t)n_embd*((uint64_t)(8u*output_rank)/32u)*34u ||
            weights->layer7_ffn.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer7_ffn.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer7_ffn.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer7_ffn.norm_bytes != n_embd*sizeof(float) ||
            weights->layer7_ffn.router_gate_bytes !=
                (uint64_t)n_embd*256u*sizeof(uint16_t) ||
            weights->layer7_ffn.router_hash_bytes != 256u*sizeof(float) ||
            weights->layer7_ffn.routed_gate_bytes != 256ull*2048ull*1056ull ||
            weights->layer7_ffn.routed_up_bytes != 256ull*2048ull*1056ull ||
            weights->layer7_ffn.routed_down_bytes != 256ull*n_embd*672ull ||
            weights->layer7_ffn.shared_gate_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer7_ffn.shared_up_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer7_ffn.shared_down_bytes !=
                n_embd*(2048u/32u)*34u ||
            weights->layer8_kvnorm.ingress.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer8_kvnorm.ingress.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer8_kvnorm.ingress.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer8_kvnorm.ingress.norm_bytes != n_embd*sizeof(float) ||
            weights->layer8_kvnorm.ingress.q_a_bytes !=
                1024ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer8_kvnorm.q_a_norm_bytes != 1024u*sizeof(float) ||
            weights->layer8_kvnorm.kv_bytes !=
                512ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer8_kvnorm.kv_norm_bytes != 512u*sizeof(float) ||
            weights->layer8_q_b_bytes !=
                (uint64_t)q_dim*(1024u/32u)*34u ||
            weights->layer8_compressor.attn_ape_bytes !=
                4ull*layer4_attn_compressor_width*sizeof(uint16_t) ||
            weights->layer8_compressor.attn_kv_bytes !=
                (uint64_t)n_embd*layer4_attn_compressor_width*sizeof(uint16_t) ||
            weights->layer8_compressor.attn_gate_bytes !=
                (uint64_t)n_embd*layer4_attn_compressor_width*sizeof(uint16_t) ||
            weights->layer8_compressor.attn_norm_bytes !=
                layer4_attn_compressor_head*sizeof(float) ||
            weights->layer8_compressor.indexer_ape_bytes !=
                4ull*layer4_indexer_compressor_width*sizeof(uint16_t) ||
            weights->layer8_compressor.indexer_kv_bytes !=
                (uint64_t)n_embd*layer4_indexer_compressor_width*sizeof(uint16_t) ||
            weights->layer8_compressor.indexer_gate_bytes !=
                (uint64_t)n_embd*layer4_indexer_compressor_width*sizeof(uint16_t) ||
            weights->layer8_compressor.indexer_norm_bytes !=
                layer4_indexer_compressor_head*sizeof(float) ||
            weights->layer8_attn_sinks_bytes != n_head*sizeof(float) ||
            weights->layer8_attn_output_a_bytes !=
                8ull*output_rank*((uint64_t)n_embd/32u)*34u ||
            weights->layer8_attn_output_b_bytes !=
                (uint64_t)n_embd*((uint64_t)(8u*output_rank)/32u)*34u ||
            weights->layer8_ffn.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer8_ffn.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer8_ffn.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer8_ffn.norm_bytes != n_embd*sizeof(float) ||
            weights->layer8_ffn.router_gate_bytes !=
                (uint64_t)n_embd*256u*sizeof(uint16_t) ||
            weights->layer8_ffn.router_hash_bytes != 256u*sizeof(float) ||
            weights->layer8_ffn.routed_gate_bytes != 256ull*2048ull*1056ull ||
            weights->layer8_ffn.routed_up_bytes != 256ull*2048ull*1056ull ||
            weights->layer8_ffn.routed_down_bytes != 256ull*n_embd*672ull ||
            weights->layer8_ffn.shared_gate_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer8_ffn.shared_up_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer8_ffn.shared_down_bytes !=
                n_embd*(2048u/32u)*34u ||
            weights->layer9_kvnorm.ingress.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer9_kvnorm.ingress.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer9_kvnorm.ingress.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer9_kvnorm.ingress.norm_bytes != n_embd*sizeof(float) ||
            weights->layer9_kvnorm.ingress.q_a_bytes !=
                1024ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer9_kvnorm.q_a_norm_bytes != 1024u*sizeof(float) ||
            weights->layer9_kvnorm.kv_bytes !=
                512ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer9_kvnorm.kv_norm_bytes != 512u*sizeof(float) ||
            weights->layer9_q_b_bytes !=
                (uint64_t)q_dim*(1024u/32u)*34u ||
            weights->layer9_compressor.attn_ape_bytes !=
                (uint64_t)layer3_compressor_ratio*layer3_compressor_width*
                    sizeof(uint16_t) ||
            weights->layer9_compressor.attn_kv_bytes !=
                (uint64_t)n_embd*layer3_compressor_width*sizeof(uint16_t) ||
            weights->layer9_compressor.attn_gate_bytes !=
                (uint64_t)n_embd*layer3_compressor_width*sizeof(uint16_t) ||
            weights->layer9_compressor.attn_norm_bytes !=
                layer3_compressor_width*sizeof(float) ||
            weights->layer9_attn_sinks_bytes != n_head*sizeof(float) ||
            weights->layer9_attn_output_a_bytes !=
                8ull*output_rank*((uint64_t)n_embd/32u)*34u ||
            weights->layer9_attn_output_b_bytes !=
                (uint64_t)n_embd*((uint64_t)(8u*output_rank)/32u)*34u ||
            weights->layer9_ffn.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer9_ffn.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer9_ffn.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer9_ffn.norm_bytes != n_embd*sizeof(float) ||
            weights->layer9_ffn.router_gate_bytes !=
                (uint64_t)n_embd*256u*sizeof(uint16_t) ||
            weights->layer9_ffn.router_hash_bytes != 256u*sizeof(float) ||
            weights->layer9_ffn.routed_gate_bytes != 256ull*2048ull*1056ull ||
            weights->layer9_ffn.routed_up_bytes != 256ull*2048ull*1056ull ||
            weights->layer9_ffn.routed_down_bytes != 256ull*n_embd*672ull ||
            weights->layer9_ffn.shared_gate_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer9_ffn.shared_up_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer9_ffn.shared_down_bytes !=
                n_embd*(2048u/32u)*34u ||
            weights->layer10_kvnorm.ingress.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer10_kvnorm.ingress.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer10_kvnorm.ingress.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer10_kvnorm.ingress.norm_bytes != n_embd*sizeof(float) ||
            weights->layer10_kvnorm.ingress.q_a_bytes !=
                1024ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer10_kvnorm.q_a_norm_bytes != 1024u*sizeof(float) ||
            weights->layer10_kvnorm.kv_bytes !=
                512ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer10_kvnorm.kv_norm_bytes != 512u*sizeof(float) ||
            weights->layer10_q_b_bytes !=
                (uint64_t)q_dim*(1024u/32u)*34u ||
            weights->layer10_compressor.attn_ape_bytes !=
                4ull*layer4_attn_compressor_width*sizeof(uint16_t) ||
            weights->layer10_compressor.attn_kv_bytes !=
                (uint64_t)n_embd*layer4_attn_compressor_width*sizeof(uint16_t) ||
            weights->layer10_compressor.attn_gate_bytes !=
                (uint64_t)n_embd*layer4_attn_compressor_width*sizeof(uint16_t) ||
            weights->layer10_compressor.attn_norm_bytes !=
                layer4_attn_compressor_head*sizeof(float) ||
            weights->layer10_compressor.indexer_ape_bytes !=
                4ull*layer4_indexer_compressor_width*sizeof(uint16_t) ||
            weights->layer10_compressor.indexer_kv_bytes !=
                (uint64_t)n_embd*layer4_indexer_compressor_width*sizeof(uint16_t) ||
            weights->layer10_compressor.indexer_gate_bytes !=
                (uint64_t)n_embd*layer4_indexer_compressor_width*sizeof(uint16_t) ||
            weights->layer10_compressor.indexer_norm_bytes !=
                layer4_indexer_compressor_head*sizeof(float) ||
            weights->layer10_attn_sinks_bytes != n_head*sizeof(float) ||
            weights->layer10_attn_output_a_bytes !=
                8ull*output_rank*((uint64_t)n_embd/32u)*34u ||
            weights->layer10_attn_output_b_bytes !=
                (uint64_t)n_embd*((uint64_t)(8u*output_rank)/32u)*34u ||
            weights->layer10_ffn.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer10_ffn.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer10_ffn.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer10_ffn.norm_bytes != n_embd*sizeof(float) ||
            weights->layer10_ffn.router_gate_bytes !=
                (uint64_t)n_embd*256u*sizeof(uint16_t) ||
            weights->layer10_ffn.router_hash_bytes != 256u*sizeof(float) ||
            weights->layer10_ffn.routed_gate_bytes != 256ull*2048ull*1056ull ||
            weights->layer10_ffn.routed_up_bytes != 256ull*2048ull*1056ull ||
            weights->layer10_ffn.routed_down_bytes != 256ull*n_embd*672ull ||
            weights->layer10_ffn.shared_gate_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer10_ffn.shared_up_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer10_ffn.shared_down_bytes !=
                n_embd*(2048u/32u)*34u ||
            weights->layer11_kvnorm.ingress.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer11_kvnorm.ingress.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer11_kvnorm.ingress.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer11_kvnorm.ingress.norm_bytes != n_embd*sizeof(float) ||
            weights->layer11_kvnorm.ingress.q_a_bytes !=
                1024ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer11_kvnorm.q_a_norm_bytes != 1024u*sizeof(float) ||
            weights->layer11_kvnorm.kv_bytes !=
                512ull*((uint64_t)n_embd/32u)*34u ||
            weights->layer11_kvnorm.kv_norm_bytes != 512u*sizeof(float) ||
            weights->layer11_q_b_bytes !=
                (uint64_t)q_dim*(1024u/32u)*34u ||
            weights->layer11_compressor.attn_ape_bytes !=
                (uint64_t)layer3_compressor_ratio*layer3_compressor_width*
                    sizeof(uint16_t) ||
            weights->layer11_compressor.attn_kv_bytes !=
                (uint64_t)n_embd*layer3_compressor_width*sizeof(uint16_t) ||
            weights->layer11_compressor.attn_gate_bytes !=
                (uint64_t)n_embd*layer3_compressor_width*sizeof(uint16_t) ||
            weights->layer11_compressor.attn_norm_bytes !=
                layer3_compressor_width*sizeof(float) ||
            weights->layer11_attn_sinks_bytes != n_head*sizeof(float) ||
            weights->layer11_attn_output_a_bytes !=
                8ull*output_rank*((uint64_t)n_embd/32u)*34u ||
            weights->layer11_attn_output_b_bytes !=
                (uint64_t)n_embd*((uint64_t)(8u*output_rank)/32u)*34u ||
            weights->layer11_ffn.hc_fn_bytes !=
                16384ull*24ull*sizeof(uint16_t) ||
            weights->layer11_ffn.hc_scale_bytes != 3u*sizeof(float) ||
            weights->layer11_ffn.hc_base_bytes != 24u*sizeof(float) ||
            weights->layer11_ffn.norm_bytes != n_embd*sizeof(float) ||
            weights->layer11_ffn.router_gate_bytes !=
                (uint64_t)n_embd*256u*sizeof(uint16_t) ||
            weights->layer11_ffn.router_hash_bytes != 256u*sizeof(float) ||
            weights->layer11_ffn.routed_gate_bytes != 256ull*2048ull*1056ull ||
            weights->layer11_ffn.routed_up_bytes != 256ull*2048ull*1056ull ||
            weights->layer11_ffn.routed_down_bytes != 256ull*n_embd*672ull ||
            weights->layer11_ffn.shared_gate_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer11_ffn.shared_up_bytes !=
                2048ull*(n_embd/32u)*34u ||
            weights->layer11_ffn.shared_down_bytes !=
                n_embd*(2048u/32u)*34u
        ...
        uint64_t offsets[284] = {
            ...
            weights->ffn.routed_down_offset, weights->ffn.shared_gate_offset,
            weights->ffn.shared_up_offset, weights->ffn.shared_down_offset,
            weights->layer3_kvnorm.ingress.hc_fn_offset,
            weights->layer3_kvnorm.ingress.hc_scale_offset,
            weights->layer3_kvnorm.ingress.hc_base_offset,
            weights->layer3_kvnorm.ingress.norm_offset,
            weights->layer3_kvnorm.ingress.q_a_offset,
            weights->layer3_kvnorm.q_a_norm_offset,
            weights->layer3_kvnorm.kv_offset,
            weights->layer3_kvnorm.kv_norm_offset,
            weights->layer3_q_b_offset,
            weights->layer3_compressor.attn_ape_offset,
            weights->layer3_compressor.attn_kv_offset,
            weights->layer3_compressor.attn_gate_offset,
            weights->layer3_compressor.attn_norm_offset,
            weights->layer3_attn_sinks_offset,
            weights->layer3_attn_output_a_offset,
            weights->layer3_attn_output_b_offset,
            weights->layer3_ffn.hc_fn_offset,
            weights->layer3_ffn.hc_scale_offset,
            weights->layer3_ffn.hc_base_offset,
            weights->layer3_ffn.norm_offset,
            weights->layer3_ffn.router_gate_offset,
            weights->layer3_ffn.router_hash_offset,
            weights->layer3_ffn.routed_gate_offset,
            weights->layer3_ffn.routed_up_offset,
            weights->layer3_ffn.routed_down_offset,
            weights->layer3_ffn.shared_gate_offset,
            weights->layer3_ffn.shared_up_offset,
            weights->layer3_ffn.shared_down_offset,
            weights->layer4_kvnorm.ingress.hc_fn_offset,
            weights->layer4_kvnorm.ingress.hc_scale_offset,
            weights->layer4_kvnorm.ingress.hc_base_offset,
            weights->layer4_kvnorm.ingress.norm_offset,
            weights->layer4_kvnorm.ingress.q_a_offset,
            weights->layer4_kvnorm.q_a_norm_offset,
            weights->layer4_kvnorm.kv_offset,
            weights->layer4_kvnorm.kv_norm_offset,
            weights->layer4_q_b_offset,
            weights->layer4_compressor.attn_ape_offset,
            weights->layer4_compressor.attn_kv_offset,
            weights->layer4_compressor.attn_gate_offset,
            weights->layer4_compressor.attn_norm_offset,
            weights->layer4_compressor.indexer_ape_offset,
            weights->layer4_compressor.indexer_kv_offset,
            weights->layer4_compressor.indexer_gate_offset,
            weights->layer4_compressor.indexer_norm_offset,
            weights->layer4_attn_sinks_offset,
            weights->layer4_attn_output_a_offset,
            weights->layer4_attn_output_b_offset,
            weights->layer4_ffn.hc_fn_offset,
            weights->layer4_ffn.hc_scale_offset,
            weights->layer4_ffn.hc_base_offset,
            weights->layer4_ffn.norm_offset,
            weights->layer4_ffn.router_gate_offset,
            weights->layer4_ffn.router_hash_offset,
            weights->layer4_ffn.routed_gate_offset,
            weights->layer4_ffn.routed_up_offset,
            weights->layer4_ffn.routed_down_offset,
            weights->layer4_ffn.shared_gate_offset,
            weights->layer4_ffn.shared_up_offset,
            weights->layer4_ffn.shared_down_offset,
            weights->layer5_kvnorm.ingress.hc_fn_offset,
            weights->layer5_kvnorm.ingress.hc_scale_offset,
            weights->layer5_kvnorm.ingress.hc_base_offset,
            weights->layer5_kvnorm.ingress.norm_offset,
            weights->layer5_kvnorm.ingress.q_a_offset,
            weights->layer5_kvnorm.q_a_norm_offset,
            weights->layer5_kvnorm.kv_offset,
            weights->layer5_kvnorm.kv_norm_offset,
            weights->layer5_q_b_offset,
            weights->layer5_compressor.attn_ape_offset,
            weights->layer5_compressor.attn_kv_offset,
            weights->layer5_compressor.attn_gate_offset,
            weights->layer5_compressor.attn_norm_offset,
            weights->layer5_attn_sinks_offset,
            weights->layer5_attn_output_a_offset,
            weights->layer5_attn_output_b_offset,
            weights->layer5_ffn.hc_fn_offset,
            weights->layer5_ffn.hc_scale_offset,
            weights->layer5_ffn.hc_base_offset,
            weights->layer5_ffn.norm_offset,
            weights->layer5_ffn.router_gate_offset,
            weights->layer5_ffn.router_hash_offset,
            weights->layer5_ffn.routed_gate_offset,
            weights->layer5_ffn.routed_up_offset,
            weights->layer5_ffn.routed_down_offset,
            weights->layer5_ffn.shared_gate_offset,
            weights->layer5_ffn.shared_up_offset,
            weights->layer5_ffn.shared_down_offset,
            weights->layer6_kvnorm.ingress.hc_fn_offset,
            weights->layer6_kvnorm.ingress.hc_scale_offset,
            weights->layer6_kvnorm.ingress.hc_base_offset,
            weights->layer6_kvnorm.ingress.norm_offset,
            weights->layer6_kvnorm.ingress.q_a_offset,
            weights->layer6_kvnorm.q_a_norm_offset,
            ...
            weights->layer6_attn_sinks_offset,
            weights->layer6_attn_output_a_offset,
            weights->layer6_attn_output_b_offset,
            weights->layer6_ffn.hc_fn_offset,
            weights->layer6_ffn.hc_scale_offset,
            weights->layer6_ffn.hc_base_offset,
            weights->layer6_ffn.norm_offset,
            weights->layer6_ffn.router_gate_offset,
            weights->layer6_ffn.router_hash_offset,
            weights->layer6_ffn.routed_gate_offset,
            weights->layer6_ffn.routed_up_offset,
            weights->layer6_ffn.routed_down_offset,
            weights->layer6_ffn.shared_gate_offset,
            weights->layer6_ffn.shared_up_offset,
            weights->layer6_ffn.shared_down_offset,
            weights->layer7_kvnorm.ingress.hc_fn_offset,
            weights->layer7_kvnorm.ingress.hc_scale_offset,
            weights->layer7_kvnorm.ingress.hc_base_offset,
            weights->layer7_kvnorm.ingress.norm_offset,
            weights->layer7_kvnorm.ingress.q_a_offset,
            weights->layer7_kvnorm.q_a_norm_offset,
            weights->layer7_kvnorm.kv_offset,
            weights->layer7_kvnorm.kv_norm_offset,
            weights->layer7_q_b_offset,
            weights->layer7_compressor.attn_ape_offset,
            weights->layer7_compressor.attn_kv_offset,
            weights->layer7_compressor.attn_gate_offset,
            weights->layer7_compressor.attn_norm_offset,
            weights->layer7_attn_sinks_offset,
            weights->layer7_attn_output_a_offset,
            weights->layer7_attn_output_b_offset,
            weights->layer7_ffn.hc_fn_offset,
            weights->layer7_ffn.hc_scale_offset,
            weights->layer7_ffn.hc_base_offset,
            weights->layer7_ffn.norm_offset,
            weights->layer7_ffn.router_gate_offset,
            weights->layer7_ffn.router_hash_offset,
            weights->layer7_ffn.routed_gate_offset,
            weights->layer7_ffn.routed_up_offset,
            weights->layer7_ffn.routed_down_offset,
            weights->layer7_ffn.shared_gate_offset,
            weights->layer7_ffn.shared_up_offset,
            weights->layer7_ffn.shared_down_offset,
            weights->layer8_kvnorm.ingress.hc_fn_offset,
            weights->layer8_kvnorm.ingress.hc_scale_offset,
            weights->layer8_kvnorm.ingress.hc_base_offset,
            weights->layer8_kvnorm.ingress.norm_offset,
            weights->layer8_kvnorm.ingress.q_a_offset,
            weights->layer8_kvnorm.q_a_norm_offset,
            weights->layer8_kvnorm.kv_offset,
            weights->layer8_kvnorm.kv_norm_offset,
            weights->layer8_q_b_offset,
            weights->layer8_compressor.attn_ape_offset,
            weights->layer8_compressor.attn_kv_offset,
            weights->layer8_compressor.attn_gate_offset,
            weights->layer8_compressor.attn_norm_offset,
            weights->layer8_compressor.indexer_ape_offset,
            weights->layer8_compressor.indexer_kv_offset,
            weights->layer8_compressor.indexer_gate_offset,
            weights->layer8_compressor.indexer_norm_offset,
            weights->layer8_attn_sinks_offset,
            weights->layer8_attn_output_a_offset,
            weights->layer8_attn_output_b_offset,
            weights->layer8_ffn.hc_fn_offset,
            weights->layer8_ffn.hc_scale_offset,
            weights->layer8_ffn.hc_base_offset,
            weights->layer8_ffn.norm_offset,
            weights->layer8_ffn.router_gate_offset,
            weights->layer8_ffn.router_hash_offset,
            weights->layer8_ffn.routed_gate_offset,
            weights->layer8_ffn.routed_up_offset,
            weights->layer8_ffn.routed_down_offset,
            weights->layer8_ffn.shared_gate_offset,
            weights->layer8_ffn.shared_up_offset,
            weights->layer8_ffn.shared_down_offset,
            weights->layer9_kvnorm.ingress.hc_fn_offset,
            weights->layer9_kvnorm.ingress.hc_scale_offset,
            weights->layer9_kvnorm.ingress.hc_base_offset,
            weights->layer9_kvnorm.ingress.norm_offset,
            weights->layer9_kvnorm.ingress.q_a_offset,
            weights->layer9_kvnorm.q_a_norm_offset,
            weights->layer9_kvnorm.kv_offset,
            weights->layer9_kvnorm.kv_norm_offset,
            weights->layer9_q_b_offset,
            weights->layer9_compressor.attn_ape_offset,
            weights->layer9_compressor.attn_kv_offset,
            weights->layer9_compressor.attn_gate_offset,
            weights->layer9_compressor.attn_norm_offset,
            weights->layer9_attn_sinks_offset,
            weights->layer9_attn_output_a_offset,
            weights->layer9_attn_output_b_offset,
            weights->layer9_ffn.hc_fn_offset,
            weights->layer9_ffn.hc_scale_offset,
            weights->layer9_ffn.hc_base_offset,
            weights->layer9_ffn.norm_offset,
            weights->layer9_ffn.router_gate_offset,
            weights->layer9_ffn.router_hash_offset,
            weights->layer9_ffn.routed_gate_offset,
            weights->layer9_ffn.routed_up_offset,
            weights->layer9_ffn.routed_down_offset,
            weights->layer9_ffn.shared_gate_offset,
            weights->layer9_ffn.shared_up_offset,
            weights->layer9_ffn.shared_down_offset,
            weights->layer10_kvnorm.ingress.hc_fn_offset,
            weights->layer10_kvnorm.ingress.hc_scale_offset,
            weights->layer10_kvnorm.ingress.hc_base_offset,
            weights->layer10_kvnorm.ingress.norm_offset,
            weights->layer10_kvnorm.ingress.q_a_offset,
            weights->layer10_kvnorm.q_a_norm_offset,
            weights->layer10_kvnorm.kv_offset,
            weights->layer10_kvnorm.kv_norm_offset,
            weights->layer10_q_b_offset,
            weights->layer10_compressor.attn_ape_offset,
            weights->layer10_compressor.attn_kv_offset,
            weights->layer10_compressor.attn_gate_offset,
            weights->layer10_compressor.attn_norm_offset,
            weights->layer10_compressor.indexer_ape_offset,
            weights->layer10_compressor.indexer_kv_offset,
            weights->layer10_compressor.indexer_gate_offset,
            weights->layer10_compressor.indexer_norm_offset,
            weights->layer10_attn_sinks_offset,
            weights->layer10_attn_output_a_offset,
            weights->layer10_attn_output_b_offset,
            weights->layer10_ffn.hc_fn_offset,
            weights->layer10_ffn.hc_scale_offset,
            weights->layer10_ffn.hc_base_offset,
            weights->layer10_ffn.norm_offset,
            weights->layer10_ffn.router_gate_offset,
            weights->layer10_ffn.router_hash_offset,
            weights->layer10_ffn.routed_gate_offset,
            weights->layer10_ffn.routed_up_offset,
            weights->layer10_ffn.routed_down_offset,
            weights->layer10_ffn.shared_gate_offset,
            weights->layer10_ffn.shared_up_offset,
            weights->layer10_ffn.shared_down_offset,
            weights->layer11_kvnorm.ingress.hc_fn_offset,
            weights->layer11_kvnorm.ingress.hc_scale_offset,
            weights->layer11_kvnorm.ingress.hc_base_offset,
            weights->layer11_kvnorm.ingress.norm_offset,
            weights->layer11_kvnorm.ingress.q_a_offset,
            weights->layer11_kvnorm.q_a_norm_offset,
            weights->layer11_kvnorm.kv_offset,
            weights->layer11_kvnorm.kv_norm_offset,
            weights->layer11_q_b_offset,
            weights->layer11_compressor.attn_ape_offset,
            weights->layer11_compressor.attn_kv_offset,
            weights->layer11_compressor.attn_gate_offset,
            weights->layer11_compressor.attn_norm_offset,
            weights->layer11_attn_sinks_offset,
            weights->layer11_attn_output_a_offset,
            weights->layer11_attn_output_b_offset,
            weights->layer11_ffn.hc_fn_offset,
            weights->layer11_ffn.hc_scale_offset,
            weights->layer11_ffn.hc_base_offset,
            weights->layer11_ffn.norm_offset,
            weights->layer11_ffn.router_gate_offset,
            weights->layer11_ffn.router_hash_offset,
            weights->layer11_ffn.routed_gate_offset,
            weights->layer11_ffn.routed_up_offset,
            weights->layer11_ffn.routed_down_offset,
            weights->layer11_ffn.shared_gate_offset,
            weights->layer11_ffn.shared_up_offset,
            weights->layer11_ffn.shared_down_offset,
        };
        uint64_t sizes[284] = {
            ...
            weights->ffn.shared_up_bytes, weights->ffn.shared_down_bytes,
            weights->layer3_kvnorm.ingress.hc_fn_bytes,
            weights->layer3_kvnorm.ingress.hc_scale_bytes,
            weights->layer3_kvnorm.ingress.hc_base_bytes,
            weights->layer3_kvnorm.ingress.norm_bytes,
            weights->layer3_kvnorm.ingress.q_a_bytes,
            weights->layer3_kvnorm.q_a_norm_bytes,
            weights->layer3_kvnorm.kv_bytes,
            weights->layer3_kvnorm.kv_norm_bytes,
            weights->layer3_q_b_bytes,
            weights->layer3_compressor.attn_ape_bytes,
            weights->layer3_compressor.attn_kv_bytes,
            weights->layer3_compressor.attn_gate_bytes,
            weights->layer3_compressor.attn_norm_bytes,
            weights->layer3_attn_sinks_bytes,
            weights->layer3_attn_output_a_bytes,
            weights->layer3_attn_output_b_bytes,
            weights->layer3_ffn.hc_fn_bytes,
            weights->layer3_ffn.hc_scale_bytes,
            weights->layer3_ffn.hc_base_bytes,
            weights->layer3_ffn.norm_bytes,
            weights->layer3_ffn.router_gate_bytes,
            weights->layer3_ffn.router_hash_bytes,
            weights->layer3_ffn.routed_gate_bytes,
            weights->layer3_ffn.routed_up_bytes,
            weights->layer3_ffn.routed_down_bytes,
            weights->layer3_ffn.shared_gate_bytes,
            weights->layer3_ffn.shared_up_bytes,
            weights->layer3_ffn.shared_down_bytes,
            weights->layer4_kvnorm.ingress.hc_fn_bytes,
            weights->layer4_kvnorm.ingress.hc_scale_bytes,
            weights->layer4_kvnorm.ingress.hc_base_bytes,
            weights->layer4_kvnorm.ingress.norm_bytes,
            weights->layer4_kvnorm.ingress.q_a_bytes,
            weights->layer4_kvnorm.q_a_norm_bytes,
            weights->layer4_kvnorm.kv_bytes,
            weights->layer4_kvnorm.kv_norm_bytes,
            weights->layer4_q_b_bytes,
            weights->layer4_compressor.attn_ape_bytes,
            weights->layer4_compressor.attn_kv_bytes,
            weights->layer4_compressor.attn_gate_bytes,
            ...
            weights->layer4_compressor.indexer_gate_bytes,
            weights->layer4_compressor.indexer_norm_bytes,
            weights->layer4_attn_sinks_bytes,
            weights->layer4_attn_output_a_bytes,
            weights->layer4_attn_output_b_bytes,
            weights->layer4_ffn.hc_fn_bytes,
            weights->layer4_ffn.hc_scale_bytes,
            weights->layer4_ffn.hc_base_bytes,
            weights->layer4_ffn.norm_bytes,
            weights->layer4_ffn.router_gate_bytes,
            weights->layer4_ffn.router_hash_bytes,
            weights->layer4_ffn.routed_gate_bytes,
            weights->layer4_ffn.routed_up_bytes,
            weights->layer4_ffn.routed_down_bytes,
            weights->layer4_ffn.shared_gate_bytes,
            weights->layer4_ffn.shared_up_bytes,
            weights->layer4_ffn.shared_down_bytes,
            weights->layer5_kvnorm.ingress.hc_fn_bytes,
            weights->layer5_kvnorm.ingress.hc_scale_bytes,
            weights->layer5_kvnorm.ingress.hc_base_bytes,
            weights->layer5_kvnorm.ingress.norm_bytes,
            weights->layer5_kvnorm.ingress.q_a_bytes,
            weights->layer5_kvnorm.q_a_norm_bytes,
            weights->layer5_kvnorm.kv_bytes,
            weights->layer5_kvnorm.kv_norm_bytes,
            weights->layer5_q_b_bytes,
            weights->layer5_compressor.attn_ape_bytes,
            weights->layer5_compressor.attn_kv_bytes,
            weights->layer5_compressor.attn_gate_bytes,
            weights->layer5_compressor.attn_norm_bytes,
            weights->layer5_attn_sinks_bytes,
            weights->layer5_attn_output_a_bytes,
            weights->layer5_attn_output_b_bytes,
            weights->layer5_ffn.hc_fn_bytes,
            weights->layer5_ffn.hc_scale_bytes,
            weights->layer5_ffn.hc_base_bytes,
            weights->layer5_ffn.norm_bytes,
            weights->layer5_ffn.router_gate_bytes,
            weights->layer5_ffn.router_hash_bytes,
            weights->layer5_ffn.routed_gate_bytes,
            weights->layer5_ffn.routed_up_bytes,
            weights->layer5_ffn.routed_down_bytes,
            weights->layer5_ffn.shared_gate_bytes,
            weights->layer5_ffn.shared_up_bytes,
            weights->layer5_ffn.shared_down_bytes,
            weights->layer6_kvnorm.ingress.hc_fn_bytes,
            weights->layer6_kvnorm.ingress.hc_scale_bytes,
            weights->layer6_kvnorm.ingress.hc_base_bytes,
            weights->layer6_kvnorm.ingress.norm_bytes,
            weights->layer6_kvnorm.ingress.q_a_bytes,
            weights->layer6_kvnorm.q_a_norm_bytes,
            weights->layer6_kvnorm.kv_bytes,
            ...
            weights->layer6_compressor.indexer_gate_bytes,
            weights->layer6_compressor.indexer_norm_bytes,
            weights->layer6_attn_sinks_bytes,
            weights->layer6_attn_output_a_bytes,
            weights->layer6_attn_output_b_bytes,
            weights->layer6_ffn.hc_fn_bytes,
            weights->layer6_ffn.hc_scale_bytes,
            weights->layer6_ffn.hc_base_bytes,
            weights->layer6_ffn.norm_bytes,
            weights->layer6_ffn.router_gate_bytes,
            weights->layer6_ffn.router_hash_bytes,
            weights->layer6_ffn.routed_gate_bytes,
            weights->layer6_ffn.routed_up_bytes,
            weights->layer6_ffn.routed_down_bytes,
            weights->layer6_ffn.shared_gate_bytes,
            weights->layer6_ffn.shared_up_bytes,
            weights->layer6_ffn.shared_down_bytes,
            weights->layer7_kvnorm.ingress.hc_fn_bytes,
            weights->layer7_kvnorm.ingress.hc_scale_bytes,
            weights->layer7_kvnorm.ingress.hc_base_bytes,
            weights->layer7_kvnorm.ingress.norm_bytes,
            weights->layer7_kvnorm.ingress.q_a_bytes,
            weights->layer7_kvnorm.q_a_norm_bytes,
            weights->layer7_kvnorm.kv_bytes,
            weights->layer7_kvnorm.kv_norm_bytes,
            weights->layer7_q_b_bytes,
            weights->layer7_compressor.attn_ape_bytes,
            weights->layer7_compressor.attn_kv_bytes,
            weights->layer7_compressor.attn_gate_bytes,
            weights->layer7_compressor.attn_norm_bytes,
            weights->layer7_attn_sinks_bytes,
            weights->layer7_attn_output_a_bytes,
            weights->layer7_attn_output_b_bytes,
            weights->layer7_ffn.hc_fn_bytes,
            weights->layer7_ffn.hc_scale_bytes,
            weights->layer7_ffn.hc_base_bytes,
            weights->layer7_ffn.norm_bytes,
            weights->layer7_ffn.router_gate_bytes,
            weights->layer7_ffn.router_hash_bytes,
            weights->layer7_ffn.routed_gate_bytes,
            weights->layer7_ffn.routed_up_bytes,
            weights->layer7_ffn.routed_down_bytes,
            weights->layer7_ffn.shared_gate_bytes,
            weights->layer7_ffn.shared_up_bytes,
            weights->layer7_ffn.shared_down_bytes,
            weights->layer8_kvnorm.ingress.hc_fn_bytes,
            weights->layer8_kvnorm.ingress.hc_scale_bytes,
            weights->layer8_kvnorm.ingress.hc_base_bytes,
            weights->layer8_kvnorm.ingress.norm_bytes,
            weights->layer8_kvnorm.ingress.q_a_bytes,
            weights->layer8_kvnorm.q_a_norm_bytes,
            weights->layer8_kvnorm.kv_bytes,
            weights->layer8_kvnorm.kv_norm_bytes,
            weights->layer8_q_b_bytes,
            weights->layer8_compressor.attn_ape_bytes,
            weights->layer8_compressor.attn_kv_bytes,
            weights->layer8_compressor.attn_gate_bytes,
            ...
            weights->layer8_compressor.indexer_gate_bytes,
            weights->layer8_compressor.indexer_norm_bytes,
            weights->layer8_attn_sinks_bytes,
            weights->layer8_attn_output_a_bytes,
            weights->layer8_attn_output_b_bytes,
            weights->layer8_ffn.hc_fn_bytes,
            weights->layer8_ffn.hc_scale_bytes,
            weights->layer8_ffn.hc_base_bytes,
            weights->layer8_ffn.norm_bytes,
            weights->layer8_ffn.router_gate_bytes,
            weights->layer8_ffn.router_hash_bytes,
            weights->layer8_ffn.routed_gate_bytes,
            weights->layer8_ffn.routed_up_bytes,
            weights->layer8_ffn.routed_down_bytes,
            weights->layer8_ffn.shared_gate_bytes,
            weights->layer8_ffn.shared_up_bytes,
            weights->layer8_ffn.shared_down_bytes,
            weights->layer9_kvnorm.ingress.hc_fn_bytes,
            weights->layer9_kvnorm.ingress.hc_scale_bytes,
            weights->layer9_kvnorm.ingress.hc_base_bytes,
            weights->layer9_kvnorm.ingress.norm_bytes,
            weights->layer9_kvnorm.ingress.q_a_bytes,
            weights->layer9_kvnorm.q_a_norm_bytes,
            weights->layer9_kvnorm.kv_bytes,
            weights->layer9_kvnorm.kv_norm_bytes,
            weights->layer9_q_b_bytes,
            weights->layer9_compressor.attn_ape_bytes,
            weights->layer9_compressor.attn_kv_bytes,
            weights->layer9_compressor.attn_gate_bytes,
            weights->layer9_compressor.attn_norm_bytes,
            weights->layer9_attn_sinks_bytes,
            weights->layer9_attn_output_a_bytes,
            weights->layer9_attn_output_b_bytes,
            weights->layer9_ffn.hc_fn_bytes,
            weights->layer9_ffn.hc_scale_bytes,
            weights->layer9_ffn.hc_base_bytes,
            weights->layer9_ffn.norm_bytes,
            weights->layer9_ffn.router_gate_bytes,
            weights->layer9_ffn.router_hash_bytes,
            weights->layer9_ffn.routed_gate_bytes,
            weights->layer9_ffn.routed_up_bytes,
            weights->layer9_ffn.routed_down_bytes,
            weights->layer9_ffn.shared_gate_bytes,
            weights->layer9_ffn.shared_up_bytes,
            weights->layer9_ffn.shared_down_bytes,
            weights->layer10_kvnorm.ingress.hc_fn_bytes,
            weights->layer10_kvnorm.ingress.hc_scale_bytes,
            weights->layer10_kvnorm.ingress.hc_base_bytes,
            weights->layer10_kvnorm.ingress.norm_bytes,
            weights->layer10_kvnorm.ingress.q_a_bytes,
            weights->layer10_kvnorm.q_a_norm_bytes,
            weights->layer10_kvnorm.kv_bytes,
            weights->layer10_kvnorm.kv_norm_bytes,
            weights->layer10_q_b_bytes,
            weights->layer10_compressor.attn_ape_bytes,
            weights->layer10_compressor.attn_kv_bytes,
            weights->layer10_compressor.attn_gate_bytes,
            ...
            weights->layer10_compressor.indexer_gate_bytes,
            weights->layer10_compressor.indexer_norm_bytes,
            weights->layer10_attn_sinks_bytes,
            weights->layer10_attn_output_a_bytes,
            weights->layer10_attn_output_b_bytes,
            weights->layer10_ffn.hc_fn_bytes,
            weights->layer10_ffn.hc_scale_bytes,
            weights->layer10_ffn.hc_base_bytes,
            weights->layer10_ffn.norm_bytes,
            weights->layer10_ffn.router_gate_bytes,
            weights->layer10_ffn.router_hash_bytes,
            weights->layer10_ffn.routed_gate_bytes,
            weights->layer10_ffn.routed_up_bytes,
            weights->layer10_ffn.routed_down_bytes,
            weights->layer10_ffn.shared_gate_bytes,
            weights->layer10_ffn.shared_up_bytes,
            weights->layer10_ffn.shared_down_bytes,
            weights->layer11_kvnorm.ingress.hc_fn_bytes,
            weights->layer11_kvnorm.ingress.hc_scale_bytes,
            weights->layer11_kvnorm.ingress.hc_base_bytes,
            weights->layer11_kvnorm.ingress.norm_bytes,
            weights->layer11_kvnorm.ingress.q_a_bytes,
            weights->layer11_kvnorm.q_a_norm_bytes,
            weights->layer11_kvnorm.kv_bytes,
            weights->layer11_kvnorm.kv_norm_bytes,
            weights->layer11_q_b_bytes,
            weights->layer11_compressor.attn_ape_bytes,
            weights->layer11_compressor.attn_kv_bytes,
            weights->layer11_compressor.attn_gate_bytes,
            weights->layer11_compressor.attn_norm_bytes,
            weights->layer11_attn_sinks_bytes,
            weights->layer11_attn_output_a_bytes,
            weights->layer11_attn_output_b_bytes,
            weights->layer11_ffn.hc_fn_bytes,
            weights->layer11_ffn.hc_scale_bytes,
            weights->layer11_ffn.hc_base_bytes,
            weights->layer11_ffn.norm_bytes,
            weights->layer11_ffn.router_gate_bytes,
            weights->layer11_ffn.router_hash_bytes,
            weights->layer11_ffn.routed_gate_bytes,
            weights->layer11_ffn.routed_up_bytes,
            weights->layer11_ffn.routed_down_bytes,
            weights->layer11_ffn.shared_gate_bytes,
            weights->layer11_ffn.shared_up_bytes,
            weights->layer11_ffn.shared_down_bytes,
        };
        id<MTLBuffer> model_buffers[284] = { nil };
        NSUInteger inner[284] = { 0 };
        BOOL matches[284] = { NO };
        for (uint32_t index = 0; index < 284u; index++) {
            model_buffers[index] = wrap_model_range(
                context, model_mapping, model_bytes, offsets[index], sizes[index],
                &inner[index], &matches[index], error, error_bytes);
            if (!model_buffers[index]) return 0;
...
#define RUST_STAR_NEW_L2_ATTN_BUFFER(name, bytes) \
        ...
        const NSUInteger layer3_q_rank_bytes = (NSUInteger)rows*1024u*sizeof(float);
        const NSUInteger layer3_kv_bytes = (NSUInteger)rows*512u*sizeof(float);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_q_norm_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_kv_raw_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_kv_norm_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_kv_norm_snapshot_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_kv_rope_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_q_cur_buffer, q_bytes);
        const NSUInteger layer3_compressor_projection_bytes =
            (NSUInteger)rows*layer3_compressor_width*sizeof(float);
        const NSUInteger layer3_compressed_bytes =
            (NSUInteger)layer3_compressed_rows*head_dim*sizeof(float);
        const NSUInteger layer3_compressor_state_bytes =
            (NSUInteger)layer3_compressor_ratio*layer3_compressor_width*
                sizeof(float);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_attn_projected_kv_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_attn_projected_score_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_attn_score_ape_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_attn_compressed_buffer,
            layer3_compressed_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_attn_state_kv_buffer,
            layer3_compressor_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_attn_state_score_buffer,
            layer3_compressor_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_compressed_position_buffer,
            layer3_compressed_rows*sizeof(int32_t));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_mask_buffer, layer3_mask_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_kqv_out_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_kqv_back_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_attn_low_row0_buffer,
            8u*output_rank*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_attention_output_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_after_attention_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_ffn_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_ffn_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_ffn_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_ffn_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_ffn_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_router_logits_buffer, ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_router_probs_buffer, ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_router_selected_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_router_weights_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_router_weight_sums_buffer,
            rows*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_routed_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_shared_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer3_after_ffn_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_q_lora_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_q_norm_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_kv_raw_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_kv_norm_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_kv_norm_snapshot_buffer,
            layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_kv_rope_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_q_raw_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_q_cur_buffer, q_bytes);
        const NSUInteger layer4_attn_projection_bytes =
            (NSUInteger)rows*layer4_attn_compressor_width*sizeof(float);
        const NSUInteger layer4_indexer_projection_bytes =
            (NSUInteger)rows*layer4_indexer_compressor_width*sizeof(float);
        const NSUInteger layer4_attn_compressed_bytes =
            (NSUInteger)compressed_rows*layer4_attn_compressor_head*sizeof(float);
        const NSUInteger layer4_indexer_compressed_bytes =
            (NSUInteger)compressed_rows*layer4_indexer_compressor_head*sizeof(float);
        const NSUInteger layer4_attn_state_bytes =
            8u*layer4_attn_compressor_width*sizeof(float);
        const NSUInteger layer4_indexer_state_bytes =
            8u*layer4_indexer_compressor_width*sizeof(float);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_attn_projected_kv_buffer,
            layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_attn_projected_score_buffer,
            layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_attn_score_ape_buffer,
            layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_attn_packed_kv_buffer,
            layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_attn_packed_score_buffer,
            layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_attn_compressed_buffer,
            layer4_attn_compressed_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_attn_state_kv_buffer,
            layer4_attn_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_attn_state_score_buffer,
            layer4_attn_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_indexer_projected_kv_buffer,
            layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_indexer_projected_score_buffer,
            layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_indexer_score_ape_buffer,
            layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_indexer_packed_kv_buffer,
            layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_indexer_packed_score_buffer,
            layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_indexer_compressed_buffer,
            layer4_indexer_compressed_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_indexer_state_kv_buffer,
            layer4_indexer_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_indexer_state_score_buffer,
            layer4_indexer_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_compressed_position_buffer,
            compressed_rows*sizeof(int32_t));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_kqv_out_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_kqv_back_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_attn_low_row0_buffer,
            8u*output_rank*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_attention_output_buffer,
            output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_after_attention_hc_buffer,
            hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_ffn_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_ffn_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_ffn_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_ffn_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_ffn_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_router_logits_buffer, ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_router_probs_buffer, ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_router_selected_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_router_weights_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_router_weight_sums_buffer,
            rows*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_routed_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_shared_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer4_after_ffn_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_q_lora_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_q_norm_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_kv_raw_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_kv_norm_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_kv_norm_snapshot_buffer,
            layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_kv_rope_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_q_raw_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_q_cur_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_attn_projected_kv_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_attn_projected_score_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_attn_score_ape_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_attn_compressed_buffer,
            layer3_compressed_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_attn_state_kv_buffer,
            layer3_compressor_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_attn_state_score_buffer,
            layer3_compressor_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_compressed_position_buffer,
            layer3_compressed_rows*sizeof(int32_t));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_kqv_out_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_kqv_back_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_attn_low_row0_buffer,
            8u*output_rank*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_attention_output_buffer,
            output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_after_attention_hc_buffer,
            hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_ffn_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_ffn_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_ffn_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_ffn_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_ffn_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_router_logits_buffer,
            ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_router_probs_buffer,
            ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_router_selected_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_router_weights_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_router_weight_sums_buffer,
            rows*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_routed_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_shared_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer5_after_ffn_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_q_lora_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_q_norm_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_kv_raw_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_kv_norm_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_kv_norm_snapshot_buffer,
            layer3_kv_bytes);
        ...
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_compressed_position_buffer,
            compressed_rows*sizeof(int32_t));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_kqv_out_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_kqv_back_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_attn_low_row0_buffer,
            8u*output_rank*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_attention_output_buffer,
            output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_after_attention_hc_buffer,
            hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_ffn_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_ffn_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_ffn_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_ffn_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_ffn_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_router_logits_buffer,
            ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_router_probs_buffer,
            ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_router_selected_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_router_weights_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_router_weight_sums_buffer,
            rows*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_routed_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_shared_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer6_after_ffn_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_q_lora_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_q_norm_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_kv_raw_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_kv_norm_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_kv_norm_snapshot_buffer,
            layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_kv_rope_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_q_raw_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_q_cur_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_attn_projected_kv_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_attn_projected_score_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_attn_score_ape_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_attn_compressed_buffer,
            layer3_compressed_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_attn_state_kv_buffer,
            layer3_compressor_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_attn_state_score_buffer,
            layer3_compressor_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_compressed_position_buffer,
            layer3_compressed_rows*sizeof(int32_t));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_kqv_out_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_kqv_back_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_attn_low_row0_buffer,
            8u*output_rank*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_attention_output_buffer,
            output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_after_attention_hc_buffer,
            hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_ffn_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_ffn_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_ffn_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_ffn_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_ffn_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_router_logits_buffer,
            ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_router_probs_buffer,
            ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_router_selected_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_router_weights_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_router_weight_sums_buffer,
            rows*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_routed_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_shared_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer7_after_ffn_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_q_lora_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_q_norm_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_kv_raw_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_kv_norm_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_kv_norm_snapshot_buffer,
        layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_kv_rope_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_q_raw_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_q_cur_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_attn_projected_kv_buffer,
        layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_attn_projected_score_buffer,
        layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_attn_score_ape_buffer,
        layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_attn_packed_kv_buffer,
        layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_attn_packed_score_buffer,
        layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_attn_compressed_buffer,
        layer4_attn_compressed_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_attn_state_kv_buffer,
        layer4_attn_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_attn_state_score_buffer,
        layer4_attn_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_indexer_projected_kv_buffer,
        layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_indexer_projected_score_buffer,
        layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_indexer_score_ape_buffer,
        layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_indexer_packed_kv_buffer,
        layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_indexer_packed_score_buffer,
        layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_indexer_compressed_buffer,
        layer4_indexer_compressed_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_indexer_state_kv_buffer,
        layer4_indexer_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_indexer_state_score_buffer,
        layer4_indexer_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_compressed_position_buffer,
        compressed_rows*sizeof(int32_t));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_kqv_out_row0_buffer,
        q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_kqv_back_row0_buffer,
        q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_attn_low_row0_buffer,
        8u*output_rank*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_attention_output_buffer,
        output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_after_attention_hc_buffer,
        hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_ffn_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_ffn_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_ffn_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_ffn_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_ffn_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_router_logits_buffer,
        ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_router_probs_buffer,
        ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_router_selected_buffer,
        ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_router_weights_buffer,
        ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_router_weight_sums_buffer,
        rows*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_routed_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_shared_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer8_after_ffn_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_q_lora_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_q_norm_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_kv_raw_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_kv_norm_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_kv_norm_snapshot_buffer,
            layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_kv_rope_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_q_raw_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_q_cur_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_attn_projected_kv_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_attn_projected_score_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_attn_score_ape_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_attn_compressed_buffer,
            layer3_compressed_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_attn_state_kv_buffer,
            layer3_compressor_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_attn_state_score_buffer,
            layer3_compressor_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_compressed_position_buffer,
            layer3_compressed_rows*sizeof(int32_t));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_kqv_out_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_kqv_back_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_attn_low_row0_buffer,
            8u*output_rank*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_attention_output_buffer,
            output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_after_attention_hc_buffer,
            hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_ffn_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_ffn_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_ffn_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_ffn_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_ffn_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_router_logits_buffer,
            ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_router_probs_buffer,
            ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_router_selected_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_router_weights_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_router_weight_sums_buffer,
            rows*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_routed_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_shared_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer9_after_ffn_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_q_lora_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_q_norm_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_kv_raw_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_kv_norm_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_kv_norm_snapshot_buffer,
        layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_kv_rope_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_q_raw_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_q_cur_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_attn_projected_kv_buffer,
        layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_attn_projected_score_buffer,
        layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_attn_score_ape_buffer,
        layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_attn_packed_kv_buffer,
        layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_attn_packed_score_buffer,
        layer4_attn_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_attn_compressed_buffer,
        layer4_attn_compressed_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_attn_state_kv_buffer,
        layer4_attn_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_attn_state_score_buffer,
        layer4_attn_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_indexer_projected_kv_buffer,
        layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_indexer_projected_score_buffer,
        layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_indexer_score_ape_buffer,
        layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_indexer_packed_kv_buffer,
        layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_indexer_packed_score_buffer,
        layer4_indexer_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_indexer_compressed_buffer,
        layer4_indexer_compressed_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_indexer_state_kv_buffer,
        layer4_indexer_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_indexer_state_score_buffer,
        layer4_indexer_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_compressed_position_buffer,
        compressed_rows*sizeof(int32_t));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_kqv_out_row0_buffer,
        q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_kqv_back_row0_buffer,
        q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_attn_low_row0_buffer,
        8u*output_rank*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_attention_output_buffer,
        output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_after_attention_hc_buffer,
        hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_ffn_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_ffn_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_ffn_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_ffn_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_ffn_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_router_logits_buffer,
        ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_router_probs_buffer,
        ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_router_selected_buffer,
        ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_router_weights_buffer,
        ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_router_weight_sums_buffer,
        rows*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_routed_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_shared_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer10_after_ffn_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_q_lora_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_q_norm_buffer, layer3_q_rank_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_kv_raw_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_kv_norm_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_kv_norm_snapshot_buffer,
            layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_kv_rope_buffer, layer3_kv_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_q_raw_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_q_cur_buffer, q_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_attn_projected_kv_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_attn_projected_score_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_attn_score_ape_buffer,
            layer3_compressor_projection_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_attn_compressed_buffer,
            layer3_compressed_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_attn_state_kv_buffer,
            layer3_compressor_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_attn_state_score_buffer,
            layer3_compressor_state_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_compressed_position_buffer,
            layer3_compressed_rows*sizeof(int32_t));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_kqv_out_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_kqv_back_row0_buffer,
            q_dim*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_attn_low_row0_buffer,
            8u*output_rank*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_attention_output_buffer,
            output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_after_attention_hc_buffer,
            hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_ffn_flat_hc_buffer, hc_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_ffn_mix_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_ffn_split_buffer, ffn_mix_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_ffn_cur_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_ffn_norm_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_router_logits_buffer,
            ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_router_probs_buffer,
            ffn_router_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_router_selected_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_router_weights_buffer,
            ffn_selected_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_router_weight_sums_buffer,
            rows*sizeof(float));
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_routed_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_shared_out_buffer, output_bytes);
        RUST_STAR_NEW_L2_ATTN_BUFFER(layer11_after_ffn_hc_buffer, hc_bytes);
...
#undef RUST_STAR_NEW_L2_ATTN_BUFFER
        if (!q_buffer || !staged_kv_buffer || !mask_buffer || !block_buffer ||
            ...
            !layer3_q_norm_buffer || !layer3_kv_raw_buffer ||
            !layer3_kv_norm_buffer || !layer3_kv_norm_snapshot_buffer ||
            !layer3_kv_rope_buffer || !layer3_q_cur_buffer ||
            !layer3_attn_projected_kv_buffer ||
            !layer3_attn_projected_score_buffer ||
            !layer3_attn_score_ape_buffer || !layer3_attn_compressed_buffer ||
            !layer3_attn_state_kv_buffer || !layer3_attn_state_score_buffer ||
            !layer3_compressed_position_buffer || !layer3_mask_buffer ||
            !layer3_kqv_out_row0_buffer || !layer3_kqv_back_row0_buffer ||
            !layer3_attn_low_row0_buffer ||
            !layer3_attention_output_buffer ||
            !layer3_after_attention_hc_buffer ||
            !layer3_ffn_flat_hc_buffer || !layer3_ffn_mix_buffer ||
            !layer3_ffn_split_buffer || !layer3_ffn_cur_buffer ||
            !layer3_ffn_norm_buffer || !layer3_router_logits_buffer ||
            !layer3_router_probs_buffer || !layer3_router_selected_buffer ||
            !layer3_router_weights_buffer ||
            !layer3_router_weight_sums_buffer ||
            !layer3_routed_out_buffer || !layer3_shared_out_buffer ||
            !layer3_after_ffn_hc_buffer || !layer4_flat_hc_buffer ||
            !layer4_mix_buffer || !layer4_split_buffer || !layer4_cur_buffer ||
            !layer4_norm_buffer || !layer4_q_lora_buffer ||
            !layer4_q_norm_buffer || !layer4_kv_raw_buffer ||
            !layer4_kv_norm_buffer || !layer4_kv_norm_snapshot_buffer ||
            !layer4_kv_rope_buffer || !layer4_q_raw_buffer ||
            !layer4_q_cur_buffer || !layer4_attn_projected_kv_buffer ||
            !layer4_attn_projected_score_buffer ||
            !layer4_attn_score_ape_buffer || !layer4_attn_packed_kv_buffer ||
            !layer4_attn_packed_score_buffer ||
            !layer4_attn_compressed_buffer || !layer4_attn_state_kv_buffer ||
            !layer4_attn_state_score_buffer ||
            !layer4_indexer_projected_kv_buffer ||
            !layer4_indexer_projected_score_buffer ||
            !layer4_indexer_score_ape_buffer ||
            !layer4_indexer_packed_kv_buffer ||
            !layer4_indexer_packed_score_buffer ||
            !layer4_indexer_compressed_buffer ||
            !layer4_indexer_state_kv_buffer ||
            !layer4_indexer_state_score_buffer ||
            !layer4_compressed_position_buffer ||
            !layer4_kqv_out_row0_buffer ||
            !layer4_kqv_back_row0_buffer ||
            !layer4_attn_low_row0_buffer ||
            !layer4_attention_output_buffer ||
            !layer4_after_attention_hc_buffer ||
            !layer4_ffn_flat_hc_buffer || !layer4_ffn_mix_buffer ||
            !layer4_ffn_split_buffer || !layer4_ffn_cur_buffer ||
            !layer4_ffn_norm_buffer || !layer4_router_logits_buffer ||
            !layer4_router_probs_buffer || !layer4_router_selected_buffer ||
            !layer4_router_weights_buffer ||
            !layer4_router_weight_sums_buffer || !layer4_routed_out_buffer ||
            !layer4_shared_out_buffer || !layer4_after_ffn_hc_buffer ||
            !layer5_flat_hc_buffer || !layer5_mix_buffer ||
            !layer5_split_buffer || !layer5_cur_buffer || !layer5_norm_buffer ||
            !layer5_q_lora_buffer || !layer5_q_norm_buffer ||
            !layer5_kv_raw_buffer || !layer5_kv_norm_buffer ||
            !layer5_kv_norm_snapshot_buffer || !layer5_kv_rope_buffer ||
            !layer5_q_raw_buffer || !layer5_q_cur_buffer ||
            !layer5_attn_projected_kv_buffer ||
            !layer5_attn_projected_score_buffer ||
            !layer5_attn_score_ape_buffer ||
            !layer5_attn_compressed_buffer || !layer5_attn_state_kv_buffer ||
            !layer5_attn_state_score_buffer ||
            !layer5_compressed_position_buffer ||
            !layer5_kqv_out_row0_buffer || !layer5_kqv_back_row0_buffer ||
            !layer5_attn_low_row0_buffer || !layer5_attention_output_buffer ||
            !layer5_after_attention_hc_buffer ||
            !layer5_ffn_flat_hc_buffer || !layer5_ffn_mix_buffer ||
            !layer5_ffn_split_buffer || !layer5_ffn_cur_buffer ||
            !layer5_ffn_norm_buffer || !layer5_router_logits_buffer ||
            !layer5_router_probs_buffer || !layer5_router_selected_buffer ||
            !layer5_router_weights_buffer ||
            !layer5_router_weight_sums_buffer || !layer5_routed_out_buffer ||
            !layer5_shared_out_buffer || !layer5_after_ffn_hc_buffer ||
            !layer6_flat_hc_buffer || !layer6_mix_buffer ||
            !layer6_split_buffer || !layer6_cur_buffer || !layer6_norm_buffer ||
            ...
            !layer6_kqv_out_row0_buffer || !layer6_kqv_back_row0_buffer ||
            !layer6_attn_low_row0_buffer || !layer6_attention_output_buffer ||
            !layer6_after_attention_hc_buffer ||
            !layer6_ffn_flat_hc_buffer || !layer6_ffn_mix_buffer ||
            !layer6_ffn_split_buffer || !layer6_ffn_cur_buffer ||
            !layer6_ffn_norm_buffer || !layer6_router_logits_buffer ||
            !layer6_router_probs_buffer || !layer6_router_selected_buffer ||
            !layer6_router_weights_buffer ||
            !layer6_router_weight_sums_buffer || !layer6_routed_out_buffer ||
            !layer6_shared_out_buffer || !layer6_after_ffn_hc_buffer ||
            !layer7_flat_hc_buffer || !layer7_mix_buffer ||
            !layer7_split_buffer || !layer7_cur_buffer || !layer7_norm_buffer ||
            !layer7_q_lora_buffer || !layer7_q_norm_buffer ||
            !layer7_kv_raw_buffer || !layer7_kv_norm_buffer ||
            !layer7_kv_norm_snapshot_buffer || !layer7_kv_rope_buffer ||
            !layer7_q_raw_buffer || !layer7_q_cur_buffer ||
            !layer7_attn_projected_kv_buffer ||
            !layer7_attn_projected_score_buffer ||
            !layer7_attn_score_ape_buffer || !layer7_attn_compressed_buffer ||
            !layer7_attn_state_kv_buffer || !layer7_attn_state_score_buffer ||
            !layer7_compressed_position_buffer ||
            !layer7_kqv_out_row0_buffer || !layer7_kqv_back_row0_buffer ||
            !layer7_attn_low_row0_buffer || !layer7_attention_output_buffer ||
            !layer7_after_attention_hc_buffer ||
            !layer7_ffn_flat_hc_buffer || !layer7_ffn_mix_buffer ||
            !layer7_ffn_split_buffer || !layer7_ffn_cur_buffer ||
            !layer7_ffn_norm_buffer || !layer7_router_logits_buffer ||
            !layer7_router_probs_buffer || !layer7_router_selected_buffer ||
            !layer7_router_weights_buffer ||
            !layer7_router_weight_sums_buffer || !layer7_routed_out_buffer ||
            !layer7_shared_out_buffer || !layer7_after_ffn_hc_buffer ||
            !layer8_flat_hc_buffer || !layer8_mix_buffer ||
            !layer8_split_buffer || !layer8_cur_buffer || !layer8_norm_buffer ||
            !layer8_q_lora_buffer || !layer8_q_norm_buffer ||
            !layer8_kv_raw_buffer || !layer8_kv_norm_buffer ||
            !layer8_kv_norm_snapshot_buffer || !layer8_kv_rope_buffer ||
            !layer8_q_raw_buffer || !layer8_q_cur_buffer ||
            !layer8_attn_projected_kv_buffer ||
            !layer8_attn_projected_score_buffer ||
            !layer8_attn_score_ape_buffer || !layer8_attn_packed_kv_buffer ||
            !layer8_attn_packed_score_buffer ||
            !layer8_attn_compressed_buffer || !layer8_attn_state_kv_buffer ||
            !layer8_attn_state_score_buffer ||
            !layer8_indexer_projected_kv_buffer ||
            !layer8_indexer_projected_score_buffer ||
            !layer8_indexer_score_ape_buffer ||
            !layer8_indexer_packed_kv_buffer ||
            !layer8_indexer_packed_score_buffer ||
            !layer8_indexer_compressed_buffer ||
            !layer8_indexer_state_kv_buffer ||
            !layer8_indexer_state_score_buffer ||
            !layer8_compressed_position_buffer ||
            !layer8_kqv_out_row0_buffer || !layer8_kqv_back_row0_buffer ||
            !layer8_attn_low_row0_buffer || !layer8_attention_output_buffer ||
            !layer8_after_attention_hc_buffer ||
            !layer8_ffn_flat_hc_buffer || !layer8_ffn_mix_buffer ||
            !layer8_ffn_split_buffer || !layer8_ffn_cur_buffer ||
            !layer8_ffn_norm_buffer || !layer8_router_logits_buffer ||
            !layer8_router_probs_buffer || !layer8_router_selected_buffer ||
            !layer8_router_weights_buffer ||
            !layer8_router_weight_sums_buffer || !layer8_routed_out_buffer ||
            !layer8_shared_out_buffer || !layer8_after_ffn_hc_buffer ||
            !layer9_flat_hc_buffer || !layer9_mix_buffer ||
            !layer9_split_buffer || !layer9_cur_buffer || !layer9_norm_buffer ||
            !layer9_q_lora_buffer || !layer9_q_norm_buffer ||
            !layer9_kv_raw_buffer || !layer9_kv_norm_buffer ||
            !layer9_kv_norm_snapshot_buffer || !layer9_kv_rope_buffer ||
            !layer9_q_raw_buffer || !layer9_q_cur_buffer ||
            !layer9_attn_projected_kv_buffer ||
            !layer9_attn_projected_score_buffer ||
            !layer9_attn_score_ape_buffer || !layer9_attn_compressed_buffer ||
            !layer9_attn_state_kv_buffer || !layer9_attn_state_score_buffer ||
            !layer9_compressed_position_buffer ||
            !layer9_kqv_out_row0_buffer || !layer9_kqv_back_row0_buffer ||
            !layer9_attn_low_row0_buffer || !layer9_attention_output_buffer ||
            !layer9_after_attention_hc_buffer ||
            !layer9_ffn_flat_hc_buffer || !layer9_ffn_mix_buffer ||
            !layer9_ffn_split_buffer || !layer9_ffn_cur_buffer ||
            !layer9_ffn_norm_buffer || !layer9_router_logits_buffer ||
            !layer9_router_probs_buffer || !layer9_router_selected_buffer ||
            !layer9_router_weights_buffer ||
            !layer9_router_weight_sums_buffer || !layer9_routed_out_buffer ||
            !layer9_shared_out_buffer || !layer9_after_ffn_hc_buffer ||
            !layer10_flat_hc_buffer || !layer10_mix_buffer ||
            !layer10_split_buffer || !layer10_cur_buffer || !layer10_norm_buffer ||
            !layer10_q_lora_buffer || !layer10_q_norm_buffer ||
            !layer10_kv_raw_buffer || !layer10_kv_norm_buffer ||
            !layer10_kv_norm_snapshot_buffer || !layer10_kv_rope_buffer ||
            !layer10_q_raw_buffer || !layer10_q_cur_buffer ||
            !layer10_attn_projected_kv_buffer ||
            !layer10_attn_projected_score_buffer ||
            !layer10_attn_score_ape_buffer || !layer10_attn_packed_kv_buffer ||
            !layer10_attn_packed_score_buffer ||
            !layer10_attn_compressed_buffer || !layer10_attn_state_kv_buffer ||
            !layer10_attn_state_score_buffer ||
            !layer10_indexer_projected_kv_buffer ||
            !layer10_indexer_projected_score_buffer ||
            !layer10_indexer_score_ape_buffer ||
            !layer10_indexer_packed_kv_buffer ||
            !layer10_indexer_packed_score_buffer ||
            !layer10_indexer_compressed_buffer ||
            !layer10_indexer_state_kv_buffer ||
            !layer10_indexer_state_score_buffer ||
            !layer10_compressed_position_buffer ||
            !layer10_kqv_out_row0_buffer || !layer10_kqv_back_row0_buffer ||
            !layer10_attn_low_row0_buffer || !layer10_attention_output_buffer ||
            !layer10_after_attention_hc_buffer ||
            !layer10_ffn_flat_hc_buffer || !layer10_ffn_mix_buffer ||
            !layer10_ffn_split_buffer || !layer10_ffn_cur_buffer ||
            !layer10_ffn_norm_buffer || !layer10_router_logits_buffer ||
            !layer10_router_probs_buffer || !layer10_router_selected_buffer ||
            !layer10_router_weights_buffer ||
            !layer10_router_weight_sums_buffer || !layer10_routed_out_buffer ||
            !layer10_shared_out_buffer || !layer10_after_ffn_hc_buffer ||
            !layer11_flat_hc_buffer || !layer11_mix_buffer ||
            !layer11_split_buffer || !layer11_cur_buffer || !layer11_norm_buffer ||
            !layer11_q_lora_buffer || !layer11_q_norm_buffer ||
            !layer11_kv_raw_buffer || !layer11_kv_norm_buffer ||
            !layer11_kv_norm_snapshot_buffer || !layer11_kv_rope_buffer ||
            !layer11_q_raw_buffer || !layer11_q_cur_buffer ||
            !layer11_attn_projected_kv_buffer ||
            !layer11_attn_projected_score_buffer ||
            !layer11_attn_score_ape_buffer || !layer11_attn_compressed_buffer ||
            !layer11_attn_state_kv_buffer || !layer11_attn_state_score_buffer ||
            !layer11_compressed_position_buffer ||
            !layer11_kqv_out_row0_buffer || !layer11_kqv_back_row0_buffer ||
            !layer11_attn_low_row0_buffer || !layer11_attention_output_buffer ||
            !layer11_after_attention_hc_buffer ||
            !layer11_ffn_flat_hc_buffer || !layer11_ffn_mix_buffer ||
            !layer11_ffn_split_buffer || !layer11_ffn_cur_buffer ||
            !layer11_ffn_norm_buffer || !layer11_router_logits_buffer ||
            !layer11_router_probs_buffer || !layer11_router_selected_buffer ||
            !layer11_router_weights_buffer ||
            !layer11_router_weight_sums_buffer || !layer11_routed_out_buffer ||
            !layer11_shared_out_buffer || !layer11_after_ffn_hc_buffer
) {
            return fail_with_message(error, error_bytes,
        ...
        for (uint32_t query = 0; query < rows; query++) {
            ...
            const uint32_t visible_compressed =
                (query+1u)/layer3_compressor_ratio;
        ...
        int32_t *layer3_compressed_positions =
            layer3_compressed_position_buffer.contents;
        for (uint32_t row = 0; row < layer3_compressed_rows; row++) {
            layer3_compressed_positions[row] =
                (int32_t)(row*layer3_compressor_ratio);
        }
        int32_t *layer4_compressed_positions =
            layer4_compressed_position_buffer.contents;
        ...
        int32_t *layer8_compressed_positions =
            layer8_compressed_position_buffer.contents;
        for (uint32_t row = 0; row < compressed_rows; row++) {
            layer8_compressed_positions[row] = (int32_t)(row*compressor_ratio);
        }
        int32_t *layer10_compressed_positions =
            layer10_compressed_position_buffer.contents;
        for (uint32_t row = 0; row < compressed_rows; row++) {
            layer10_compressed_positions[row] = (int32_t)(row*compressor_ratio);
        }
        int32_t *layer5_compressed_positions =
            layer5_compressed_position_buffer.contents;
        for (uint32_t row = 0; row < layer3_compressed_rows; row++) {
            layer5_compressed_positions[row] =
                (int32_t)(row*layer3_compressor_ratio);
        }
        int32_t *layer7_compressed_positions =
            layer7_compressed_position_buffer.contents;
        for (uint32_t row = 0; row < layer3_compressed_rows; row++) {
            layer7_compressed_positions[row] =
                (int32_t)(row*layer3_compressor_ratio);
        }
        int32_t *layer9_compressed_positions =
            layer9_compressed_position_buffer.contents;
        for (uint32_t row = 0; row < layer3_compressed_rows; row++) {
            layer9_compressed_positions[row] =
                (int32_t)(row*layer3_compressor_ratio);
        }
        int32_t *layer11_compressed_positions =
            layer11_compressed_position_buffer.contents;
        for (uint32_t row = 0; row < layer3_compressed_rows; row++) {
            layer11_compressed_positions[row] =
                (int32_t)(row*layer3_compressor_ratio);
        }
        memset(layer4_attn_state_kv_buffer.contents, 0, layer4_attn_state_bytes);
        memset(layer4_indexer_state_kv_buffer.contents, 0,
               layer4_indexer_state_bytes);
        uint32_t *layer4_attn_state_score_bits =
            layer4_attn_state_score_buffer.contents;
        for (NSUInteger index = 0;
             index < layer4_attn_state_bytes/sizeof(uint32_t); index++) {
            layer4_attn_state_score_bits[index] = 0xff800000u;
        }
        uint32_t *layer4_indexer_state_score_bits =
            layer4_indexer_state_score_buffer.contents;
        for (NSUInteger index = 0;
        ...
        memset(layer8_attn_state_kv_buffer.contents, 0, layer4_attn_state_bytes);
        memset(layer8_indexer_state_kv_buffer.contents, 0,
               layer4_indexer_state_bytes);
        uint32_t *layer8_attn_state_score_bits =
            layer8_attn_state_score_buffer.contents;
        for (NSUInteger index = 0;
             index < layer4_attn_state_bytes/sizeof(uint32_t); index++) {
            layer8_attn_state_score_bits[index] = 0xff800000u;
        }
        uint32_t *layer8_indexer_state_score_bits =
            layer8_indexer_state_score_buffer.contents;
        for (NSUInteger index = 0;
             index < layer4_indexer_state_bytes/sizeof(uint32_t); index++) {
            layer8_indexer_state_score_bits[index] = 0xff800000u;
        }
        memset(layer10_attn_state_kv_buffer.contents, 0, layer4_attn_state_bytes);
        memset(layer10_indexer_state_kv_buffer.contents, 0,
               layer4_indexer_state_bytes);
        uint32_t *layer10_attn_state_score_bits =
            layer10_attn_state_score_buffer.contents;
        for (NSUInteger index = 0;
             index < layer4_attn_state_bytes/sizeof(uint32_t); index++) {
            layer10_attn_state_score_bits[index] = 0xff800000u;
        }
        uint32_t *layer10_indexer_state_score_bits =
            layer10_indexer_state_score_buffer.contents;
        for (NSUInteger index = 0;
             index < layer4_indexer_state_bytes/sizeof(uint32_t); index++) {
            layer10_indexer_state_score_bits[index] = 0xff800000u;
        }
        memset(layer3_attn_state_kv_buffer.contents, 0,
               layer3_compressor_state_bytes);
        uint32_t *layer3_state_score_bits =
            layer3_attn_state_score_buffer.contents;
        for (NSUInteger index = 0;
             index < layer3_compressor_state_bytes/sizeof(uint32_t); index++) {
            layer3_state_score_bits[index] = 0xff800000u;
        }
        memset(layer5_attn_state_kv_buffer.contents, 0,
               layer3_compressor_state_bytes);
        uint32_t *layer5_state_score_bits =
            layer5_attn_state_score_buffer.contents;
        for (NSUInteger index = 0;
             index < layer3_compressor_state_bytes/sizeof(uint32_t); index++) {
            layer5_state_score_bits[index] = 0xff800000u;
        }
        memset(layer7_attn_state_kv_buffer.contents, 0,
               layer3_compressor_state_bytes);
        uint32_t *layer7_state_score_bits =
            layer7_attn_state_score_buffer.contents;
        for (NSUInteger index = 0;
             index < layer3_compressor_state_bytes/sizeof(uint32_t); index++) {
            layer7_state_score_bits[index] = 0xff800000u;
        }
        memset(layer9_attn_state_kv_buffer.contents, 0,
               layer3_compressor_state_bytes);
        uint32_t *layer9_state_score_bits =
            layer9_attn_state_score_buffer.contents;
        for (NSUInteger index = 0;
             index < layer3_compressor_state_bytes/sizeof(uint32_t); index++) {
            layer9_state_score_bits[index] = 0xff800000u;
        }

        memset(layer11_attn_state_kv_buffer.contents, 0,
               layer3_compressor_state_bytes);
        uint32_t *layer11_state_score_bits =
            layer11_attn_state_score_buffer.contents;
        for (NSUInteger index = 0;
             index < layer3_compressor_state_bytes/sizeof(uint32_t); index++) {
            layer11_state_score_bits[index] = 0xff800000u;
        }
...
#undef RUST_STAR_L2_FFN_Q8_ARGS
        ...
        rust_star_q8_mm_args layer3_q_a_args = {
            .ne00=n_embd, .ne02=1,
            .nb01=(n_embd/32u)*34u,
            .nb02=weights->layer3_kvnorm.ingress.q_a_bytes,
            .nb03=weights->layer3_kvnorm.ingress.q_a_bytes,
            .ne12=1, .nb10=sizeof(float),
            .nb11=n_embd*sizeof(float),
            .nb12=(uint64_t)rows*n_embd*sizeof(float),
            .nb13=(uint64_t)rows*n_embd*sizeof(float),
        ...
        rust_star_q8_mm_args layer3_kv_args = {
            .ne00=n_embd, .ne02=1,
            .nb01=(n_embd/32u)*34u,
            .nb02=weights->layer3_kvnorm.kv_bytes,
            .nb03=weights->layer3_kvnorm.kv_bytes,
            .ne12=1, .nb10=sizeof(float),
            .nb11=n_embd*sizeof(float),
            .nb12=(uint64_t)rows*n_embd*sizeof(float),
            .nb13=(uint64_t)rows*n_embd*sizeof(float),
            .ne0=512, .ne1=rows, .r2=1, .r3=1,
        };
        rust_star_q8_mm_args layer3_attn_compressor_kv_args = {
            .ne00=n_embd, .ne02=1,
            .nb01=(uint64_t)n_embd*sizeof(uint16_t),
            .nb02=weights->layer3_compressor.attn_kv_bytes,
            .nb03=weights->layer3_compressor.attn_kv_bytes,
            .ne12=1, .nb10=sizeof(float),
            .nb11=(uint64_t)n_embd*sizeof(float),
            .nb12=(uint64_t)rows*n_embd*sizeof(float),
            .nb13=(uint64_t)rows*n_embd*sizeof(float),
            .ne0=layer3_compressor_width, .ne1=rows, .r2=1, .r3=1,
        };
        rust_star_q8_mm_args layer3_attn_compressor_gate_args =
            layer3_attn_compressor_kv_args;
        layer3_attn_compressor_gate_args.nb02 =
            weights->layer3_compressor.attn_gate_bytes;
        layer3_attn_compressor_gate_args.nb03 =
            weights->layer3_compressor.attn_gate_bytes;
        rust_star_q8_mm_args layer3_q_b_args = {
            .ne00=1024, .ne02=1, .nb01=(1024u/32u)*34u,
            .nb02=weights->layer3_q_b_bytes,
            .nb03=weights->layer3_q_b_bytes,
            .ne12=1, .nb10=sizeof(float), .nb11=1024u*sizeof(float),
            .nb12=(uint64_t)rows*1024u*sizeof(float),
            .nb13=(uint64_t)rows*1024u*sizeof(float),
            .ne0=q_dim, .ne1=rows, .r2=1, .r3=1,
        };
        rust_star_qkv_norm_args layer3_qkv_norm_args = {
            .q_n=1024, .q_n4=256, .kv_n=512, .kv_n4=128,
            .q_row_stride=1024u*sizeof(float),
            .kv_row_stride=512u*sizeof(float), .eps=1.0e-6f,
        };
        rust_star_rope_tail_args layer3_kv_rope_args = {
            .ne00=512, .ne01=1, .ne02=rows, .ne03=1,
            .nb00=sizeof(float), .nb01=512u*sizeof(float),
            .nb02=512u*sizeof(float), .nb03=(uint64_t)rows*512u*sizeof(float),
            .nb0=sizeof(float), .nb1=512u*sizeof(float),
        ...
        rust_star_fp8_quantize_args layer3_kv_fp8_args = {
            .ne00=512, .ne01=1, .ne02=rows, .ne03=1,
            .nb00=sizeof(float), .nb01=512u*sizeof(float),
            .nb02=512u*sizeof(float), .nb03=(uint64_t)rows*512u*sizeof(float),
            .nb0=sizeof(float), .nb1=512u*sizeof(float),
        ...
        layer3_low_args.nb03 = weights->layer3_attn_output_a_bytes;
        rust_star_q8_mm_args layer3_output_args = output_args;
        layer3_output_args.nb02 = weights->layer3_attn_output_b_bytes;
        layer3_output_args.nb03 = weights->layer3_attn_output_b_bytes;
        rust_star_q8_mm_args layer4_q_a_args = layer3_q_a_args;
        layer4_q_a_args.nb02 = weights->layer4_kvnorm.ingress.q_a_bytes;
        layer4_q_a_args.nb03 = weights->layer4_kvnorm.ingress.q_a_bytes;
        rust_star_q8_mm_args layer4_kv_args = layer3_kv_args;
        layer4_kv_args.nb02 = weights->layer4_kvnorm.kv_bytes;
        layer4_kv_args.nb03 = weights->layer4_kvnorm.kv_bytes;
        rust_star_q8_mm_args layer4_q_b_args = layer3_q_b_args;
        layer4_q_b_args.nb02 = weights->layer4_q_b_bytes;
        layer4_q_b_args.nb03 = weights->layer4_q_b_bytes;
        rust_star_q8_mm_args layer5_q_a_args = layer3_q_a_args;
        layer5_q_a_args.nb02 = weights->layer5_kvnorm.ingress.q_a_bytes;
        layer5_q_a_args.nb03 = weights->layer5_kvnorm.ingress.q_a_bytes;
        rust_star_q8_mm_args layer5_kv_args = layer3_kv_args;
        layer5_kv_args.nb02 = weights->layer5_kvnorm.kv_bytes;
        layer5_kv_args.nb03 = weights->layer5_kvnorm.kv_bytes;
        rust_star_q8_mm_args layer5_q_b_args = layer3_q_b_args;
        layer5_q_b_args.nb02 = weights->layer5_q_b_bytes;
        layer5_q_b_args.nb03 = weights->layer5_q_b_bytes;
        rust_star_q8_mm_args layer6_q_a_args = layer3_q_a_args;
        layer6_q_a_args.nb02 = weights->layer6_kvnorm.ingress.q_a_bytes;
        layer6_q_a_args.nb03 = weights->layer6_kvnorm.ingress.q_a_bytes;
        rust_star_q8_mm_args layer6_kv_args = layer3_kv_args;
        layer6_kv_args.nb02 = weights->layer6_kvnorm.kv_bytes;
        layer6_kv_args.nb03 = weights->layer6_kvnorm.kv_bytes;
        rust_star_q8_mm_args layer6_q_b_args = layer3_q_b_args;
        layer6_q_b_args.nb02 = weights->layer6_q_b_bytes;
        layer6_q_b_args.nb03 = weights->layer6_q_b_bytes;
        rust_star_q8_mm_args layer5_attn_compressor_kv_args =
            layer3_attn_compressor_kv_args;
        layer5_attn_compressor_kv_args.nb02 =
            weights->layer5_compressor.attn_kv_bytes;
        layer5_attn_compressor_kv_args.nb03 =
            weights->layer5_compressor.attn_kv_bytes;
        rust_star_q8_mm_args layer5_attn_compressor_gate_args =
            layer5_attn_compressor_kv_args;
        layer5_attn_compressor_gate_args.nb02 =
            weights->layer5_compressor.attn_gate_bytes;
        layer5_attn_compressor_gate_args.nb03 =
            weights->layer5_compressor.attn_gate_bytes;
        rust_star_q8_mm_args layer4_attn_compressor_kv_args = {
            .ne00=n_embd, .ne02=1,
            .nb01=(uint64_t)n_embd*sizeof(uint16_t),
            .nb02=weights->layer4_compressor.attn_kv_bytes,
            .nb03=weights->layer4_compressor.attn_kv_bytes,
            .ne12=1, .nb10=sizeof(float),
            .nb11=(uint64_t)n_embd*sizeof(float),
            .nb12=(uint64_t)rows*n_embd*sizeof(float),
            .nb13=(uint64_t)rows*n_embd*sizeof(float),
            .ne0=layer4_attn_compressor_width, .ne1=rows, .r2=1, .r3=1,
        };
        rust_star_q8_mm_args layer4_attn_compressor_gate_args =
            layer4_attn_compressor_kv_args;
        layer4_attn_compressor_gate_args.nb02 =
            weights->layer4_compressor.attn_gate_bytes;
        layer4_attn_compressor_gate_args.nb03 =
            weights->layer4_compressor.attn_gate_bytes;
        rust_star_q8_mm_args layer4_indexer_compressor_kv_args =
            layer4_attn_compressor_kv_args;
        layer4_indexer_compressor_kv_args.ne0 =
            layer4_indexer_compressor_width;
        layer4_indexer_compressor_kv_args.nb02 =
            weights->layer4_compressor.indexer_kv_bytes;
        layer4_indexer_compressor_kv_args.nb03 =
            weights->layer4_compressor.indexer_kv_bytes;
        rust_star_q8_mm_args layer4_indexer_compressor_gate_args =
            layer4_indexer_compressor_kv_args;
        layer4_indexer_compressor_gate_args.nb02 =
            weights->layer4_compressor.indexer_gate_bytes;
        ...
        layer4_output_args.nb02 = weights->layer4_attn_output_b_bytes;
        layer4_output_args.nb03 = weights->layer4_attn_output_b_bytes;
        rust_star_q8_mm_id_args layer5_low_args = layer3_low_args;
        layer5_low_args.nb03 = weights->layer5_attn_output_a_bytes;
        rust_star_q8_mm_args layer5_output_args = output_args;
        layer5_output_args.nb02 = weights->layer5_attn_output_b_bytes;
        layer5_output_args.nb03 = weights->layer5_attn_output_b_bytes;
        rust_star_q8_mm_id_args layer6_low_args = low_args;
        layer6_low_args.nb03 = weights->layer6_attn_output_a_bytes;
        rust_star_q8_mm_args layer6_output_args = output_args;
        layer6_output_args.nb02 = weights->layer6_attn_output_b_bytes;
        layer6_output_args.nb03 = weights->layer6_attn_output_b_bytes;
...
#undef RUST_STAR_ENCODE_L2_SHARED
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer3_kv_args length:sizeof(layer3_kv_args) atIndex:0];
        [encoder setBuffer:model_buffers[22] offset:inner[22] atIndex:1];
        [encoder setBuffer:layer3_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer3_kv_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        ...
        [encoder setBuffer:layer3_q_lora_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[21] offset:inner[21] atIndex:2];
        [encoder setBuffer:layer3_q_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer3_kv_raw_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[23] offset:inner[23] atIndex:5];
        [encoder setBuffer:layer3_kv_norm_buffer offset:0 atIndex:6];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,2,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer3_q_b_args length:sizeof(layer3_q_b_args) atIndex:0];
        [encoder setBuffer:model_buffers[24] offset:inner[24] atIndex:1];
        [encoder setBuffer:layer3_q_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:q_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,q_dim/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        id<MTLBlitCommandEncoder> layer3_blit = [command blitCommandEncoder];
        if (!layer3_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-3 Q/KV snapshot encoder");
        [layer3_blit copyFromBuffer:q_buffer sourceOffset:0
                           toBuffer:layer3_q_cur_buffer destinationOffset:0
                               size:q_bytes];
        [layer3_blit copyFromBuffer:layer3_kv_norm_buffer sourceOffset:0
                           toBuffer:layer3_kv_norm_snapshot_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer3_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-3 RoPE encoder");
        [encoder setComputePipelineState:context.headNormRopePipeline];
        [encoder setBytes:&q_rope_args length:sizeof(q_rope_args) atIndex:0];
        ...
        [encoder setBuffer:layer3_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer3_kv_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer3_kv_norm_buffer offset:0 atIndex:4];
        [encoder dispatchThreadgroups:MTLSizeMake(1,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        layer3_blit = [command blitCommandEncoder];
        if (!layer3_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-3 KVrope snapshot encoder");
        [layer3_blit copyFromBuffer:layer3_kv_norm_buffer sourceOffset:0
                           toBuffer:layer3_kv_rope_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer3_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-3 KV finalization encoder");
        [encoder setComputePipelineState:context.compressorFp8Pipeline];
        [encoder setBytes:&layer3_kv_fp8_args
                   length:sizeof(layer3_kv_fp8_args) atIndex:0];
        [encoder setBuffer:layer3_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer3_kv_norm_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:64u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(64,1,1)];

#define RUST_STAR_ENCODE_LAYER3_COMPRESSOR_PROJECTION(args, index, output) do { \
        [encoder setComputePipelineState:context.f16AlignedPrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:layer3_norm_buffer offset:0 atIndex:2]; \
        ...
        [encoder setThreadgroupMemoryLength:6144u atIndex:0]; \
        [encoder dispatchThreadgroups:MTLSizeMake( \
                rows/32u,layer3_compressor_width/64u,1) \
             threadsPerThreadgroup:MTLSizeMake(128,1,1)]; \
    } while (0)
        RUST_STAR_ENCODE_LAYER3_COMPRESSOR_PROJECTION(
            layer3_attn_compressor_kv_args, 26,
            layer3_attn_projected_kv_buffer);
        RUST_STAR_ENCODE_LAYER3_COMPRESSOR_PROJECTION(
            layer3_attn_compressor_gate_args, 27,
            layer3_attn_projected_score_buffer);
#undef RUST_STAR_ENCODE_LAYER3_COMPRESSOR_PROJECTION

        if (!encode_projected_compressor_batch_ratio128(
                context, encoder,
                layer3_attn_projected_kv_buffer,
                layer3_attn_projected_score_buffer,
                layer3_attn_score_ape_buffer,
                model_buffers[25], inner[25],
                model_buffers[28], inner[28],
                layer3_attn_compressed_buffer,
                layer3_compressed_position_buffer,
                0u, rows)) {
            return fail_with_message(error, error_bytes,
                @"failed to encode prefill layer-3 ratio-128 compressor");
        }

        uint32_t layer3_raw_elements = raw_rows*head_dim;
        [encoder setComputePipelineState:context.cpyF32F16Pipeline];
        [encoder setBytes:&layer3_raw_elements
                   length:sizeof(layer3_raw_elements) atIndex:0];
        [encoder setBuffer:layer3_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer3_raw_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        uint32_t layer3_compressed_elements =
            layer3_compressed_rows*head_dim;
        [encoder setBytes:&layer3_compressed_elements
                   length:sizeof(layer3_compressed_elements) atIndex:0];
        [encoder setBuffer:layer3_attn_compressed_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer
                     offset:(NSUInteger)raw_rows*head_f16_bytes atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
        ...
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:2];
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer3_mask_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[29] offset:inner[29] atIndex:5];
        [encoder setBuffer:pad_buffer offset:0 atIndex:6];
        [encoder setBuffer:block_buffer offset:0 atIndex:7];
        [encoder setBuffer:heads_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:28672u atIndex:0];
        ...
        if (!layer3_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-3 attention snapshot encoder");
        [layer3_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer3_kqv_out_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer3_attention_blit endEncoding];
        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to resume prefill layer-3 attention encoder");
        ...
        [encoder setComputePipelineState:context.attentionOutputBatchLowPipeline];
        [encoder setBytes:&layer3_low_args
                   length:sizeof(layer3_low_args) atIndex:0];
        [encoder setBuffer:model_buffers[30] offset:inner[30] atIndex:1];
        [encoder setBuffer:heads_buffer offset:0 atIndex:2];
        [encoder setBuffer:group_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:group_map_buffer offset:tpe_bytes atIndex:4];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:5];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer3_output_args
                   length:sizeof(layer3_output_args) atIndex:0];
        [encoder setBuffer:model_buffers[31] offset:inner[31] atIndex:1];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer3_attention_output_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,n_embd/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];

        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&attention_hc_args
                   length:sizeof(attention_hc_args) atIndex:0];
        [encoder setBuffer:layer3_attention_output_buffer offset:0 atIndex:1];
        [encoder setBuffer:after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer3_split_buffer
                     offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer3_split_buffer
                     offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer3_attention_output_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer3_after_attention_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer3_after_attention_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer3_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer3_after_attention_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer3_ffn_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[32] offset:inner[32] atIndex:1];
        [encoder setBuffer:layer3_ffn_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer3_ffn_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer3_ffn_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[33] offset:inner[33] atIndex:2];
        [encoder setBuffer:model_buffers[34] offset:inner[34] atIndex:3];
        [encoder setBuffer:layer3_after_attention_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer3_ffn_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer3_ffn_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[35] offset:inner[35] atIndex:7];
        [encoder setBuffer:layer3_ffn_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setBytes:&router_args length:sizeof(router_args) atIndex:0];
        [encoder setBuffer:model_buffers[36] offset:inner[36] atIndex:1];
        [encoder setBuffer:layer3_ffn_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer3_router_logits_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,4,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];

        [encoder setComputePipelineState:context.routerSoftplusBatchPipeline];
        [encoder setBuffer:layer3_router_logits_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer3_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerSqrtBatchPipeline];
        [encoder setBuffer:layer3_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer3_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        ...
        [encoder setBuffer:layer3_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:model_buffers[37] offset:inner[37] atIndex:1];
        [encoder setBuffer:layer3_router_selected_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerGatherWeightsBatchPipeline];
        [encoder setBuffer:layer3_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer3_router_selected_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer3_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];

        [encoder setComputePipelineState:context.compressorSumRowsPipeline];
        [encoder setBytes:&router_sum_args length:sizeof(router_sum_args) atIndex:0];
        [encoder setBuffer:layer3_router_weights_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer3_router_weight_sums_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        [encoder setComputePipelineState:context.routerClampSumsBatchPipeline];
        [encoder setBuffer:layer3_router_weight_sums_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer3_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerDivideBatchPipeline];
        [encoder setBuffer:layer3_router_weights_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer3_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer3_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        ...
        [encoder setBuffer:model_buffers[38] offset:inner[38] atIndex:2];
        [encoder setBuffer:model_buffers[39] offset:inner[39] atIndex:3];
        [encoder setBuffer:layer3_ffn_norm_buffer offset:0 atIndex:4];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:5];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:6];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:7];
        [encoder setBuffer:layer3_router_weights_buffer offset:0 atIndex:8];
        [encoder setBuffer:routed_map_buffer offset:routed_map_work_offset atIndex:9];
        [encoder setThreadgroupMemoryLength:16384u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(routed_map_work_cap,32,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.routedBatchDownPipeline];
        [encoder setBytes:&routed_down_args length:sizeof(routed_down_args) atIndex:0];
        [encoder setBuffer:model_buffers[40] offset:inner[40] atIndex:1];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:2];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:4];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:5];
        ...
        [encoder setBytes:&routed_sum_args length:sizeof(routed_sum_args) atIndex:0];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer3_routed_out_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

#define RUST_STAR_ENCODE_L3_SHARED(args, index, input, output, width) do { \
        [encoder setComputePipelineState:context.q8PrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:(input) offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_L3_SHARED(shared_gate_args, 41, layer3_ffn_norm_buffer,
            shared_gate_buffer, 2048);
        RUST_STAR_ENCODE_L3_SHARED(shared_up_args, 42, layer3_ffn_norm_buffer,
            shared_up_buffer, 2048);
        [encoder setComputePipelineState:context.sharedSwigluBatchPipeline];
        [encoder setBytes:&shared_swiglu_args length:sizeof(shared_swiglu_args) atIndex:0];
        [encoder setBuffer:shared_gate_buffer offset:0 atIndex:1];
        ...
        [encoder dispatchThreadgroups:MTLSizeMake((rows*2048u+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        RUST_STAR_ENCODE_L3_SHARED(shared_down_args, 43, shared_mid_buffer,
            layer3_shared_out_buffer, n_embd);
#undef RUST_STAR_ENCODE_L3_SHARED

        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&ffn_hc_post_args length:sizeof(ffn_hc_post_args) atIndex:0];
        [encoder setBuffer:layer3_routed_out_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer3_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer3_ffn_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer3_ffn_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer3_shared_out_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer3_after_ffn_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer3_after_ffn_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer3_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer3_after_ffn_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer4_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[44] offset:inner[44] atIndex:1];
        [encoder setBuffer:layer4_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer4_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer4_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[45] offset:inner[45] atIndex:2];
        [encoder setBuffer:model_buffers[46] offset:inner[46] atIndex:3];
        [encoder setBuffer:layer3_after_ffn_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer4_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer4_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[47] offset:inner[47] atIndex:7];
        [encoder setBuffer:layer4_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];

        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer4_q_a_args length:sizeof(layer4_q_a_args) atIndex:0];
        [encoder setBuffer:model_buffers[48] offset:inner[48] atIndex:1];
        [encoder setBuffer:layer4_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer4_q_lora_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1024u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];

        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer4_kv_args length:sizeof(layer4_kv_args) atIndex:0];
        [encoder setBuffer:model_buffers[50] offset:inner[50] atIndex:1];
        [encoder setBuffer:layer4_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer4_kv_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,512u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBytes:&layer3_qkv_norm_args
                   length:sizeof(layer3_qkv_norm_args) atIndex:0];
        [encoder setBuffer:layer4_q_lora_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[49] offset:inner[49] atIndex:2];
        [encoder setBuffer:layer4_q_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer4_kv_raw_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[51] offset:inner[51] atIndex:5];
        [encoder setBuffer:layer4_kv_norm_buffer offset:0 atIndex:6];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,2,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer4_q_b_args length:sizeof(layer4_q_b_args) atIndex:0];
        [encoder setBuffer:model_buffers[52] offset:inner[52] atIndex:1];
        [encoder setBuffer:layer4_q_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer4_q_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,q_dim/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder endEncoding];

        id<MTLBlitCommandEncoder> layer4_blit = [command blitCommandEncoder];
        if (!layer4_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-4 Q/KV snapshot encoder");
        [layer4_blit copyFromBuffer:layer4_q_raw_buffer sourceOffset:0
                           toBuffer:layer4_q_cur_buffer destinationOffset:0
                               size:q_bytes];
        [layer4_blit copyFromBuffer:layer4_kv_norm_buffer sourceOffset:0
                           toBuffer:layer4_kv_norm_snapshot_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer4_blit copyFromBuffer:heads_buffer sourceOffset:0
                           toBuffer:layer3_kqv_back_row0_buffer destinationOffset:0
                               size:q_dim*sizeof(float)];
        [layer4_blit copyFromBuffer:attention_low_buffer sourceOffset:0
                           toBuffer:layer3_attn_low_row0_buffer destinationOffset:0
                               size:8u*output_rank*sizeof(float)];
        [layer4_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-4 RoPE encoder");
        [encoder setComputePipelineState:context.headNormRopePipeline];
        [encoder setBytes:&q_rope_args length:sizeof(q_rope_args) atIndex:0];
        [encoder setBuffer:layer4_q_cur_buffer offset:0 atIndex:1];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(n_head,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.ropeTailPipeline];
        [encoder setBytes:&layer3_kv_rope_args
                   length:sizeof(layer3_kv_rope_args) atIndex:0];
        [encoder setBuffer:layer4_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer4_kv_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer4_kv_norm_buffer offset:0 atIndex:4];
        [encoder dispatchThreadgroups:MTLSizeMake(1,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        layer4_blit = [command blitCommandEncoder];
        if (!layer4_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-4 KVrope snapshot encoder");
        [layer4_blit copyFromBuffer:layer4_kv_norm_buffer sourceOffset:0
                           toBuffer:layer4_kv_rope_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer4_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-4 KV finalization encoder");
        [encoder setComputePipelineState:context.compressorFp8Pipeline];
        [encoder setBytes:&layer3_kv_fp8_args
                   length:sizeof(layer3_kv_fp8_args) atIndex:0];
        [encoder setBuffer:layer4_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer4_kv_norm_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:64u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(64,1,1)];

#define RUST_STAR_ENCODE_LAYER4_COMPRESSOR_PROJECTION(args, index, width, output) do { \
        [encoder setComputePipelineState:context.f16AlignedPrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:layer4_norm_buffer offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_LAYER4_COMPRESSOR_PROJECTION(
            layer4_attn_compressor_kv_args, 54,
            layer4_attn_compressor_width, layer4_attn_projected_kv_buffer);
        RUST_STAR_ENCODE_LAYER4_COMPRESSOR_PROJECTION(
            layer4_attn_compressor_gate_args, 55,
            layer4_attn_compressor_width, layer4_attn_projected_score_buffer);
        RUST_STAR_ENCODE_LAYER4_COMPRESSOR_PROJECTION(
            layer4_indexer_compressor_kv_args, 58,
            layer4_indexer_compressor_width, layer4_indexer_projected_kv_buffer);
        RUST_STAR_ENCODE_LAYER4_COMPRESSOR_PROJECTION(
            layer4_indexer_compressor_gate_args, 59,
            layer4_indexer_compressor_width,
            layer4_indexer_projected_score_buffer);
#undef RUST_STAR_ENCODE_LAYER4_COMPRESSOR_PROJECTION

        const NSUInteger layer4_tail_activation_offset =
            (NSUInteger)(rows-compressor_ratio)*n_embd*sizeof(float);
        if (!encode_projected_compressor_batch_ratio4(
                context, encoder,
                layer4_norm_buffer, layer4_tail_activation_offset,
                model_buffers[54], inner[54], model_buffers[55], inner[55],
                layer4_attn_projected_kv_buffer,
                layer4_attn_projected_score_buffer,
                layer4_attn_score_ape_buffer,
                layer4_attn_packed_kv_buffer,
                layer4_attn_packed_score_buffer,
                model_buffers[53], inner[53], model_buffers[56], inner[56],
                layer4_attn_state_kv_buffer,
                layer4_attn_state_score_buffer,
            ...
            !encode_projected_compressor_batch_ratio4(
                context, encoder,
                layer4_norm_buffer, layer4_tail_activation_offset,
                model_buffers[58], inner[58], model_buffers[59], inner[59],
                layer4_indexer_projected_kv_buffer,
                layer4_indexer_projected_score_buffer,
                layer4_indexer_score_ape_buffer,
                layer4_indexer_packed_kv_buffer,
                layer4_indexer_packed_score_buffer,
                model_buffers[57], inner[57], model_buffers[60], inner[60],
                layer4_indexer_state_kv_buffer,
                layer4_indexer_state_score_buffer,
        ...
        uint32_t layer4_raw_elements = raw_rows*head_dim;
        [encoder setComputePipelineState:context.cpyF32F16Pipeline];
        [encoder setBytes:&layer4_raw_elements length:sizeof(layer4_raw_elements) atIndex:0];
        [encoder setBuffer:layer4_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer4_raw_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        uint32_t layer4_compressed_elements = compressed_rows*head_dim;
        [encoder setBytes:&layer4_compressed_elements
                   length:sizeof(layer4_compressed_elements) atIndex:0];
        [encoder setBuffer:layer4_attn_compressed_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer
                     offset:(NSUInteger)raw_rows*head_f16_bytes atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer4_compressed_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.flashBlkPipeline];
        [encoder setBytes:&block_args length:sizeof(block_args) atIndex:0];
        [encoder setBuffer:mask_buffer offset:0 atIndex:1];
        ...
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:3];
        [encoder setBuffer:mask_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[61] offset:inner[61] atIndex:5];
        [encoder setBuffer:pad_buffer offset:0 atIndex:6];
        [encoder setBuffer:block_buffer offset:0 atIndex:7];
        [encoder setBuffer:heads_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:28672u atIndex:0];
        ...
        id<MTLBlitCommandEncoder> layer4_attention_blit =
            [command blitCommandEncoder];
        if (!layer4_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-4 attention snapshot encoder");
        [layer4_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer4_kqv_out_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer4_attention_blit endEncoding];
        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to resume prefill layer-4 attention encoder");
        [encoder setComputePipelineState:context.ropeTailPipeline];
        [encoder setBytes:&inverse_args length:sizeof(inverse_args) atIndex:0];
        [encoder setBuffer:heads_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        ...
        [encoder dispatchThreadgroups:MTLSizeMake(1,1,1)
             threadsPerThreadgroup:MTLSizeMake(8,1,1)];
        [encoder setComputePipelineState:context.attentionOutputBatchLowPipeline];
        [encoder setBytes:&layer4_low_args length:sizeof(layer4_low_args) atIndex:0];
        [encoder setBuffer:model_buffers[62] offset:inner[62] atIndex:1];
        [encoder setBuffer:heads_buffer offset:0 atIndex:2];
        [encoder setBuffer:group_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:group_map_buffer offset:tpe_bytes atIndex:4];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:5];
        ...
        [encoder dispatchThreadgroups:MTLSizeMake(work_cap,output_rank/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer4_output_args length:sizeof(layer4_output_args) atIndex:0];
        [encoder setBuffer:model_buffers[63] offset:inner[63] atIndex:1];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer4_attention_output_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,n_embd/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&attention_hc_args length:sizeof(attention_hc_args) atIndex:0];
        [encoder setBuffer:layer4_attention_output_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer3_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer4_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer4_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer4_attention_output_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer4_after_attention_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        [encoder endEncoding];

        layer4_attention_blit = [command blitCommandEncoder];
        if (!layer4_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-4 attention tail snapshot encoder");
        [layer4_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer4_kqv_back_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer4_attention_blit copyFromBuffer:attention_low_buffer sourceOffset:0
                                    toBuffer:layer4_attn_low_row0_buffer
                           destinationOffset:0
                                      size:8u*output_rank*sizeof(float)];
        [layer4_attention_blit endEncoding];
        encoder = [command computeCommandEncoder];
        ...
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer4_after_attention_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer4_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer4_after_attention_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer4_ffn_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[64] offset:inner[64] atIndex:1];
        [encoder setBuffer:layer4_ffn_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer4_ffn_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer4_ffn_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[65] offset:inner[65] atIndex:2];
        [encoder setBuffer:model_buffers[66] offset:inner[66] atIndex:3];
        [encoder setBuffer:layer4_after_attention_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer4_ffn_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer4_ffn_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[67] offset:inner[67] atIndex:7];
        [encoder setBuffer:layer4_ffn_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&router_args length:sizeof(router_args) atIndex:0];
        [encoder setBuffer:model_buffers[68] offset:inner[68] atIndex:1];
        [encoder setBuffer:layer4_ffn_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer4_router_logits_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,4,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];

        [encoder setComputePipelineState:context.routerSoftplusBatchPipeline];
        [encoder setBuffer:layer4_router_logits_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer4_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerSqrtBatchPipeline];
        [encoder setBuffer:layer4_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer4_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerTopkRowsBatchPipeline];
        [encoder setBuffer:layer4_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:model_buffers[69] offset:inner[69] atIndex:1];
        [encoder setBuffer:layer4_router_selected_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerGatherWeightsBatchPipeline];
        [encoder setBuffer:layer4_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer4_router_selected_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer4_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];

        [encoder setComputePipelineState:context.compressorSumRowsPipeline];
        [encoder setBytes:&router_sum_args length:sizeof(router_sum_args) atIndex:0];
        [encoder setBuffer:layer4_router_weights_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer4_router_weight_sums_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        [encoder setComputePipelineState:context.routerClampSumsBatchPipeline];
        [encoder setBuffer:layer4_router_weight_sums_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer4_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerDivideBatchPipeline];
        [encoder setBuffer:layer4_router_weights_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer4_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer4_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        ...
        [encoder setBytes:&routed_gate_args length:sizeof(routed_gate_args) atIndex:0];
        [encoder setBytes:&routed_activation_args length:sizeof(routed_activation_args) atIndex:1];
        [encoder setBuffer:model_buffers[70] offset:inner[70] atIndex:2];
        [encoder setBuffer:model_buffers[71] offset:inner[71] atIndex:3];
        [encoder setBuffer:layer4_ffn_norm_buffer offset:0 atIndex:4];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:5];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:6];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:7];
        [encoder setBuffer:layer4_router_weights_buffer offset:0 atIndex:8];
        [encoder setBuffer:routed_map_buffer offset:routed_map_work_offset atIndex:9];
        [encoder setThreadgroupMemoryLength:16384u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(routed_map_work_cap,32,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.routedBatchDownPipeline];
        [encoder setBytes:&routed_down_args length:sizeof(routed_down_args) atIndex:0];
        [encoder setBuffer:model_buffers[72] offset:inner[72] atIndex:1];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:2];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:4];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:5];
        ...
        [encoder setBytes:&routed_sum_args length:sizeof(routed_sum_args) atIndex:0];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer4_routed_out_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

#define RUST_STAR_ENCODE_L4_SHARED(args, index, input, output, width) do { \
        [encoder setComputePipelineState:context.q8PrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:(input) offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_L4_SHARED(shared_gate_args, 73, layer4_ffn_norm_buffer,
            shared_gate_buffer, 2048);
        RUST_STAR_ENCODE_L4_SHARED(shared_up_args, 74, layer4_ffn_norm_buffer,
            shared_up_buffer, 2048);
        [encoder setComputePipelineState:context.sharedSwigluBatchPipeline];
        [encoder setBytes:&shared_swiglu_args length:sizeof(shared_swiglu_args) atIndex:0];
        [encoder setBuffer:shared_gate_buffer offset:0 atIndex:1];
        ...
        [encoder dispatchThreadgroups:MTLSizeMake((rows*2048u+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        RUST_STAR_ENCODE_L4_SHARED(shared_down_args, 75, shared_mid_buffer,
            layer4_shared_out_buffer, n_embd);
#undef RUST_STAR_ENCODE_L4_SHARED

        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&ffn_hc_post_args length:sizeof(ffn_hc_post_args) atIndex:0];
        [encoder setBuffer:layer4_routed_out_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer4_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer4_ffn_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer4_ffn_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer4_shared_out_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer4_after_ffn_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer4_after_ffn_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer4_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer4_after_ffn_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer5_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[76] offset:inner[76] atIndex:1];
        [encoder setBuffer:layer5_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer5_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer5_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[77] offset:inner[77] atIndex:2];
        [encoder setBuffer:model_buffers[78] offset:inner[78] atIndex:3];
        [encoder setBuffer:layer4_after_ffn_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer5_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer5_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[79] offset:inner[79] atIndex:7];
        [encoder setBuffer:layer5_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];

        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_q_a_args length:sizeof(layer5_q_a_args) atIndex:0];
        [encoder setBuffer:model_buffers[80] offset:inner[80] atIndex:1];
        [encoder setBuffer:layer5_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer5_q_lora_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1024u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];

        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_kv_args length:sizeof(layer5_kv_args) atIndex:0];
        [encoder setBuffer:model_buffers[82] offset:inner[82] atIndex:1];
        [encoder setBuffer:layer5_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer5_kv_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,512u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBytes:&layer3_qkv_norm_args
                   length:sizeof(layer3_qkv_norm_args) atIndex:0];
        [encoder setBuffer:layer5_q_lora_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[81] offset:inner[81] atIndex:2];
        [encoder setBuffer:layer5_q_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer5_kv_raw_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[83] offset:inner[83] atIndex:5];
        [encoder setBuffer:layer5_kv_norm_buffer offset:0 atIndex:6];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,2,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_q_b_args length:sizeof(layer5_q_b_args) atIndex:0];
        [encoder setBuffer:model_buffers[84] offset:inner[84] atIndex:1];
        [encoder setBuffer:layer5_q_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer5_q_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,q_dim/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder endEncoding];

        id<MTLBlitCommandEncoder> layer5_blit = [command blitCommandEncoder];
        if (!layer5_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-5 Q/KV snapshot encoder");
        [layer5_blit copyFromBuffer:layer5_q_raw_buffer sourceOffset:0
                           toBuffer:layer5_q_cur_buffer destinationOffset:0
                               size:q_bytes];
        [layer5_blit copyFromBuffer:layer5_kv_norm_buffer sourceOffset:0
                           toBuffer:layer5_kv_norm_snapshot_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer5_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-5 RoPE encoder");
        [encoder setComputePipelineState:context.headNormRopePipeline];
        [encoder setBytes:&q_rope_args length:sizeof(q_rope_args) atIndex:0];
        [encoder setBuffer:layer5_q_cur_buffer offset:0 atIndex:1];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(n_head,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.ropeTailPipeline];
        [encoder setBytes:&layer3_kv_rope_args
                   length:sizeof(layer3_kv_rope_args) atIndex:0];
        [encoder setBuffer:layer5_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer5_kv_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer5_kv_norm_buffer offset:0 atIndex:4];
        [encoder dispatchThreadgroups:MTLSizeMake(1,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        layer5_blit = [command blitCommandEncoder];
        if (!layer5_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-5 KVrope snapshot encoder");
        [layer5_blit copyFromBuffer:layer5_kv_norm_buffer sourceOffset:0
                           toBuffer:layer5_kv_rope_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer5_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-5 KV finalization encoder");
        [encoder setComputePipelineState:context.compressorFp8Pipeline];
        [encoder setBytes:&layer3_kv_fp8_args
                   length:sizeof(layer3_kv_fp8_args) atIndex:0];
        [encoder setBuffer:layer5_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer5_kv_norm_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:64u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(64,1,1)];

#define RUST_STAR_ENCODE_LAYER5_COMPRESSOR_PROJECTION(args, index, output) do { \
        [encoder setComputePipelineState:context.f16AlignedPrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:layer5_norm_buffer offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_LAYER5_COMPRESSOR_PROJECTION(
            layer5_attn_compressor_kv_args, 86,
            layer5_attn_projected_kv_buffer);
        RUST_STAR_ENCODE_LAYER5_COMPRESSOR_PROJECTION(
            layer5_attn_compressor_gate_args, 87,
            layer5_attn_projected_score_buffer);
#undef RUST_STAR_ENCODE_LAYER5_COMPRESSOR_PROJECTION
        ...
        if (!encode_projected_compressor_batch_ratio128(
                ...
                layer5_attn_projected_score_buffer,
                layer5_attn_score_ape_buffer,
                model_buffers[85], inner[85],
                model_buffers[88], inner[88],
                layer5_attn_compressed_buffer,
                layer5_compressed_position_buffer,
                0u, rows)) {
            return fail_with_message(error, error_bytes,
                @"failed to encode prefill layer-5 ratio-128 compressor");
        }

        uint32_t layer5_raw_elements = raw_rows*head_dim;
        [encoder setComputePipelineState:context.cpyF32F16Pipeline];
        [encoder setBytes:&layer5_raw_elements
                   length:sizeof(layer5_raw_elements) atIndex:0];
        [encoder setBuffer:layer5_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer5_raw_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        uint32_t layer5_compressed_elements =
            layer3_compressed_rows*head_dim;
        [encoder setBytes:&layer5_compressed_elements
                   length:sizeof(layer5_compressed_elements) atIndex:0];
        [encoder setBuffer:layer5_attn_compressed_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer
                     offset:(NSUInteger)raw_rows*head_f16_bytes atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer5_compressed_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        ...
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer3_mask_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[89] offset:inner[89] atIndex:5];
        [encoder setBuffer:pad_buffer offset:0 atIndex:6];
        [encoder setBuffer:block_buffer offset:0 atIndex:7];
        [encoder setBuffer:heads_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:28672u atIndex:0];
        ...
        id<MTLBlitCommandEncoder> layer5_attention_blit =
            [command blitCommandEncoder];
        if (!layer5_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-5 attention snapshot encoder");
        [layer5_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer5_kqv_out_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer5_attention_blit endEncoding];
        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to resume prefill layer-5 attention encoder");
        ...
        [encoder setComputePipelineState:context.attentionOutputBatchLowPipeline];
        [encoder setBytes:&layer5_low_args length:sizeof(layer5_low_args) atIndex:0];
        [encoder setBuffer:model_buffers[90] offset:inner[90] atIndex:1];
        [encoder setBuffer:heads_buffer offset:0 atIndex:2];
        [encoder setBuffer:group_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:group_map_buffer offset:tpe_bytes atIndex:4];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:5];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_output_args
                   length:sizeof(layer5_output_args) atIndex:0];
        [encoder setBuffer:model_buffers[91] offset:inner[91] atIndex:1];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer5_attention_output_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,n_embd/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBytes:&attention_hc_args
                   length:sizeof(attention_hc_args) atIndex:0];
        [encoder setBuffer:layer5_attention_output_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer4_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer5_split_buffer
                     offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer5_split_buffer
                     offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer5_attention_output_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer5_after_attention_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        id<MTLBlitCommandEncoder> layer5_attention_tail_blit =
            [command blitCommandEncoder];
        if (!layer5_attention_tail_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create retained prefill layer-5 attention tail encoder");
        [layer5_attention_tail_blit copyFromBuffer:heads_buffer sourceOffset:0
                                         toBuffer:layer5_kqv_back_row0_buffer
                                destinationOffset:0 size:q_dim*sizeof(float)];
        [layer5_attention_tail_blit copyFromBuffer:attention_low_buffer
                                      sourceOffset:0
                                         toBuffer:layer5_attn_low_row0_buffer
                                destinationOffset:0
                                           size:8u*output_rank*sizeof(float)];
        ...
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer5_after_attention_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer5_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer5_after_attention_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer5_ffn_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[92] offset:inner[92] atIndex:1];
        [encoder setBuffer:layer5_ffn_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer5_ffn_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer5_ffn_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[93] offset:inner[93] atIndex:2];
        [encoder setBuffer:model_buffers[94] offset:inner[94] atIndex:3];
        [encoder setBuffer:layer5_after_attention_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer5_ffn_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer5_ffn_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[95] offset:inner[95] atIndex:7];
        [encoder setBuffer:layer5_ffn_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&router_args length:sizeof(router_args) atIndex:0];
        [encoder setBuffer:model_buffers[96] offset:inner[96] atIndex:1];
        [encoder setBuffer:layer5_ffn_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer5_router_logits_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,4,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];

        [encoder setComputePipelineState:context.routerSoftplusBatchPipeline];
        [encoder setBuffer:layer5_router_logits_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer5_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerSqrtBatchPipeline];
        [encoder setBuffer:layer5_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer5_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerTopkRowsBatchPipeline];
        [encoder setBuffer:layer5_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:model_buffers[97] offset:inner[97] atIndex:1];
        [encoder setBuffer:layer5_router_selected_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerGatherWeightsBatchPipeline];
        [encoder setBuffer:layer5_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer5_router_selected_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer5_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];

        [encoder setComputePipelineState:context.compressorSumRowsPipeline];
        [encoder setBytes:&router_sum_args length:sizeof(router_sum_args) atIndex:0];
        [encoder setBuffer:layer5_router_weights_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer5_router_weight_sums_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        [encoder setComputePipelineState:context.routerClampSumsBatchPipeline];
        [encoder setBuffer:layer5_router_weight_sums_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer5_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerDivideBatchPipeline];
        [encoder setBuffer:layer5_router_weights_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer5_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer5_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        ...
        [encoder setBytes:&routed_gate_args length:sizeof(routed_gate_args) atIndex:0];
        [encoder setBytes:&routed_activation_args length:sizeof(routed_activation_args) atIndex:1];
        [encoder setBuffer:model_buffers[98] offset:inner[98] atIndex:2];
        [encoder setBuffer:model_buffers[99] offset:inner[99] atIndex:3];
        [encoder setBuffer:layer5_ffn_norm_buffer offset:0 atIndex:4];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:5];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:6];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:7];
        [encoder setBuffer:layer5_router_weights_buffer offset:0 atIndex:8];
        [encoder setBuffer:routed_map_buffer offset:routed_map_work_offset atIndex:9];
        [encoder setThreadgroupMemoryLength:16384u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(routed_map_work_cap,32,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.routedBatchDownPipeline];
        [encoder setBytes:&routed_down_args length:sizeof(routed_down_args) atIndex:0];
        [encoder setBuffer:model_buffers[100] offset:inner[100] atIndex:1];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:2];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:4];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:5];
        ...
        [encoder setBytes:&routed_sum_args length:sizeof(routed_sum_args) atIndex:0];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer5_routed_out_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

#define RUST_STAR_ENCODE_L5_SHARED(args, index, input, output, width) do { \
        [encoder setComputePipelineState:context.q8PrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:(input) offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_L5_SHARED(shared_gate_args, 101, layer5_ffn_norm_buffer,
            shared_gate_buffer, 2048);
        RUST_STAR_ENCODE_L5_SHARED(shared_up_args, 102, layer5_ffn_norm_buffer,
            shared_up_buffer, 2048);
        [encoder setComputePipelineState:context.sharedSwigluBatchPipeline];
        [encoder setBytes:&shared_swiglu_args length:sizeof(shared_swiglu_args) atIndex:0];
        [encoder setBuffer:shared_gate_buffer offset:0 atIndex:1];
        ...
        [encoder dispatchThreadgroups:MTLSizeMake((rows*2048u+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        RUST_STAR_ENCODE_L5_SHARED(shared_down_args, 103, shared_mid_buffer,
            layer5_shared_out_buffer, n_embd);
#undef RUST_STAR_ENCODE_L5_SHARED

        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&ffn_hc_post_args length:sizeof(ffn_hc_post_args) atIndex:0];
        [encoder setBuffer:layer5_routed_out_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer5_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer5_ffn_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer5_ffn_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer5_shared_out_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer5_after_ffn_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer5_after_ffn_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer5_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer5_after_ffn_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer6_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[104] offset:inner[104] atIndex:1];
        [encoder setBuffer:layer6_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer6_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer6_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[105] offset:inner[105] atIndex:2];
        [encoder setBuffer:model_buffers[106] offset:inner[106] atIndex:3];
        [encoder setBuffer:layer5_after_ffn_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer6_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer6_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[107] offset:inner[107] atIndex:7];
        [encoder setBuffer:layer6_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setBuffer:model_buffers[108] offset:inner[108] atIndex:1];
        [encoder setBuffer:layer6_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer6_q_lora_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1024u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBuffer:model_buffers[110] offset:inner[110] atIndex:1];
        [encoder setBuffer:layer6_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer6_kv_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,512u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBytes:&layer3_qkv_norm_args
                   length:sizeof(layer3_qkv_norm_args) atIndex:0];
        [encoder setBuffer:layer6_q_lora_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[109] offset:inner[109] atIndex:2];
        [encoder setBuffer:layer6_q_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer6_kv_raw_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[111] offset:inner[111] atIndex:5];
        [encoder setBuffer:layer6_kv_norm_buffer offset:0 atIndex:6];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,2,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        ...
        [encoder setBuffer:model_buffers[112] offset:inner[112] atIndex:1];
        [encoder setBuffer:layer6_q_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer6_q_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,q_dim/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder endEncoding];

        id<MTLBlitCommandEncoder> layer6_blit = [command blitCommandEncoder];
        if (!layer6_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-6 Q/KV snapshot encoder");
        [layer6_blit copyFromBuffer:layer6_q_raw_buffer sourceOffset:0
                           toBuffer:layer6_q_cur_buffer destinationOffset:0
                               size:q_bytes];
        [layer6_blit copyFromBuffer:layer6_kv_norm_buffer sourceOffset:0
                           toBuffer:layer6_kv_norm_snapshot_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer6_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-6 RoPE encoder");
        [encoder setComputePipelineState:context.headNormRopePipeline];
        [encoder setBytes:&q_rope_args length:sizeof(q_rope_args) atIndex:0];
        [encoder setBuffer:layer6_q_cur_buffer offset:0 atIndex:1];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(n_head,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.ropeTailPipeline];
        [encoder setBytes:&layer3_kv_rope_args
                   length:sizeof(layer3_kv_rope_args) atIndex:0];
        [encoder setBuffer:layer6_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer6_kv_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer6_kv_norm_buffer offset:0 atIndex:4];
        [encoder dispatchThreadgroups:MTLSizeMake(1,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        layer6_blit = [command blitCommandEncoder];
        if (!layer6_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-6 KVrope snapshot encoder");
        [layer6_blit copyFromBuffer:layer6_kv_norm_buffer sourceOffset:0
                           toBuffer:layer6_kv_rope_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer6_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-6 KV finalization encoder");
        [encoder setComputePipelineState:context.compressorFp8Pipeline];
        [encoder setBytes:&layer3_kv_fp8_args
                   length:sizeof(layer3_kv_fp8_args) atIndex:0];
        [encoder setBuffer:layer6_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer6_kv_norm_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:64u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(64,1,1)];
...
#undef RUST_STAR_ENCODE_LAYER6_COMPRESSOR_PROJECTION
        ...
        uint32_t layer6_raw_elements = raw_rows*head_dim;
        [encoder setComputePipelineState:context.cpyF32F16Pipeline];
        [encoder setBytes:&layer6_raw_elements length:sizeof(layer6_raw_elements) atIndex:0];
        [encoder setBuffer:layer6_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer6_raw_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        uint32_t layer6_compressed_elements = compressed_rows*head_dim;
        [encoder setBytes:&layer6_compressed_elements
                   length:sizeof(layer6_compressed_elements) atIndex:0];
        [encoder setBuffer:layer6_attn_compressed_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer
                     offset:(NSUInteger)raw_rows*head_f16_bytes atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer6_compressed_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.flashBlkPipeline];
        [encoder setBytes:&block_args length:sizeof(block_args) atIndex:0];
        [encoder setBuffer:mask_buffer offset:0 atIndex:1];
        ...
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:3];
        [encoder setBuffer:mask_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[121] offset:inner[121] atIndex:5];
        [encoder setBuffer:pad_buffer offset:0 atIndex:6];
        [encoder setBuffer:block_buffer offset:0 atIndex:7];
        [encoder setBuffer:heads_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:28672u atIndex:0];
        ...
        id<MTLBlitCommandEncoder> layer6_attention_blit =
            [command blitCommandEncoder];
        if (!layer6_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-6 attention snapshot encoder");
        [layer6_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer6_kqv_out_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer6_attention_blit endEncoding];
        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to resume prefill layer-6 attention encoder");
        [encoder setComputePipelineState:context.ropeTailPipeline];
        [encoder setBytes:&inverse_args length:sizeof(inverse_args) atIndex:0];
        [encoder setBuffer:heads_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        ...
        [encoder setBuffer:model_buffers[122] offset:inner[122] atIndex:1];
        [encoder setBuffer:heads_buffer offset:0 atIndex:2];
        [encoder setBuffer:group_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:group_map_buffer offset:tpe_bytes atIndex:4];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:5];
        ...
        [encoder setBuffer:model_buffers[123] offset:inner[123] atIndex:1];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer6_attention_output_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,n_embd/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&attention_hc_args length:sizeof(attention_hc_args) atIndex:0];
        [encoder setBuffer:layer6_attention_output_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer5_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer6_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer6_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer6_attention_output_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer6_after_attention_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        [encoder endEncoding];

        layer6_attention_blit = [command blitCommandEncoder];
        if (!layer6_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-6 attention tail snapshot encoder");
        [layer6_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer6_kqv_back_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer6_attention_blit copyFromBuffer:attention_low_buffer sourceOffset:0
                                    toBuffer:layer6_attn_low_row0_buffer
                           destinationOffset:0
                                      size:8u*output_rank*sizeof(float)];
        [layer6_attention_blit endEncoding];
        ...
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-6 FFN encoder");
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer6_after_attention_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer6_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer6_after_attention_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer6_ffn_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[124] offset:inner[124] atIndex:1];
        [encoder setBuffer:layer6_ffn_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer6_ffn_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer6_ffn_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[125] offset:inner[125] atIndex:2];
        [encoder setBuffer:model_buffers[126] offset:inner[126] atIndex:3];
        [encoder setBuffer:layer6_after_attention_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer6_ffn_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer6_ffn_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[127] offset:inner[127] atIndex:7];
        [encoder setBuffer:layer6_ffn_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&router_args length:sizeof(router_args) atIndex:0];
        [encoder setBuffer:model_buffers[128] offset:inner[128] atIndex:1];
        [encoder setBuffer:layer6_ffn_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer6_router_logits_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,4,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];

        [encoder setComputePipelineState:context.routerSoftplusBatchPipeline];
        [encoder setBuffer:layer6_router_logits_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer6_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerSqrtBatchPipeline];
        [encoder setBuffer:layer6_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer6_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerTopkRowsBatchPipeline];
        [encoder setBuffer:layer6_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:model_buffers[129] offset:inner[129] atIndex:1];
        [encoder setBuffer:layer6_router_selected_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerGatherWeightsBatchPipeline];
        [encoder setBuffer:layer6_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer6_router_selected_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer6_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];

        [encoder setComputePipelineState:context.compressorSumRowsPipeline];
        [encoder setBytes:&router_sum_args length:sizeof(router_sum_args) atIndex:0];
        [encoder setBuffer:layer6_router_weights_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer6_router_weight_sums_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        [encoder setComputePipelineState:context.routerClampSumsBatchPipeline];
        [encoder setBuffer:layer6_router_weight_sums_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer6_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerDivideBatchPipeline];
        [encoder setBuffer:layer6_router_weights_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer6_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer6_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        ...
        [encoder setBytes:&routed_gate_args length:sizeof(routed_gate_args) atIndex:0];
        [encoder setBytes:&routed_activation_args length:sizeof(routed_activation_args) atIndex:1];
        [encoder setBuffer:model_buffers[130] offset:inner[130] atIndex:2];
        [encoder setBuffer:model_buffers[131] offset:inner[131] atIndex:3];
        [encoder setBuffer:layer6_ffn_norm_buffer offset:0 atIndex:4];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:5];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:6];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:7];
        [encoder setBuffer:layer6_router_weights_buffer offset:0 atIndex:8];
        [encoder setBuffer:routed_map_buffer offset:routed_map_work_offset atIndex:9];
        [encoder setThreadgroupMemoryLength:16384u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(routed_map_work_cap,32,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.routedBatchDownPipeline];
        [encoder setBytes:&routed_down_args length:sizeof(routed_down_args) atIndex:0];
        [encoder setBuffer:model_buffers[132] offset:inner[132] atIndex:1];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:2];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:4];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:5];
        ...
        [encoder setBytes:&routed_sum_args length:sizeof(routed_sum_args) atIndex:0];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer6_routed_out_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

#define RUST_STAR_ENCODE_L6_SHARED(args, index, input, output, width) do { \
        [encoder setComputePipelineState:context.q8PrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:(input) offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_L6_SHARED(shared_gate_args, 133, layer6_ffn_norm_buffer,
            shared_gate_buffer, 2048);
        RUST_STAR_ENCODE_L6_SHARED(shared_up_args, 134, layer6_ffn_norm_buffer,
            shared_up_buffer, 2048);
        [encoder setComputePipelineState:context.sharedSwigluBatchPipeline];
        [encoder setBytes:&shared_swiglu_args length:sizeof(shared_swiglu_args) atIndex:0];
        [encoder setBuffer:shared_gate_buffer offset:0 atIndex:1];
        ...
        [encoder dispatchThreadgroups:MTLSizeMake((rows*2048u+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        RUST_STAR_ENCODE_L6_SHARED(shared_down_args, 135, shared_mid_buffer,
            layer6_shared_out_buffer, n_embd);
#undef RUST_STAR_ENCODE_L6_SHARED

        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&ffn_hc_post_args length:sizeof(ffn_hc_post_args) atIndex:0];
        [encoder setBuffer:layer6_routed_out_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer6_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer6_ffn_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer6_ffn_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer6_shared_out_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer6_after_ffn_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer6_after_ffn_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer6_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer6_after_ffn_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer7_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[136] offset:inner[136] atIndex:1];
        [encoder setBuffer:layer7_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer7_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer7_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[137] offset:inner[137] atIndex:2];
        [encoder setBuffer:model_buffers[138] offset:inner[138] atIndex:3];
        [encoder setBuffer:layer6_after_ffn_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer7_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer7_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[139] offset:inner[139] atIndex:7];
        [encoder setBuffer:layer7_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_q_a_args length:sizeof(layer5_q_a_args) atIndex:0];
        [encoder setBuffer:model_buffers[140] offset:inner[140] atIndex:1];
        [encoder setBuffer:layer7_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer7_q_lora_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1024u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_kv_args length:sizeof(layer5_kv_args) atIndex:0];
        [encoder setBuffer:model_buffers[142] offset:inner[142] atIndex:1];
        [encoder setBuffer:layer7_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer7_kv_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,512u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBytes:&layer3_qkv_norm_args
                   length:sizeof(layer3_qkv_norm_args) atIndex:0];
        [encoder setBuffer:layer7_q_lora_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[141] offset:inner[141] atIndex:2];
        [encoder setBuffer:layer7_q_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer7_kv_raw_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[143] offset:inner[143] atIndex:5];
        [encoder setBuffer:layer7_kv_norm_buffer offset:0 atIndex:6];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,2,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_q_b_args length:sizeof(layer5_q_b_args) atIndex:0];
        [encoder setBuffer:model_buffers[144] offset:inner[144] atIndex:1];
        [encoder setBuffer:layer7_q_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer7_q_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,q_dim/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder endEncoding];

        id<MTLBlitCommandEncoder> layer7_blit = [command blitCommandEncoder];
        if (!layer7_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-7 Q/KV snapshot encoder");
        [layer7_blit copyFromBuffer:layer7_q_raw_buffer sourceOffset:0
                           toBuffer:layer7_q_cur_buffer destinationOffset:0
                               size:q_bytes];
        [layer7_blit copyFromBuffer:layer7_kv_norm_buffer sourceOffset:0
                           toBuffer:layer7_kv_norm_snapshot_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer7_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-7 RoPE encoder");
        [encoder setComputePipelineState:context.headNormRopePipeline];
        [encoder setBytes:&q_rope_args length:sizeof(q_rope_args) atIndex:0];
        [encoder setBuffer:layer7_q_cur_buffer offset:0 atIndex:1];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(n_head,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.ropeTailPipeline];
        [encoder setBytes:&layer3_kv_rope_args
                   length:sizeof(layer3_kv_rope_args) atIndex:0];
        [encoder setBuffer:layer7_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer7_kv_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer7_kv_norm_buffer offset:0 atIndex:4];
        [encoder dispatchThreadgroups:MTLSizeMake(1,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        layer7_blit = [command blitCommandEncoder];
        if (!layer7_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-7 KVrope snapshot encoder");
        [layer7_blit copyFromBuffer:layer7_kv_norm_buffer sourceOffset:0
                           toBuffer:layer7_kv_rope_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer7_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-7 KV finalization encoder");
        [encoder setComputePipelineState:context.compressorFp8Pipeline];
        [encoder setBytes:&layer3_kv_fp8_args
                   length:sizeof(layer3_kv_fp8_args) atIndex:0];
        [encoder setBuffer:layer7_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer7_kv_norm_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:64u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(64,1,1)];

#define RUST_STAR_ENCODE_LAYER7_COMPRESSOR_PROJECTION(args, index, output) do { \
        [encoder setComputePipelineState:context.f16AlignedPrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:layer7_norm_buffer offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_LAYER7_COMPRESSOR_PROJECTION(
            layer5_attn_compressor_kv_args, 146,
            layer7_attn_projected_kv_buffer);
        RUST_STAR_ENCODE_LAYER7_COMPRESSOR_PROJECTION(
            layer5_attn_compressor_gate_args, 147,
            layer7_attn_projected_score_buffer);
#undef RUST_STAR_ENCODE_LAYER7_COMPRESSOR_PROJECTION

        if (!encode_projected_compressor_batch_ratio128(
                context, encoder,
                layer7_attn_projected_kv_buffer,
                layer7_attn_projected_score_buffer,
                layer7_attn_score_ape_buffer,
                model_buffers[145], inner[145],
                model_buffers[148], inner[148],
                layer7_attn_compressed_buffer,
                layer7_compressed_position_buffer,
                0u, rows)) {
            return fail_with_message(error, error_bytes,
                @"failed to encode prefill layer-7 ratio-128 compressor");
        }

        uint32_t layer7_raw_elements = raw_rows*head_dim;
        [encoder setComputePipelineState:context.cpyF32F16Pipeline];
        [encoder setBytes:&layer7_raw_elements
                   length:sizeof(layer7_raw_elements) atIndex:0];
        [encoder setBuffer:layer7_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer7_raw_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        uint32_t layer7_compressed_elements =
            layer3_compressed_rows*head_dim;
        [encoder setBytes:&layer7_compressed_elements
                   length:sizeof(layer7_compressed_elements) atIndex:0];
        [encoder setBuffer:layer7_attn_compressed_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer
                     offset:(NSUInteger)raw_rows*head_f16_bytes atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer7_compressed_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        ...
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer3_mask_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[149] offset:inner[149] atIndex:5];
        [encoder setBuffer:pad_buffer offset:0 atIndex:6];
        [encoder setBuffer:block_buffer offset:0 atIndex:7];
        [encoder setBuffer:heads_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:28672u atIndex:0];
        ...
        id<MTLBlitCommandEncoder> layer7_attention_blit =
            [command blitCommandEncoder];
        if (!layer7_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-7 attention snapshot encoder");
        [layer7_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer7_kqv_out_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer7_attention_blit endEncoding];
        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to resume prefill layer-7 attention encoder");
        ...
        [encoder setComputePipelineState:context.attentionOutputBatchLowPipeline];
        [encoder setBytes:&layer5_low_args length:sizeof(layer5_low_args) atIndex:0];
        [encoder setBuffer:model_buffers[150] offset:inner[150] atIndex:1];
        [encoder setBuffer:heads_buffer offset:0 atIndex:2];
        [encoder setBuffer:group_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:group_map_buffer offset:tpe_bytes atIndex:4];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:5];
        ...
        [encoder setBytes:&layer5_output_args
                   length:sizeof(layer5_output_args) atIndex:0];
        [encoder setBuffer:model_buffers[151] offset:inner[151] atIndex:1];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer7_attention_output_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,n_embd/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBytes:&attention_hc_args
                   length:sizeof(attention_hc_args) atIndex:0];
        [encoder setBuffer:layer7_attention_output_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer6_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer7_split_buffer
                     offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer7_split_buffer
                     offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer7_attention_output_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer7_after_attention_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        id<MTLBlitCommandEncoder> layer7_attention_tail_blit =
            [command blitCommandEncoder];
        if (!layer7_attention_tail_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create retained prefill layer-7 attention tail encoder");
        [layer7_attention_tail_blit copyFromBuffer:heads_buffer sourceOffset:0
                                         toBuffer:layer7_kqv_back_row0_buffer
                                destinationOffset:0 size:q_dim*sizeof(float)];
        [layer7_attention_tail_blit copyFromBuffer:attention_low_buffer
                                      sourceOffset:0
                                         toBuffer:layer7_attn_low_row0_buffer
                                destinationOffset:0
                                           size:8u*output_rank*sizeof(float)];
        [layer7_attention_tail_blit endEncoding];
        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to resume prefill layer-7 FFN encoder");

        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer7_after_attention_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer7_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer7_after_attention_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer7_ffn_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[152] offset:inner[152] atIndex:1];
        [encoder setBuffer:layer7_ffn_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer7_ffn_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer7_ffn_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[153] offset:inner[153] atIndex:2];
        [encoder setBuffer:model_buffers[154] offset:inner[154] atIndex:3];
        [encoder setBuffer:layer7_after_attention_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer7_ffn_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer7_ffn_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[155] offset:inner[155] atIndex:7];
        [encoder setBuffer:layer7_ffn_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&router_args length:sizeof(router_args) atIndex:0];
        [encoder setBuffer:model_buffers[156] offset:inner[156] atIndex:1];
        [encoder setBuffer:layer7_ffn_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer7_router_logits_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,4,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];

        [encoder setComputePipelineState:context.routerSoftplusBatchPipeline];
        [encoder setBuffer:layer7_router_logits_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer7_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerSqrtBatchPipeline];
        [encoder setBuffer:layer7_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer7_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerTopkRowsBatchPipeline];
        [encoder setBuffer:layer7_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:model_buffers[157] offset:inner[157] atIndex:1];
        [encoder setBuffer:layer7_router_selected_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerGatherWeightsBatchPipeline];
        [encoder setBuffer:layer7_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer7_router_selected_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer7_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];

        [encoder setComputePipelineState:context.compressorSumRowsPipeline];
        [encoder setBytes:&router_sum_args length:sizeof(router_sum_args) atIndex:0];
        [encoder setBuffer:layer7_router_weights_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer7_router_weight_sums_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        [encoder setComputePipelineState:context.routerClampSumsBatchPipeline];
        [encoder setBuffer:layer7_router_weight_sums_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer7_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerDivideBatchPipeline];
        [encoder setBuffer:layer7_router_weights_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer7_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer7_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        ...
        [encoder setBytes:&routed_gate_args length:sizeof(routed_gate_args) atIndex:0];
        [encoder setBytes:&routed_activation_args length:sizeof(routed_activation_args) atIndex:1];
        [encoder setBuffer:model_buffers[158] offset:inner[158] atIndex:2];
        [encoder setBuffer:model_buffers[159] offset:inner[159] atIndex:3];
        [encoder setBuffer:layer7_ffn_norm_buffer offset:0 atIndex:4];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:5];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:6];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:7];
        [encoder setBuffer:layer7_router_weights_buffer offset:0 atIndex:8];
        [encoder setBuffer:routed_map_buffer offset:routed_map_work_offset atIndex:9];
        [encoder setThreadgroupMemoryLength:16384u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(routed_map_work_cap,32,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.routedBatchDownPipeline];
        [encoder setBytes:&routed_down_args length:sizeof(routed_down_args) atIndex:0];
        [encoder setBuffer:model_buffers[160] offset:inner[160] atIndex:1];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:2];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:4];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:5];
        ...
        [encoder setBytes:&routed_sum_args length:sizeof(routed_sum_args) atIndex:0];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer7_routed_out_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

#define RUST_STAR_ENCODE_L7_SHARED(args, index, input, output, width) do { \
        [encoder setComputePipelineState:context.q8PrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:(input) offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_L7_SHARED(shared_gate_args, 161, layer7_ffn_norm_buffer,
            shared_gate_buffer, 2048);
        RUST_STAR_ENCODE_L7_SHARED(shared_up_args, 162, layer7_ffn_norm_buffer,
            shared_up_buffer, 2048);
        [encoder setComputePipelineState:context.sharedSwigluBatchPipeline];
        [encoder setBytes:&shared_swiglu_args length:sizeof(shared_swiglu_args) atIndex:0];
        [encoder setBuffer:shared_gate_buffer offset:0 atIndex:1];
        ...
        [encoder dispatchThreadgroups:MTLSizeMake((rows*2048u+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        RUST_STAR_ENCODE_L7_SHARED(shared_down_args, 163, shared_mid_buffer,
            layer7_shared_out_buffer, n_embd);
#undef RUST_STAR_ENCODE_L7_SHARED

        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&ffn_hc_post_args length:sizeof(ffn_hc_post_args) atIndex:0];
        [encoder setBuffer:layer7_routed_out_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer7_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer7_ffn_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer7_ffn_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer7_shared_out_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer7_after_ffn_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer7_after_ffn_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer7_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer7_after_ffn_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer8_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[164] offset:inner[164] atIndex:1];
        [encoder setBuffer:layer8_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer8_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer8_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[165] offset:inner[165] atIndex:2];
        [encoder setBuffer:model_buffers[166] offset:inner[166] atIndex:3];
        [encoder setBuffer:layer7_after_ffn_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer8_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer8_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[167] offset:inner[167] atIndex:7];
        [encoder setBuffer:layer8_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer6_q_a_args length:sizeof(layer6_q_a_args) atIndex:0];
        [encoder setBuffer:model_buffers[168] offset:inner[168] atIndex:1];
        [encoder setBuffer:layer8_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer8_q_lora_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1024u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer6_kv_args length:sizeof(layer6_kv_args) atIndex:0];
        [encoder setBuffer:model_buffers[170] offset:inner[170] atIndex:1];
        [encoder setBuffer:layer8_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer8_kv_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,512u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBytes:&layer3_qkv_norm_args
                   length:sizeof(layer3_qkv_norm_args) atIndex:0];
        [encoder setBuffer:layer8_q_lora_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[169] offset:inner[169] atIndex:2];
        [encoder setBuffer:layer8_q_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer8_kv_raw_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[171] offset:inner[171] atIndex:5];
        [encoder setBuffer:layer8_kv_norm_buffer offset:0 atIndex:6];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,2,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer6_q_b_args length:sizeof(layer6_q_b_args) atIndex:0];
        [encoder setBuffer:model_buffers[172] offset:inner[172] atIndex:1];
        [encoder setBuffer:layer8_q_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer8_q_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,q_dim/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder endEncoding];

        id<MTLBlitCommandEncoder> layer8_blit = [command blitCommandEncoder];
        if (!layer8_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-8 Q/KV snapshot encoder");
        [layer8_blit copyFromBuffer:layer8_q_raw_buffer sourceOffset:0
                           toBuffer:layer8_q_cur_buffer destinationOffset:0
                               size:q_bytes];
        [layer8_blit copyFromBuffer:layer8_kv_norm_buffer sourceOffset:0
                           toBuffer:layer8_kv_norm_snapshot_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer8_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-8 RoPE encoder");
        [encoder setComputePipelineState:context.headNormRopePipeline];
        [encoder setBytes:&q_rope_args length:sizeof(q_rope_args) atIndex:0];
        [encoder setBuffer:layer8_q_cur_buffer offset:0 atIndex:1];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(n_head,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.ropeTailPipeline];
        [encoder setBytes:&layer3_kv_rope_args
                   length:sizeof(layer3_kv_rope_args) atIndex:0];
        [encoder setBuffer:layer8_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer8_kv_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer8_kv_norm_buffer offset:0 atIndex:4];
        [encoder dispatchThreadgroups:MTLSizeMake(1,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        layer8_blit = [command blitCommandEncoder];
        if (!layer8_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-8 KVrope snapshot encoder");
        [layer8_blit copyFromBuffer:layer8_kv_norm_buffer sourceOffset:0
                           toBuffer:layer8_kv_rope_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer8_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-8 KV finalization encoder");
        [encoder setComputePipelineState:context.compressorFp8Pipeline];
        [encoder setBytes:&layer3_kv_fp8_args
                   length:sizeof(layer3_kv_fp8_args) atIndex:0];
        [encoder setBuffer:layer8_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer8_kv_norm_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:64u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(64,1,1)];

#define RUST_STAR_ENCODE_LAYER8_COMPRESSOR_PROJECTION(args, index, width, output) do { \
        [encoder setComputePipelineState:context.f16AlignedPrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:layer8_norm_buffer offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_LAYER8_COMPRESSOR_PROJECTION(
            layer6_attn_compressor_kv_args, 174,
            layer4_attn_compressor_width, layer8_attn_projected_kv_buffer);
        RUST_STAR_ENCODE_LAYER8_COMPRESSOR_PROJECTION(
            layer6_attn_compressor_gate_args, 175,
            layer4_attn_compressor_width, layer8_attn_projected_score_buffer);
        RUST_STAR_ENCODE_LAYER8_COMPRESSOR_PROJECTION(
            layer6_indexer_compressor_kv_args, 178,
            layer4_indexer_compressor_width, layer8_indexer_projected_kv_buffer);
        RUST_STAR_ENCODE_LAYER8_COMPRESSOR_PROJECTION(
            layer6_indexer_compressor_gate_args, 179,
            layer4_indexer_compressor_width,
            layer8_indexer_projected_score_buffer);
#undef RUST_STAR_ENCODE_LAYER8_COMPRESSOR_PROJECTION

        const NSUInteger layer8_tail_activation_offset =
            (NSUInteger)(rows-compressor_ratio)*n_embd*sizeof(float);
        if (!encode_projected_compressor_batch_ratio4(
                context, encoder,
                layer8_norm_buffer, layer8_tail_activation_offset,
                model_buffers[174], inner[174], model_buffers[175], inner[175],
                layer8_attn_projected_kv_buffer,
                layer8_attn_projected_score_buffer,
                layer8_attn_score_ape_buffer,
                layer8_attn_packed_kv_buffer,
                layer8_attn_packed_score_buffer,
                model_buffers[173], inner[173], model_buffers[176], inner[176],
                layer8_attn_state_kv_buffer,
                layer8_attn_state_score_buffer,
            ...
            !encode_projected_compressor_batch_ratio4(
                context, encoder,
                layer8_norm_buffer, layer8_tail_activation_offset,
                model_buffers[178], inner[178], model_buffers[179], inner[179],
                layer8_indexer_projected_kv_buffer,
                layer8_indexer_projected_score_buffer,
                layer8_indexer_score_ape_buffer,
                layer8_indexer_packed_kv_buffer,
                layer8_indexer_packed_score_buffer,
                model_buffers[177], inner[177], model_buffers[180], inner[180],
                layer8_indexer_state_kv_buffer,
                layer8_indexer_state_score_buffer,
        ...
        uint32_t layer8_raw_elements = raw_rows*head_dim;
        [encoder setComputePipelineState:context.cpyF32F16Pipeline];
        [encoder setBytes:&layer8_raw_elements length:sizeof(layer8_raw_elements) atIndex:0];
        [encoder setBuffer:layer8_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer8_raw_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        uint32_t layer8_compressed_elements = compressed_rows*head_dim;
        [encoder setBytes:&layer8_compressed_elements
                   length:sizeof(layer8_compressed_elements) atIndex:0];
        [encoder setBuffer:layer8_attn_compressed_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer
                     offset:(NSUInteger)raw_rows*head_f16_bytes atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer8_compressed_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.flashBlkPipeline];
        [encoder setBytes:&block_args length:sizeof(block_args) atIndex:0];
        [encoder setBuffer:mask_buffer offset:0 atIndex:1];
        ...
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:3];
        [encoder setBuffer:mask_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[181] offset:inner[181] atIndex:5];
        [encoder setBuffer:pad_buffer offset:0 atIndex:6];
        [encoder setBuffer:block_buffer offset:0 atIndex:7];
        [encoder setBuffer:heads_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:28672u atIndex:0];
        ...
        id<MTLBlitCommandEncoder> layer8_attention_blit =
            [command blitCommandEncoder];
        if (!layer8_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-8 attention snapshot encoder");
        [layer8_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer8_kqv_out_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer8_attention_blit endEncoding];
        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to resume prefill layer-8 attention encoder");
        [encoder setComputePipelineState:context.ropeTailPipeline];
        [encoder setBytes:&inverse_args length:sizeof(inverse_args) atIndex:0];
        [encoder setBuffer:heads_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        ...
        [encoder setComputePipelineState:context.attentionOutputBatchLowPipeline];
        [encoder setBytes:&layer6_low_args length:sizeof(layer6_low_args) atIndex:0];
        [encoder setBuffer:model_buffers[182] offset:inner[182] atIndex:1];
        [encoder setBuffer:heads_buffer offset:0 atIndex:2];
        [encoder setBuffer:group_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:group_map_buffer offset:tpe_bytes atIndex:4];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:5];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer6_output_args length:sizeof(layer6_output_args) atIndex:0];
        [encoder setBuffer:model_buffers[183] offset:inner[183] atIndex:1];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer8_attention_output_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,n_embd/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&attention_hc_args length:sizeof(attention_hc_args) atIndex:0];
        [encoder setBuffer:layer8_attention_output_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer7_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer8_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer8_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer8_attention_output_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer8_after_attention_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        [encoder endEncoding];

        layer8_attention_blit = [command blitCommandEncoder];
        if (!layer8_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-8 attention tail snapshot encoder");
        [layer8_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer8_kqv_back_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer8_attention_blit copyFromBuffer:attention_low_buffer sourceOffset:0
                                    toBuffer:layer8_attn_low_row0_buffer
                           destinationOffset:0
                                      size:8u*output_rank*sizeof(float)];
        [layer8_attention_blit endEncoding];
        ...
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-8 FFN encoder");
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer8_after_attention_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer8_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer8_after_attention_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer8_ffn_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[184] offset:inner[184] atIndex:1];
        [encoder setBuffer:layer8_ffn_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer8_ffn_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer8_ffn_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[185] offset:inner[185] atIndex:2];
        [encoder setBuffer:model_buffers[186] offset:inner[186] atIndex:3];
        [encoder setBuffer:layer8_after_attention_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer8_ffn_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer8_ffn_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[187] offset:inner[187] atIndex:7];
        [encoder setBuffer:layer8_ffn_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&router_args length:sizeof(router_args) atIndex:0];
        [encoder setBuffer:model_buffers[188] offset:inner[188] atIndex:1];
        [encoder setBuffer:layer8_ffn_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer8_router_logits_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,4,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];

        [encoder setComputePipelineState:context.routerSoftplusBatchPipeline];
        [encoder setBuffer:layer8_router_logits_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer8_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerSqrtBatchPipeline];
        [encoder setBuffer:layer8_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer8_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerTopkRowsBatchPipeline];
        [encoder setBuffer:layer8_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:model_buffers[189] offset:inner[189] atIndex:1];
        [encoder setBuffer:layer8_router_selected_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerGatherWeightsBatchPipeline];
        [encoder setBuffer:layer8_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer8_router_selected_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer8_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];

        [encoder setComputePipelineState:context.compressorSumRowsPipeline];
        [encoder setBytes:&router_sum_args length:sizeof(router_sum_args) atIndex:0];
        [encoder setBuffer:layer8_router_weights_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer8_router_weight_sums_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        [encoder setComputePipelineState:context.routerClampSumsBatchPipeline];
        [encoder setBuffer:layer8_router_weight_sums_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer8_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerDivideBatchPipeline];
        [encoder setBuffer:layer8_router_weights_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer8_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer8_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        ...
        [encoder setBytes:&routed_gate_args length:sizeof(routed_gate_args) atIndex:0];
        [encoder setBytes:&routed_activation_args length:sizeof(routed_activation_args) atIndex:1];
        [encoder setBuffer:model_buffers[190] offset:inner[190] atIndex:2];
        [encoder setBuffer:model_buffers[191] offset:inner[191] atIndex:3];
        [encoder setBuffer:layer8_ffn_norm_buffer offset:0 atIndex:4];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:5];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:6];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:7];
        [encoder setBuffer:layer8_router_weights_buffer offset:0 atIndex:8];
        [encoder setBuffer:routed_map_buffer offset:routed_map_work_offset atIndex:9];
        [encoder setThreadgroupMemoryLength:16384u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(routed_map_work_cap,32,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.routedBatchDownPipeline];
        [encoder setBytes:&routed_down_args length:sizeof(routed_down_args) atIndex:0];
        [encoder setBuffer:model_buffers[192] offset:inner[192] atIndex:1];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:2];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:4];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:5];
        ...
        [encoder setBytes:&routed_sum_args length:sizeof(routed_sum_args) atIndex:0];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer8_routed_out_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

#define RUST_STAR_ENCODE_L8_SHARED(args, index, input, output, width) do { \
        [encoder setComputePipelineState:context.q8PrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:(input) offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_L8_SHARED(shared_gate_args, 193, layer8_ffn_norm_buffer,
            shared_gate_buffer, 2048);
        RUST_STAR_ENCODE_L8_SHARED(shared_up_args, 194, layer8_ffn_norm_buffer,
            shared_up_buffer, 2048);
        [encoder setComputePipelineState:context.sharedSwigluBatchPipeline];
        [encoder setBytes:&shared_swiglu_args length:sizeof(shared_swiglu_args) atIndex:0];
        [encoder setBuffer:shared_gate_buffer offset:0 atIndex:1];
        ...
        [encoder dispatchThreadgroups:MTLSizeMake((rows*2048u+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        RUST_STAR_ENCODE_L8_SHARED(shared_down_args, 195, shared_mid_buffer,
            layer8_shared_out_buffer, n_embd);
#undef RUST_STAR_ENCODE_L8_SHARED

        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&ffn_hc_post_args length:sizeof(ffn_hc_post_args) atIndex:0];
        [encoder setBuffer:layer8_routed_out_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer8_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer8_ffn_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer8_ffn_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer8_shared_out_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer8_after_ffn_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer8_after_ffn_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer8_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer8_after_ffn_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer9_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[196] offset:inner[196] atIndex:1];
        [encoder setBuffer:layer9_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer9_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer9_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[197] offset:inner[197] atIndex:2];
        [encoder setBuffer:model_buffers[198] offset:inner[198] atIndex:3];
        [encoder setBuffer:layer8_after_ffn_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer9_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer9_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[199] offset:inner[199] atIndex:7];
        [encoder setBuffer:layer9_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_q_a_args length:sizeof(layer5_q_a_args) atIndex:0];
        [encoder setBuffer:model_buffers[200] offset:inner[200] atIndex:1];
        [encoder setBuffer:layer9_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer9_q_lora_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1024u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_kv_args length:sizeof(layer5_kv_args) atIndex:0];
        [encoder setBuffer:model_buffers[202] offset:inner[202] atIndex:1];
        [encoder setBuffer:layer9_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer9_kv_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,512u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBytes:&layer3_qkv_norm_args
                   length:sizeof(layer3_qkv_norm_args) atIndex:0];
        [encoder setBuffer:layer9_q_lora_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[201] offset:inner[201] atIndex:2];
        [encoder setBuffer:layer9_q_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer9_kv_raw_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[203] offset:inner[203] atIndex:5];
        [encoder setBuffer:layer9_kv_norm_buffer offset:0 atIndex:6];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,2,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_q_b_args length:sizeof(layer5_q_b_args) atIndex:0];
        [encoder setBuffer:model_buffers[204] offset:inner[204] atIndex:1];
        [encoder setBuffer:layer9_q_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer9_q_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,q_dim/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder endEncoding];

        id<MTLBlitCommandEncoder> layer9_blit = [command blitCommandEncoder];
        if (!layer9_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-7 Q/KV snapshot encoder");
        [layer9_blit copyFromBuffer:layer9_q_raw_buffer sourceOffset:0
                           toBuffer:layer9_q_cur_buffer destinationOffset:0
                               size:q_bytes];
        [layer9_blit copyFromBuffer:layer9_kv_norm_buffer sourceOffset:0
                           toBuffer:layer9_kv_norm_snapshot_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer9_blit endEncoding];
        ...
        [encoder setComputePipelineState:context.headNormRopePipeline];
        [encoder setBytes:&q_rope_args length:sizeof(q_rope_args) atIndex:0];
        [encoder setBuffer:layer9_q_cur_buffer offset:0 atIndex:1];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(n_head,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.ropeTailPipeline];
        [encoder setBytes:&layer3_kv_rope_args
                   length:sizeof(layer3_kv_rope_args) atIndex:0];
        [encoder setBuffer:layer9_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer9_kv_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer9_kv_norm_buffer offset:0 atIndex:4];
        [encoder dispatchThreadgroups:MTLSizeMake(1,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        layer9_blit = [command blitCommandEncoder];
        if (!layer9_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-7 KVrope snapshot encoder");
        [layer9_blit copyFromBuffer:layer9_kv_norm_buffer sourceOffset:0
                           toBuffer:layer9_kv_rope_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer9_blit endEncoding];
        ...
        [encoder setBytes:&layer3_kv_fp8_args
                   length:sizeof(layer3_kv_fp8_args) atIndex:0];
        [encoder setBuffer:layer9_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer9_kv_norm_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:64u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(64,1,1)];

#define RUST_STAR_ENCODE_LAYER9_COMPRESSOR_PROJECTION(args, index, output) do { \
        [encoder setComputePipelineState:context.f16AlignedPrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:layer9_norm_buffer offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_LAYER9_COMPRESSOR_PROJECTION(
            layer5_attn_compressor_kv_args, 206,
            layer9_attn_projected_kv_buffer);
        RUST_STAR_ENCODE_LAYER9_COMPRESSOR_PROJECTION(
            layer5_attn_compressor_gate_args, 207,
            layer9_attn_projected_score_buffer);
#undef RUST_STAR_ENCODE_LAYER9_COMPRESSOR_PROJECTION

        if (!encode_projected_compressor_batch_ratio128(
                context, encoder,
                layer9_attn_projected_kv_buffer,
                layer9_attn_projected_score_buffer,
                layer9_attn_score_ape_buffer,
                model_buffers[205], inner[205],
                model_buffers[208], inner[208],
                layer9_attn_compressed_buffer,
                layer9_compressed_position_buffer,
                0u, rows)) {
            return fail_with_message(error, error_bytes,
                @"failed to encode prefill layer-7 ratio-128 compressor");
        ...
        uint32_t layer9_raw_elements = raw_rows*head_dim;
        [encoder setComputePipelineState:context.cpyF32F16Pipeline];
        [encoder setBytes:&layer9_raw_elements
                   length:sizeof(layer9_raw_elements) atIndex:0];
        [encoder setBuffer:layer9_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer9_raw_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        uint32_t layer9_compressed_elements =
            layer3_compressed_rows*head_dim;
        [encoder setBytes:&layer9_compressed_elements
                   length:sizeof(layer9_compressed_elements) atIndex:0];
        [encoder setBuffer:layer9_attn_compressed_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer
                     offset:(NSUInteger)raw_rows*head_f16_bytes atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer9_compressed_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        ...
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer3_mask_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[209] offset:inner[209] atIndex:5];
        [encoder setBuffer:pad_buffer offset:0 atIndex:6];
        [encoder setBuffer:block_buffer offset:0 atIndex:7];
        [encoder setBuffer:heads_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:28672u atIndex:0];
        ...
        id<MTLBlitCommandEncoder> layer9_attention_blit =
            [command blitCommandEncoder];
        if (!layer9_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-7 attention snapshot encoder");
        [layer9_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer9_kqv_out_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer9_attention_blit endEncoding];
        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to resume prefill layer-7 attention encoder");
        ...
        [encoder setComputePipelineState:context.attentionOutputBatchLowPipeline];
        [encoder setBytes:&layer5_low_args length:sizeof(layer5_low_args) atIndex:0];
        [encoder setBuffer:model_buffers[210] offset:inner[210] atIndex:1];
        [encoder setBuffer:heads_buffer offset:0 atIndex:2];
        [encoder setBuffer:group_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:group_map_buffer offset:tpe_bytes atIndex:4];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:5];
        ...
        [encoder setBytes:&layer5_output_args
                   length:sizeof(layer5_output_args) atIndex:0];
        [encoder setBuffer:model_buffers[211] offset:inner[211] atIndex:1];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer9_attention_output_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,n_embd/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBytes:&attention_hc_args
                   length:sizeof(attention_hc_args) atIndex:0];
        [encoder setBuffer:layer9_attention_output_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer8_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer9_split_buffer
                     offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer9_split_buffer
                     offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer9_attention_output_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer9_after_attention_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        id<MTLBlitCommandEncoder> layer9_attention_tail_blit =
            [command blitCommandEncoder];
        if (!layer9_attention_tail_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create retained prefill layer-7 attention tail encoder");
        [layer9_attention_tail_blit copyFromBuffer:heads_buffer sourceOffset:0
                                         toBuffer:layer9_kqv_back_row0_buffer
                                destinationOffset:0 size:q_dim*sizeof(float)];
        [layer9_attention_tail_blit copyFromBuffer:attention_low_buffer
                                      sourceOffset:0
                                         toBuffer:layer9_attn_low_row0_buffer
                                destinationOffset:0
                                           size:8u*output_rank*sizeof(float)];
        [layer9_attention_tail_blit endEncoding];
        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to resume prefill layer-7 FFN encoder");
        ...
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer9_after_attention_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer9_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer9_after_attention_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer9_ffn_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[212] offset:inner[212] atIndex:1];
        [encoder setBuffer:layer9_ffn_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer9_ffn_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer9_ffn_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[213] offset:inner[213] atIndex:2];
        [encoder setBuffer:model_buffers[214] offset:inner[214] atIndex:3];
        [encoder setBuffer:layer9_after_attention_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer9_ffn_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer9_ffn_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[215] offset:inner[215] atIndex:7];
        [encoder setBuffer:layer9_ffn_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&router_args length:sizeof(router_args) atIndex:0];
        [encoder setBuffer:model_buffers[216] offset:inner[216] atIndex:1];
        [encoder setBuffer:layer9_ffn_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer9_router_logits_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,4,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];

        [encoder setComputePipelineState:context.routerSoftplusBatchPipeline];
        [encoder setBuffer:layer9_router_logits_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer9_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerSqrtBatchPipeline];
        [encoder setBuffer:layer9_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer9_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerTopkRowsBatchPipeline];
        [encoder setBuffer:layer9_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:model_buffers[217] offset:inner[217] atIndex:1];
        [encoder setBuffer:layer9_router_selected_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerGatherWeightsBatchPipeline];
        [encoder setBuffer:layer9_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer9_router_selected_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer9_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];

        [encoder setComputePipelineState:context.compressorSumRowsPipeline];
        [encoder setBytes:&router_sum_args length:sizeof(router_sum_args) atIndex:0];
        [encoder setBuffer:layer9_router_weights_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer9_router_weight_sums_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        [encoder setComputePipelineState:context.routerClampSumsBatchPipeline];
        [encoder setBuffer:layer9_router_weight_sums_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer9_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerDivideBatchPipeline];
        [encoder setBuffer:layer9_router_weights_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer9_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer9_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        ...
        [encoder setBytes:&routed_gate_args length:sizeof(routed_gate_args) atIndex:0];
        [encoder setBytes:&routed_activation_args length:sizeof(routed_activation_args) atIndex:1];
        [encoder setBuffer:model_buffers[218] offset:inner[218] atIndex:2];
        [encoder setBuffer:model_buffers[219] offset:inner[219] atIndex:3];
        [encoder setBuffer:layer9_ffn_norm_buffer offset:0 atIndex:4];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:5];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:6];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:7];
        [encoder setBuffer:layer9_router_weights_buffer offset:0 atIndex:8];
        [encoder setBuffer:routed_map_buffer offset:routed_map_work_offset atIndex:9];
        [encoder setThreadgroupMemoryLength:16384u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(routed_map_work_cap,32,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.routedBatchDownPipeline];
        [encoder setBytes:&routed_down_args length:sizeof(routed_down_args) atIndex:0];
        [encoder setBuffer:model_buffers[220] offset:inner[220] atIndex:1];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:2];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:4];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:5];
        ...
        [encoder setBytes:&routed_sum_args length:sizeof(routed_sum_args) atIndex:0];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer9_routed_out_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

#define RUST_STAR_ENCODE_L9_SHARED(args, index, input, output, width) do { \
        [encoder setComputePipelineState:context.q8PrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:(input) offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_L9_SHARED(shared_gate_args, 221, layer9_ffn_norm_buffer,
            shared_gate_buffer, 2048);
        RUST_STAR_ENCODE_L9_SHARED(shared_up_args, 222, layer9_ffn_norm_buffer,
            shared_up_buffer, 2048);
        [encoder setComputePipelineState:context.sharedSwigluBatchPipeline];
        [encoder setBytes:&shared_swiglu_args length:sizeof(shared_swiglu_args) atIndex:0];
        [encoder setBuffer:shared_gate_buffer offset:0 atIndex:1];
        ...
        [encoder dispatchThreadgroups:MTLSizeMake((rows*2048u+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        RUST_STAR_ENCODE_L9_SHARED(shared_down_args, 223, shared_mid_buffer,
            layer9_shared_out_buffer, n_embd);
#undef RUST_STAR_ENCODE_L9_SHARED

        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&ffn_hc_post_args length:sizeof(ffn_hc_post_args) atIndex:0];
        [encoder setBuffer:layer9_routed_out_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer9_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer9_ffn_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer9_ffn_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer9_shared_out_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer9_after_ffn_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer9_after_ffn_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer9_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer9_after_ffn_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer10_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[224] offset:inner[224] atIndex:1];
        [encoder setBuffer:layer10_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer10_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer10_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[225] offset:inner[225] atIndex:2];
        [encoder setBuffer:model_buffers[226] offset:inner[226] atIndex:3];
        [encoder setBuffer:layer9_after_ffn_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer10_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer10_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[227] offset:inner[227] atIndex:7];
        [encoder setBuffer:layer10_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer6_q_a_args length:sizeof(layer6_q_a_args) atIndex:0];
        [encoder setBuffer:model_buffers[228] offset:inner[228] atIndex:1];
        [encoder setBuffer:layer10_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer10_q_lora_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1024u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer6_kv_args length:sizeof(layer6_kv_args) atIndex:0];
        [encoder setBuffer:model_buffers[230] offset:inner[230] atIndex:1];
        [encoder setBuffer:layer10_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer10_kv_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,512u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBytes:&layer3_qkv_norm_args
                   length:sizeof(layer3_qkv_norm_args) atIndex:0];
        [encoder setBuffer:layer10_q_lora_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[229] offset:inner[229] atIndex:2];
        [encoder setBuffer:layer10_q_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer10_kv_raw_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[231] offset:inner[231] atIndex:5];
        [encoder setBuffer:layer10_kv_norm_buffer offset:0 atIndex:6];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,2,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer6_q_b_args length:sizeof(layer6_q_b_args) atIndex:0];
        [encoder setBuffer:model_buffers[232] offset:inner[232] atIndex:1];
        [encoder setBuffer:layer10_q_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer10_q_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,q_dim/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder endEncoding];

        id<MTLBlitCommandEncoder> layer10_blit = [command blitCommandEncoder];
        if (!layer10_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-10 Q/KV snapshot encoder");
        [layer10_blit copyFromBuffer:layer10_q_raw_buffer sourceOffset:0
                           toBuffer:layer10_q_cur_buffer destinationOffset:0
                               size:q_bytes];
        [layer10_blit copyFromBuffer:layer10_kv_norm_buffer sourceOffset:0
                           toBuffer:layer10_kv_norm_snapshot_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer10_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-10 RoPE encoder");
        [encoder setComputePipelineState:context.headNormRopePipeline];
        [encoder setBytes:&q_rope_args length:sizeof(q_rope_args) atIndex:0];
        [encoder setBuffer:layer10_q_cur_buffer offset:0 atIndex:1];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(n_head,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.ropeTailPipeline];
        [encoder setBytes:&layer3_kv_rope_args
                   length:sizeof(layer3_kv_rope_args) atIndex:0];
        [encoder setBuffer:layer10_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer10_kv_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer10_kv_norm_buffer offset:0 atIndex:4];
        [encoder dispatchThreadgroups:MTLSizeMake(1,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        layer10_blit = [command blitCommandEncoder];
        if (!layer10_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-10 KVrope snapshot encoder");
        [layer10_blit copyFromBuffer:layer10_kv_norm_buffer sourceOffset:0
                           toBuffer:layer10_kv_rope_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer10_blit endEncoding];

        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-10 KV finalization encoder");
        [encoder setComputePipelineState:context.compressorFp8Pipeline];
        [encoder setBytes:&layer3_kv_fp8_args
                   length:sizeof(layer3_kv_fp8_args) atIndex:0];
        [encoder setBuffer:layer10_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer10_kv_norm_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:64u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(64,1,1)];

#define RUST_STAR_ENCODE_LAYER10_COMPRESSOR_PROJECTION(args, index, width, output) do { \
        [encoder setComputePipelineState:context.f16AlignedPrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:layer10_norm_buffer offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_LAYER10_COMPRESSOR_PROJECTION(
            layer6_attn_compressor_kv_args, 234,
            layer4_attn_compressor_width, layer10_attn_projected_kv_buffer);
        RUST_STAR_ENCODE_LAYER10_COMPRESSOR_PROJECTION(
            layer6_attn_compressor_gate_args, 235,
            layer4_attn_compressor_width, layer10_attn_projected_score_buffer);
        RUST_STAR_ENCODE_LAYER10_COMPRESSOR_PROJECTION(
            layer6_indexer_compressor_kv_args, 238,
            layer4_indexer_compressor_width, layer10_indexer_projected_kv_buffer);
        RUST_STAR_ENCODE_LAYER10_COMPRESSOR_PROJECTION(
            layer6_indexer_compressor_gate_args, 239,
            layer4_indexer_compressor_width,
            layer10_indexer_projected_score_buffer);
#undef RUST_STAR_ENCODE_LAYER10_COMPRESSOR_PROJECTION

        const NSUInteger layer10_tail_activation_offset =
            (NSUInteger)(rows-compressor_ratio)*n_embd*sizeof(float);
        if (!encode_projected_compressor_batch_ratio4(
                context, encoder,
                layer10_norm_buffer, layer10_tail_activation_offset,
                model_buffers[234], inner[234], model_buffers[235], inner[235],
                layer10_attn_projected_kv_buffer,
                layer10_attn_projected_score_buffer,
                layer10_attn_score_ape_buffer,
                layer10_attn_packed_kv_buffer,
                layer10_attn_packed_score_buffer,
                model_buffers[233], inner[233], model_buffers[236], inner[236],
                layer10_attn_state_kv_buffer,
                layer10_attn_state_score_buffer,
            ...
            !encode_projected_compressor_batch_ratio4(
                context, encoder,
                layer10_norm_buffer, layer10_tail_activation_offset,
                model_buffers[238], inner[238], model_buffers[239], inner[239],
                layer10_indexer_projected_kv_buffer,
                layer10_indexer_projected_score_buffer,
                layer10_indexer_score_ape_buffer,
                layer10_indexer_packed_kv_buffer,
                layer10_indexer_packed_score_buffer,
                model_buffers[237], inner[237], model_buffers[240], inner[240],
                layer10_indexer_state_kv_buffer,
                layer10_indexer_state_score_buffer,
        ...
        uint32_t layer10_raw_elements = raw_rows*head_dim;
        [encoder setComputePipelineState:context.cpyF32F16Pipeline];
        [encoder setBytes:&layer10_raw_elements length:sizeof(layer10_raw_elements) atIndex:0];
        [encoder setBuffer:layer10_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer10_raw_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        uint32_t layer10_compressed_elements = compressed_rows*head_dim;
        [encoder setBytes:&layer10_compressed_elements
                   length:sizeof(layer10_compressed_elements) atIndex:0];
        [encoder setBuffer:layer10_attn_compressed_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer
                     offset:(NSUInteger)raw_rows*head_f16_bytes atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer10_compressed_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.flashBlkPipeline];
        [encoder setBytes:&block_args length:sizeof(block_args) atIndex:0];
        [encoder setBuffer:mask_buffer offset:0 atIndex:1];
        ...
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:3];
        [encoder setBuffer:mask_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[241] offset:inner[241] atIndex:5];
        [encoder setBuffer:pad_buffer offset:0 atIndex:6];
        [encoder setBuffer:block_buffer offset:0 atIndex:7];
        [encoder setBuffer:heads_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:28672u atIndex:0];
        ...
        id<MTLBlitCommandEncoder> layer10_attention_blit =
            [command blitCommandEncoder];
        if (!layer10_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-10 attention snapshot encoder");
        [layer10_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer10_kqv_out_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer10_attention_blit endEncoding];
        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to resume prefill layer-10 attention encoder");
        [encoder setComputePipelineState:context.ropeTailPipeline];
        [encoder setBytes:&inverse_args length:sizeof(inverse_args) atIndex:0];
        [encoder setBuffer:heads_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        ...
        [encoder setComputePipelineState:context.attentionOutputBatchLowPipeline];
        [encoder setBytes:&layer6_low_args length:sizeof(layer6_low_args) atIndex:0];
        [encoder setBuffer:model_buffers[242] offset:inner[242] atIndex:1];
        [encoder setBuffer:heads_buffer offset:0 atIndex:2];
        [encoder setBuffer:group_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:group_map_buffer offset:tpe_bytes atIndex:4];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:5];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer6_output_args length:sizeof(layer6_output_args) atIndex:0];
        [encoder setBuffer:model_buffers[243] offset:inner[243] atIndex:1];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer10_attention_output_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,n_embd/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&attention_hc_args length:sizeof(attention_hc_args) atIndex:0];
        [encoder setBuffer:layer10_attention_output_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer9_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer10_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer10_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer10_attention_output_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer10_after_attention_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        [encoder endEncoding];

        layer10_attention_blit = [command blitCommandEncoder];
        if (!layer10_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-10 attention tail snapshot encoder");
        [layer10_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer10_kqv_back_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer10_attention_blit copyFromBuffer:attention_low_buffer sourceOffset:0
                                    toBuffer:layer10_attn_low_row0_buffer
                           destinationOffset:0
                                      size:8u*output_rank*sizeof(float)];
        [layer10_attention_blit endEncoding];
        ...
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-10 FFN encoder");
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer10_after_attention_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer10_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer10_after_attention_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer10_ffn_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[244] offset:inner[244] atIndex:1];
        [encoder setBuffer:layer10_ffn_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer10_ffn_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer10_ffn_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[245] offset:inner[245] atIndex:2];
        [encoder setBuffer:model_buffers[246] offset:inner[246] atIndex:3];
        [encoder setBuffer:layer10_after_attention_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer10_ffn_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer10_ffn_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[247] offset:inner[247] atIndex:7];
        [encoder setBuffer:layer10_ffn_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&router_args length:sizeof(router_args) atIndex:0];
        [encoder setBuffer:model_buffers[248] offset:inner[248] atIndex:1];
        [encoder setBuffer:layer10_ffn_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer10_router_logits_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,4,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];

        [encoder setComputePipelineState:context.routerSoftplusBatchPipeline];
        [encoder setBuffer:layer10_router_logits_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer10_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerSqrtBatchPipeline];
        [encoder setBuffer:layer10_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer10_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerTopkRowsBatchPipeline];
        [encoder setBuffer:layer10_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:model_buffers[249] offset:inner[249] atIndex:1];
        [encoder setBuffer:layer10_router_selected_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerGatherWeightsBatchPipeline];
        [encoder setBuffer:layer10_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer10_router_selected_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer10_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];

        [encoder setComputePipelineState:context.compressorSumRowsPipeline];
        [encoder setBytes:&router_sum_args length:sizeof(router_sum_args) atIndex:0];
        [encoder setBuffer:layer10_router_weights_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer10_router_weight_sums_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        [encoder setComputePipelineState:context.routerClampSumsBatchPipeline];
        [encoder setBuffer:layer10_router_weight_sums_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer10_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerDivideBatchPipeline];
        [encoder setBuffer:layer10_router_weights_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer10_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer10_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        ...
        [encoder setBytes:&routed_gate_args length:sizeof(routed_gate_args) atIndex:0];
        [encoder setBytes:&routed_activation_args length:sizeof(routed_activation_args) atIndex:1];
        [encoder setBuffer:model_buffers[250] offset:inner[250] atIndex:2];
        [encoder setBuffer:model_buffers[251] offset:inner[251] atIndex:3];
        [encoder setBuffer:layer10_ffn_norm_buffer offset:0 atIndex:4];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:5];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:6];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:7];
        [encoder setBuffer:layer10_router_weights_buffer offset:0 atIndex:8];
        [encoder setBuffer:routed_map_buffer offset:routed_map_work_offset atIndex:9];
        [encoder setThreadgroupMemoryLength:16384u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(routed_map_work_cap,32,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.routedBatchDownPipeline];
        [encoder setBytes:&routed_down_args length:sizeof(routed_down_args) atIndex:0];
        [encoder setBuffer:model_buffers[252] offset:inner[252] atIndex:1];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:2];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:4];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:5];
        ...
        [encoder setBytes:&routed_sum_args length:sizeof(routed_sum_args) atIndex:0];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer10_routed_out_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

#define RUST_STAR_ENCODE_L10_SHARED(args, index, input, output, width) do { \
        [encoder setComputePipelineState:context.q8PrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:(input) offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_L10_SHARED(shared_gate_args, 253, layer10_ffn_norm_buffer,
            shared_gate_buffer, 2048);
        RUST_STAR_ENCODE_L10_SHARED(shared_up_args, 254, layer10_ffn_norm_buffer,
            shared_up_buffer, 2048);
        [encoder setComputePipelineState:context.sharedSwigluBatchPipeline];
        [encoder setBytes:&shared_swiglu_args length:sizeof(shared_swiglu_args) atIndex:0];
        [encoder setBuffer:shared_gate_buffer offset:0 atIndex:1];
        ...
        [encoder dispatchThreadgroups:MTLSizeMake((rows*2048u+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        RUST_STAR_ENCODE_L10_SHARED(shared_down_args, 255, shared_mid_buffer,
            layer10_shared_out_buffer, n_embd);
#undef RUST_STAR_ENCODE_L10_SHARED

        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&ffn_hc_post_args length:sizeof(ffn_hc_post_args) atIndex:0];
        [encoder setBuffer:layer10_routed_out_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer10_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer10_ffn_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer10_ffn_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer10_shared_out_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer10_after_ffn_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer10_after_ffn_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer10_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer10_after_ffn_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer11_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[256] offset:inner[256] atIndex:1];
        [encoder setBuffer:layer11_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer11_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer11_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[257] offset:inner[257] atIndex:2];
        [encoder setBuffer:model_buffers[258] offset:inner[258] atIndex:3];
        [encoder setBuffer:layer10_after_ffn_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer11_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer11_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[259] offset:inner[259] atIndex:7];
        [encoder setBuffer:layer11_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_q_a_args length:sizeof(layer5_q_a_args) atIndex:0];
        [encoder setBuffer:model_buffers[260] offset:inner[260] atIndex:1];
        [encoder setBuffer:layer11_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer11_q_lora_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1024u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_kv_args length:sizeof(layer5_kv_args) atIndex:0];
        [encoder setBuffer:model_buffers[262] offset:inner[262] atIndex:1];
        [encoder setBuffer:layer11_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer11_kv_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,512u/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBytes:&layer3_qkv_norm_args
                   length:sizeof(layer3_qkv_norm_args) atIndex:0];
        [encoder setBuffer:layer11_q_lora_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[261] offset:inner[261] atIndex:2];
        [encoder setBuffer:layer11_q_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer11_kv_raw_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[263] offset:inner[263] atIndex:5];
        [encoder setBuffer:layer11_kv_norm_buffer offset:0 atIndex:6];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,2,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        ...
        [encoder setComputePipelineState:context.q8PrefillPipeline];
        [encoder setBytes:&layer5_q_b_args length:sizeof(layer5_q_b_args) atIndex:0];
        [encoder setBuffer:model_buffers[264] offset:inner[264] atIndex:1];
        [encoder setBuffer:layer11_q_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer11_q_raw_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,q_dim/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        [encoder endEncoding];

        id<MTLBlitCommandEncoder> layer11_blit = [command blitCommandEncoder];
        if (!layer11_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-7 Q/KV snapshot encoder");
        [layer11_blit copyFromBuffer:layer11_q_raw_buffer sourceOffset:0
                           toBuffer:layer11_q_cur_buffer destinationOffset:0
                               size:q_bytes];
        [layer11_blit copyFromBuffer:layer11_kv_norm_buffer sourceOffset:0
                           toBuffer:layer11_kv_norm_snapshot_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer11_blit endEncoding];
        ...
        [encoder setComputePipelineState:context.headNormRopePipeline];
        [encoder setBytes:&q_rope_args length:sizeof(q_rope_args) atIndex:0];
        [encoder setBuffer:layer11_q_cur_buffer offset:0 atIndex:1];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(n_head,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.ropeTailPipeline];
        [encoder setBytes:&layer3_kv_rope_args
                   length:sizeof(layer3_kv_rope_args) atIndex:0];
        [encoder setBuffer:layer11_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:position_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer11_kv_norm_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer11_kv_norm_buffer offset:0 atIndex:4];
        [encoder dispatchThreadgroups:MTLSizeMake(1,rows,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        layer11_blit = [command blitCommandEncoder];
        if (!layer11_blit) return fail_with_message(error, error_bytes,
            @"failed to create prefill layer-7 KVrope snapshot encoder");
        [layer11_blit copyFromBuffer:layer11_kv_norm_buffer sourceOffset:0
                           toBuffer:layer11_kv_rope_buffer destinationOffset:0
                               size:layer3_kv_bytes];
        [layer11_blit endEncoding];
        ...
        [encoder setBytes:&layer3_kv_fp8_args
                   length:sizeof(layer3_kv_fp8_args) atIndex:0];
        [encoder setBuffer:layer11_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer11_kv_norm_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:64u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(64,1,1)];

#define RUST_STAR_ENCODE_LAYER11_COMPRESSOR_PROJECTION(args, index, output) do { \
        [encoder setComputePipelineState:context.f16AlignedPrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:layer11_norm_buffer offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_LAYER11_COMPRESSOR_PROJECTION(
            layer5_attn_compressor_kv_args, 266,
            layer11_attn_projected_kv_buffer);
        RUST_STAR_ENCODE_LAYER11_COMPRESSOR_PROJECTION(
            layer5_attn_compressor_gate_args, 267,
            layer11_attn_projected_score_buffer);
#undef RUST_STAR_ENCODE_LAYER11_COMPRESSOR_PROJECTION

        if (!encode_projected_compressor_batch_ratio128(
                context, encoder,
                layer11_attn_projected_kv_buffer,
                layer11_attn_projected_score_buffer,
                layer11_attn_score_ape_buffer,
                model_buffers[265], inner[265],
                model_buffers[268], inner[268],
                layer11_attn_compressed_buffer,
                layer11_compressed_position_buffer,
                0u, rows)) {
            return fail_with_message(error, error_bytes,
                @"failed to encode prefill layer-7 ratio-128 compressor");
        ...
        uint32_t layer11_raw_elements = raw_rows*head_dim;
        [encoder setComputePipelineState:context.cpyF32F16Pipeline];
        [encoder setBytes:&layer11_raw_elements
                   length:sizeof(layer11_raw_elements) atIndex:0];
        [encoder setBuffer:layer11_kv_norm_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer11_raw_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

        uint32_t layer11_compressed_elements =
            layer3_compressed_rows*head_dim;
        [encoder setBytes:&layer11_compressed_elements
                   length:sizeof(layer11_compressed_elements) atIndex:0];
        [encoder setBuffer:layer11_attn_compressed_buffer offset:0 atIndex:1];
        [encoder setBuffer:staged_kv_buffer
                     offset:(NSUInteger)raw_rows*head_f16_bytes atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(
                (layer11_compressed_elements+1023u)/1024u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        ...
        [encoder setBuffer:staged_kv_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer3_mask_buffer offset:0 atIndex:4];
        [encoder setBuffer:model_buffers[269] offset:inner[269] atIndex:5];
        [encoder setBuffer:pad_buffer offset:0 atIndex:6];
        [encoder setBuffer:block_buffer offset:0 atIndex:7];
        [encoder setBuffer:heads_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:28672u atIndex:0];
        ...
        id<MTLBlitCommandEncoder> layer11_attention_blit =
            [command blitCommandEncoder];
        if (!layer11_attention_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create prefill layer-7 attention snapshot encoder");
        [layer11_attention_blit copyFromBuffer:heads_buffer sourceOffset:0
                                    toBuffer:layer11_kqv_out_row0_buffer
                           destinationOffset:0 size:q_dim*sizeof(float)];
        [layer11_attention_blit endEncoding];
        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to resume prefill layer-7 attention encoder");
        ...
        [encoder setComputePipelineState:context.attentionOutputBatchLowPipeline];
        [encoder setBytes:&layer5_low_args length:sizeof(layer5_low_args) atIndex:0];
        [encoder setBuffer:model_buffers[270] offset:inner[270] atIndex:1];
        [encoder setBuffer:heads_buffer offset:0 atIndex:2];
        [encoder setBuffer:group_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:group_map_buffer offset:tpe_bytes atIndex:4];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:5];
        ...
        [encoder setBytes:&layer5_output_args
                   length:sizeof(layer5_output_args) atIndex:0];
        [encoder setBuffer:model_buffers[271] offset:inner[271] atIndex:1];
        [encoder setBuffer:attention_low_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer11_attention_output_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:6144u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,n_embd/64u,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setBytes:&attention_hc_args
                   length:sizeof(attention_hc_args) atIndex:0];
        [encoder setBuffer:layer11_attention_output_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer10_after_ffn_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer11_split_buffer
                     offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer11_split_buffer
                     offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer11_attention_output_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer11_after_attention_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];

        id<MTLBlitCommandEncoder> layer11_attention_tail_blit =
            [command blitCommandEncoder];
        if (!layer11_attention_tail_blit) return fail_with_message(
            error, error_bytes,
            @"failed to create retained prefill layer-7 attention tail encoder");
        [layer11_attention_tail_blit copyFromBuffer:heads_buffer sourceOffset:0
                                         toBuffer:layer11_kqv_back_row0_buffer
                                destinationOffset:0 size:q_dim*sizeof(float)];
        [layer11_attention_tail_blit copyFromBuffer:attention_low_buffer
                                      sourceOffset:0
                                         toBuffer:layer11_attn_low_row0_buffer
                                destinationOffset:0
                                           size:8u*output_rank*sizeof(float)];
        [layer11_attention_tail_blit endEncoding];
        encoder = [command computeCommandEncoder];
        if (!encoder) return fail_with_message(
            error, error_bytes,
            @"failed to resume prefill layer-7 FFN encoder");
        ...
        [encoder setComputePipelineState:context.rmsNormF32Pipeline];
        [encoder setBytes:&ffn_hc_norm_args length:sizeof(ffn_hc_norm_args) atIndex:0];
        [encoder setBuffer:layer11_after_attention_hc_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer11_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer11_after_attention_hc_buffer offset:0 atIndex:3];
        [encoder setBuffer:layer11_ffn_flat_hc_buffer offset:0 atIndex:4];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&ffn_hc_mm_args length:sizeof(ffn_hc_mm_args) atIndex:0];
        [encoder setBuffer:model_buffers[272] offset:inner[272] atIndex:1];
        [encoder setBuffer:layer11_ffn_flat_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer11_ffn_mix_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,1,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.hcIngressPipeline];
        [encoder setBytes:&ffn_hc_ingress_args length:sizeof(ffn_hc_ingress_args) atIndex:0];
        [encoder setBuffer:layer11_ffn_mix_buffer offset:0 atIndex:1];
        [encoder setBuffer:model_buffers[273] offset:inner[273] atIndex:2];
        [encoder setBuffer:model_buffers[274] offset:inner[274] atIndex:3];
        [encoder setBuffer:layer11_after_attention_hc_buffer offset:0 atIndex:4];
        [encoder setBuffer:layer11_ffn_split_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer11_ffn_cur_buffer offset:0 atIndex:6];
        [encoder setBuffer:model_buffers[275] offset:inner[275] atIndex:7];
        [encoder setBuffer:layer11_ffn_norm_buffer offset:0 atIndex:8];
        [encoder setThreadgroupMemoryLength:(n_embd+4u+32u)*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        [encoder setComputePipelineState:context.f16PrefillPipeline];
        [encoder setBytes:&router_args length:sizeof(router_args) atIndex:0];
        [encoder setBuffer:model_buffers[276] offset:inner[276] atIndex:1];
        [encoder setBuffer:layer11_ffn_norm_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer11_router_logits_buffer offset:0 atIndex:3];
        [encoder setThreadgroupMemoryLength:8192u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows/32u,4,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];

        [encoder setComputePipelineState:context.routerSoftplusBatchPipeline];
        [encoder setBuffer:layer11_router_logits_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer11_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerSqrtBatchPipeline];
        [encoder setBuffer:layer11_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer11_router_probs_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows*256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerTopkRowsBatchPipeline];
        [encoder setBuffer:layer11_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:model_buffers[277] offset:inner[277] atIndex:1];
        [encoder setBuffer:layer11_router_selected_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerGatherWeightsBatchPipeline];
        [encoder setBuffer:layer11_router_probs_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer11_router_selected_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer11_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];

        [encoder setComputePipelineState:context.compressorSumRowsPipeline];
        [encoder setBytes:&router_sum_args length:sizeof(router_sum_args) atIndex:0];
        [encoder setBuffer:layer11_router_weights_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer11_router_weight_sums_buffer offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:32u*sizeof(float) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        [encoder setComputePipelineState:context.routerClampSumsBatchPipeline];
        [encoder setBuffer:layer11_router_weight_sums_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer11_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder dispatchThreads:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder setComputePipelineState:context.routerDivideBatchPipeline];
        [encoder setBuffer:layer11_router_weights_buffer offset:0 atIndex:0];
        [encoder setBuffer:layer11_router_weight_sums_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer11_router_weights_buffer offset:0 atIndex:2];
        [encoder dispatchThreads:MTLSizeMake(6,rows,1)
             threadsPerThreadgroup:MTLSizeMake(6,1,1)];
        ...
        [encoder setBytes:&routed_gate_args length:sizeof(routed_gate_args) atIndex:0];
        [encoder setBytes:&routed_activation_args length:sizeof(routed_activation_args) atIndex:1];
        [encoder setBuffer:model_buffers[278] offset:inner[278] atIndex:2];
        [encoder setBuffer:model_buffers[279] offset:inner[279] atIndex:3];
        [encoder setBuffer:layer11_ffn_norm_buffer offset:0 atIndex:4];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:5];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:6];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:7];
        [encoder setBuffer:layer11_router_weights_buffer offset:0 atIndex:8];
        [encoder setBuffer:routed_map_buffer offset:routed_map_work_offset atIndex:9];
        [encoder setThreadgroupMemoryLength:16384u atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(routed_map_work_cap,32,1)
             threadsPerThreadgroup:MTLSizeMake(128,1,1)];
        ...
        [encoder setComputePipelineState:context.routedBatchDownPipeline];
        [encoder setBytes:&routed_down_args length:sizeof(routed_down_args) atIndex:0];
        [encoder setBuffer:model_buffers[280] offset:inner[280] atIndex:1];
        [encoder setBuffer:routed_mid_buffer offset:0 atIndex:2];
        [encoder setBuffer:routed_map_buffer offset:0 atIndex:3];
        [encoder setBuffer:routed_map_buffer offset:routed_map_tpe_bytes atIndex:4];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:5];
        ...
        [encoder setBytes:&routed_sum_args length:sizeof(routed_sum_args) atIndex:0];
        [encoder setBuffer:routed_experts_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer11_routed_out_buffer offset:0 atIndex:2];
        [encoder dispatchThreadgroups:MTLSizeMake(rows,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];

#define RUST_STAR_ENCODE_L11_SHARED(args, index, input, output, width) do { \
        [encoder setComputePipelineState:context.q8PrefillPipeline]; \
        [encoder setBytes:&(args) length:sizeof(args) atIndex:0]; \
        [encoder setBuffer:model_buffers[(index)] offset:inner[(index)] atIndex:1]; \
        [encoder setBuffer:(input) offset:0 atIndex:2]; \
        ...
        RUST_STAR_ENCODE_L11_SHARED(shared_gate_args, 281, layer11_ffn_norm_buffer,
            shared_gate_buffer, 2048);
        RUST_STAR_ENCODE_L11_SHARED(shared_up_args, 282, layer11_ffn_norm_buffer,
            shared_up_buffer, 2048);
        [encoder setComputePipelineState:context.sharedSwigluBatchPipeline];
        [encoder setBytes:&shared_swiglu_args length:sizeof(shared_swiglu_args) atIndex:0];
        [encoder setBuffer:shared_gate_buffer offset:0 atIndex:1];
        ...
        [encoder dispatchThreadgroups:MTLSizeMake((rows*2048u+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        RUST_STAR_ENCODE_L11_SHARED(shared_down_args, 283, shared_mid_buffer,
            layer11_shared_out_buffer, n_embd);
#undef RUST_STAR_ENCODE_L11_SHARED

        [encoder setComputePipelineState:context.hcExpand4Pipeline];
        [encoder setBytes:&ffn_hc_post_args length:sizeof(ffn_hc_post_args) atIndex:0];
        [encoder setBuffer:layer11_routed_out_buffer offset:0 atIndex:1];
        [encoder setBuffer:layer11_after_attention_hc_buffer offset:0 atIndex:2];
        [encoder setBuffer:layer11_ffn_split_buffer offset:4u*sizeof(float) atIndex:3];
        [encoder setBuffer:layer11_ffn_split_buffer offset:8u*sizeof(float) atIndex:4];
        [encoder setBuffer:layer11_shared_out_buffer offset:0 atIndex:5];
        [encoder setBuffer:layer11_after_ffn_hc_buffer offset:0 atIndex:6];
        [encoder dispatchThreadgroups:MTLSizeMake((rows*n_embd+255u)/256u,1,1)
             threadsPerThreadgroup:MTLSizeMake(256,1,1)];
        [encoder endEncoding];
        ...
        memcpy(layer3_q_lora, layer3_q_lora_buffer.contents,
               (NSUInteger)rows*1024u*sizeof(float));
        memcpy(layer3_q_lora_norm, layer3_q_norm_buffer.contents,
               layer3_q_rank_bytes);
        memcpy(layer3_kv_raw, layer3_kv_raw_buffer.contents, layer3_kv_bytes);
        memcpy(layer3_kv_norm, layer3_kv_norm_snapshot_buffer.contents,
               layer3_kv_bytes);
        const NSUInteger layer3_q_final_tile_offset =
            (NSUInteger)(rows-32u)*q_dim*sizeof(float);
        memcpy(layer3_q_raw_final_tile,
               (const uint8_t *)q_buffer.contents+layer3_q_final_tile_offset,
               32ull*q_dim*sizeof(float));
        memcpy(layer3_q_cur_final_tile,
               (const uint8_t *)layer3_q_cur_buffer.contents+
                   layer3_q_final_tile_offset,
               32ull*q_dim*sizeof(float));
        memcpy(layer3_kv_rope, layer3_kv_rope_buffer.contents, layer3_kv_bytes);
        memcpy(layer3_kv_cur, layer3_kv_norm_buffer.contents, layer3_kv_bytes);
        memcpy(layer3_attn_compressed,
               layer3_attn_compressed_buffer.contents, layer3_compressed_bytes);
        memcpy(layer3_attn_state_kv,
               layer3_attn_state_kv_buffer.contents,
               layer3_compressor_state_bytes);
        memcpy(layer3_attn_state_score,
               layer3_attn_state_score_buffer.contents,
               layer3_compressor_state_bytes);
        memcpy(layer3_kqv_out_row0,
               layer3_kqv_out_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer3_kqv_back_row0,
               layer3_kqv_back_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer3_attn_low_row0,
               layer3_attn_low_row0_buffer.contents,
               8u*output_rank*sizeof(float));
        memcpy(layer3_attention_output,
               layer3_attention_output_buffer.contents, output_bytes);
        memcpy(layer3_after_attention_hc,
               layer3_after_attention_hc_buffer.contents, hc_bytes);
        memcpy(layer3_after_ffn_hc,
               layer3_after_ffn_hc_buffer.contents, hc_bytes);
        ...
        memcpy(shared_out_final_tile,
               ...
               32u*n_embd*sizeof(float));
        memcpy(layer3_ffn_cur_final_tile,
               (const uint8_t *)layer3_ffn_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer3_ffn_norm_final_tile,
               (const uint8_t *)layer3_ffn_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer3_router_selected_final_tile,
               (const uint8_t *)layer3_router_selected_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(int32_t));
        memcpy(layer3_router_weights_final_tile,
               (const uint8_t *)layer3_router_weights_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(float));
        memcpy(layer3_routed_out_final_tile,
               (const uint8_t *)layer3_routed_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer3_shared_out_final_tile,
               (const uint8_t *)layer3_shared_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        const NSUInteger layer4_q_rank_final_tile_offset =
            (NSUInteger)(rows-32u)*1024u*sizeof(float);
        const NSUInteger layer4_kv_final_tile_offset =
            (NSUInteger)(rows-32u)*512u*sizeof(float);
        memcpy(layer4_hc_attn_pre_final_tile,
               (const uint8_t *)layer4_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer4_attn_norm_final_tile,
               (const uint8_t *)layer4_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer4_q_lora_final_tile,
               (const uint8_t *)layer4_q_lora_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer4_q_lora_norm_final_tile,
               (const uint8_t *)layer4_q_norm_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer4_kv_raw_final_tile,
               (const uint8_t *)layer4_kv_raw_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer4_kv_norm_final_tile,
               (const uint8_t *)layer4_kv_norm_snapshot_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer4_q_raw_final_tile,
               (const uint8_t *)layer4_q_raw_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer4_q_cur_final_tile,
               (const uint8_t *)layer4_q_cur_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer4_kv_rope_final_tile,
               (const uint8_t *)layer4_kv_rope_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer4_kv_cur_final_tile,
               (const uint8_t *)layer4_kv_norm_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer4_attn_compressed,
               layer4_attn_compressed_buffer.contents,
               layer4_attn_compressed_bytes);
        memcpy(layer4_attn_state_kv,
               layer4_attn_state_kv_buffer.contents, layer4_attn_state_bytes);
        memcpy(layer4_attn_state_score,
               layer4_attn_state_score_buffer.contents, layer4_attn_state_bytes);
        memcpy(layer4_indexer_compressed,
               layer4_indexer_compressed_buffer.contents,
               layer4_indexer_compressed_bytes);
        memcpy(layer4_indexer_state_kv,
               layer4_indexer_state_kv_buffer.contents,
               layer4_indexer_state_bytes);
        memcpy(layer4_indexer_state_score,
               layer4_indexer_state_score_buffer.contents,
               layer4_indexer_state_bytes);
        memcpy(layer4_kqv_out_row0,
               layer4_kqv_out_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer4_kqv_back_row0,
               layer4_kqv_back_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer4_attn_low_row0,
               layer4_attn_low_row0_buffer.contents,
               8u*output_rank*sizeof(float));
        memcpy(layer4_attention_output,
               layer4_attention_output_buffer.contents, output_bytes);
        memcpy(layer4_after_attention_hc,
               layer4_after_attention_hc_buffer.contents, hc_bytes);
        memcpy(layer4_after_ffn_hc,
               layer4_after_ffn_hc_buffer.contents, hc_bytes);
        memcpy(layer4_ffn_cur_final_tile,
               (const uint8_t *)layer4_ffn_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer4_ffn_norm_final_tile,
               (const uint8_t *)layer4_ffn_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer4_router_selected_final_tile,
               (const uint8_t *)layer4_router_selected_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(int32_t));
        memcpy(layer4_router_weights_final_tile,
               (const uint8_t *)layer4_router_weights_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(float));
        memcpy(layer4_routed_out_final_tile,
               (const uint8_t *)layer4_routed_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer4_shared_out_final_tile,
               (const uint8_t *)layer4_shared_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer5_hc_attn_pre_final_tile,
               (const uint8_t *)layer5_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer5_attn_norm_final_tile,
               (const uint8_t *)layer5_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer5_q_lora_final_tile,
               (const uint8_t *)layer5_q_lora_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer5_q_lora_norm_final_tile,
               (const uint8_t *)layer5_q_norm_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer5_kv_raw_final_tile,
               (const uint8_t *)layer5_kv_raw_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer5_kv_norm_final_tile,
               (const uint8_t *)layer5_kv_norm_snapshot_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer5_q_raw_final_tile,
               (const uint8_t *)layer5_q_raw_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer5_q_cur_final_tile,
               (const uint8_t *)layer5_q_cur_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer5_kv_rope_final_tile,
               (const uint8_t *)layer5_kv_rope_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer5_kv_cur_final_tile,
               (const uint8_t *)layer5_kv_norm_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer5_attn_compressed,
               layer5_attn_compressed_buffer.contents, layer3_compressed_bytes);
        memcpy(layer5_attn_state_kv,
               layer5_attn_state_kv_buffer.contents,
               layer3_compressor_state_bytes);
        memcpy(layer5_attn_state_score,
               layer5_attn_state_score_buffer.contents,
               layer3_compressor_state_bytes);
        memcpy(layer5_kqv_out_row0,
               layer5_kqv_out_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer5_kqv_back_row0,
               layer5_kqv_back_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer5_attn_low_row0,
               layer5_attn_low_row0_buffer.contents,
               8u*output_rank*sizeof(float));
        memcpy(layer5_attention_output,
               layer5_attention_output_buffer.contents, output_bytes);
        memcpy(layer5_after_attention_hc,
               layer5_after_attention_hc_buffer.contents, hc_bytes);
        memcpy(layer5_after_ffn_hc,
               layer5_after_ffn_hc_buffer.contents, hc_bytes);
        memcpy(layer5_ffn_cur_final_tile,
               (const uint8_t *)layer5_ffn_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer5_ffn_norm_final_tile,
               (const uint8_t *)layer5_ffn_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer5_router_selected_final_tile,
               (const uint8_t *)layer5_router_selected_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(int32_t));
        memcpy(layer5_router_weights_final_tile,
               (const uint8_t *)layer5_router_weights_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(float));
        memcpy(layer5_routed_out_final_tile,
               (const uint8_t *)layer5_routed_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer5_shared_out_final_tile,
               (const uint8_t *)layer5_shared_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer6_hc_attn_pre_final_tile,
               (const uint8_t *)layer6_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer6_attn_norm_final_tile,
               (const uint8_t *)layer6_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer6_q_lora_final_tile,
               (const uint8_t *)layer6_q_lora_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer6_q_lora_norm_final_tile,
               (const uint8_t *)layer6_q_norm_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer6_kv_raw_final_tile,
               (const uint8_t *)layer6_kv_raw_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer6_kv_norm_final_tile,
               (const uint8_t *)layer6_kv_norm_snapshot_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer6_q_raw_final_tile,
               (const uint8_t *)layer6_q_raw_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer6_q_cur_final_tile,
               (const uint8_t *)layer6_q_cur_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer6_kv_rope_final_tile,
               (const uint8_t *)layer6_kv_rope_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer6_kv_cur_final_tile,
        ...
        memcpy(layer6_indexer_state_score,
               layer6_indexer_state_score_buffer.contents,
               layer4_indexer_state_bytes);
        memcpy(layer6_kqv_out_row0,
               layer6_kqv_out_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer6_kqv_back_row0,
               layer6_kqv_back_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer6_attn_low_row0,
               layer6_attn_low_row0_buffer.contents,
               8u*output_rank*sizeof(float));
        memcpy(layer6_attention_output,
               layer6_attention_output_buffer.contents, output_bytes);
        memcpy(layer6_after_attention_hc,
               layer6_after_attention_hc_buffer.contents, hc_bytes);
        memcpy(layer6_after_ffn_hc,
               layer6_after_ffn_hc_buffer.contents, hc_bytes);
        memcpy(layer6_ffn_cur_final_tile,
               (const uint8_t *)layer6_ffn_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer6_ffn_norm_final_tile,
               (const uint8_t *)layer6_ffn_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer6_router_selected_final_tile,
               (const uint8_t *)layer6_router_selected_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(int32_t));
        memcpy(layer6_router_weights_final_tile,
               (const uint8_t *)layer6_router_weights_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(float));
        memcpy(layer6_routed_out_final_tile,
               (const uint8_t *)layer6_routed_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer6_shared_out_final_tile,
               (const uint8_t *)layer6_shared_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer7_hc_attn_pre_final_tile,
               (const uint8_t *)layer7_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer7_attn_norm_final_tile,
               (const uint8_t *)layer7_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer7_q_lora_final_tile,
               (const uint8_t *)layer7_q_lora_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer7_q_lora_norm_final_tile,
               (const uint8_t *)layer7_q_norm_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer7_kv_raw_final_tile,
               (const uint8_t *)layer7_kv_raw_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer7_kv_norm_final_tile,
               (const uint8_t *)layer7_kv_norm_snapshot_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer7_q_raw_final_tile,
               (const uint8_t *)layer7_q_raw_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer7_q_cur_final_tile,
               (const uint8_t *)layer7_q_cur_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer7_kv_rope_final_tile,
               (const uint8_t *)layer7_kv_rope_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer7_kv_cur_final_tile,
               (const uint8_t *)layer7_kv_norm_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer7_attn_compressed,
               layer7_attn_compressed_buffer.contents, layer3_compressed_bytes);
        memcpy(layer7_attn_state_kv,
               layer7_attn_state_kv_buffer.contents,
               layer3_compressor_state_bytes);
        memcpy(layer7_attn_state_score,
               layer7_attn_state_score_buffer.contents,
               layer3_compressor_state_bytes);
        memcpy(layer7_kqv_out_row0,
               layer7_kqv_out_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer7_kqv_back_row0,
               layer7_kqv_back_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer7_attn_low_row0,
               layer7_attn_low_row0_buffer.contents,
               8u*output_rank*sizeof(float));
        memcpy(layer7_attention_output,
               layer7_attention_output_buffer.contents, output_bytes);
        memcpy(layer7_after_attention_hc,
               layer7_after_attention_hc_buffer.contents, hc_bytes);
        memcpy(layer7_after_ffn_hc,
               layer7_after_ffn_hc_buffer.contents, hc_bytes);
        memcpy(layer7_ffn_cur_final_tile,
               (const uint8_t *)layer7_ffn_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer7_ffn_norm_final_tile,
               (const uint8_t *)layer7_ffn_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer7_router_selected_final_tile,
               (const uint8_t *)layer7_router_selected_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(int32_t));
        memcpy(layer7_router_weights_final_tile,
               (const uint8_t *)layer7_router_weights_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(float));
        memcpy(layer7_routed_out_final_tile,
               (const uint8_t *)layer7_routed_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer7_shared_out_final_tile,
               (const uint8_t *)layer7_shared_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer8_hc_attn_pre_final_tile,
               (const uint8_t *)layer8_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer8_attn_norm_final_tile,
               (const uint8_t *)layer8_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer8_q_lora_final_tile,
               (const uint8_t *)layer8_q_lora_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer8_q_lora_norm_final_tile,
               (const uint8_t *)layer8_q_norm_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer8_kv_raw_final_tile,
               (const uint8_t *)layer8_kv_raw_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer8_kv_norm_final_tile,
               (const uint8_t *)layer8_kv_norm_snapshot_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer8_q_raw_final_tile,
               (const uint8_t *)layer8_q_raw_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer8_q_cur_final_tile,
               (const uint8_t *)layer8_q_cur_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer8_kv_rope_final_tile,
               (const uint8_t *)layer8_kv_rope_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer8_kv_cur_final_tile,
               (const uint8_t *)layer8_kv_norm_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer8_attn_compressed,
               layer8_attn_compressed_buffer.contents,
               layer4_attn_compressed_bytes);
        memcpy(layer8_attn_state_kv,
               layer8_attn_state_kv_buffer.contents, layer4_attn_state_bytes);
        memcpy(layer8_attn_state_score,
               layer8_attn_state_score_buffer.contents, layer4_attn_state_bytes);
        memcpy(layer8_indexer_compressed,
               layer8_indexer_compressed_buffer.contents,
               layer4_indexer_compressed_bytes);
        memcpy(layer8_indexer_state_kv,
               layer8_indexer_state_kv_buffer.contents,
               layer4_indexer_state_bytes);
        memcpy(layer8_indexer_state_score,
               layer8_indexer_state_score_buffer.contents,
               layer4_indexer_state_bytes);
        memcpy(layer8_kqv_out_row0,
               layer8_kqv_out_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer8_kqv_back_row0,
               layer8_kqv_back_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer8_attn_low_row0,
               layer8_attn_low_row0_buffer.contents,
               8u*output_rank*sizeof(float));
        memcpy(layer8_attention_output,
               layer8_attention_output_buffer.contents, output_bytes);
        memcpy(layer8_after_attention_hc,
               layer8_after_attention_hc_buffer.contents, hc_bytes);
        memcpy(layer8_after_ffn_hc,
               layer8_after_ffn_hc_buffer.contents, hc_bytes);
        memcpy(layer8_ffn_cur_final_tile,
               (const uint8_t *)layer8_ffn_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer8_ffn_norm_final_tile,
               (const uint8_t *)layer8_ffn_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer8_router_selected_final_tile,
               (const uint8_t *)layer8_router_selected_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(int32_t));
        memcpy(layer8_router_weights_final_tile,
               (const uint8_t *)layer8_router_weights_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(float));
        memcpy(layer8_routed_out_final_tile,
               (const uint8_t *)layer8_routed_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer8_shared_out_final_tile,
               (const uint8_t *)layer8_shared_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));

        memcpy(layer9_hc_attn_pre_final_tile,
               (const uint8_t *)layer9_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer9_attn_norm_final_tile,
               (const uint8_t *)layer9_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer9_q_lora_final_tile,
               (const uint8_t *)layer9_q_lora_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer9_q_lora_norm_final_tile,
               (const uint8_t *)layer9_q_norm_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer9_kv_raw_final_tile,
               (const uint8_t *)layer9_kv_raw_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer9_kv_norm_final_tile,
               (const uint8_t *)layer9_kv_norm_snapshot_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer9_q_raw_final_tile,
               (const uint8_t *)layer9_q_raw_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer9_q_cur_final_tile,
               (const uint8_t *)layer9_q_cur_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer9_kv_rope_final_tile,
               (const uint8_t *)layer9_kv_rope_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer9_kv_cur_final_tile,
               (const uint8_t *)layer9_kv_norm_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer9_attn_compressed,
               layer9_attn_compressed_buffer.contents, layer3_compressed_bytes);
        memcpy(layer9_attn_state_kv,
               layer9_attn_state_kv_buffer.contents,
               layer3_compressor_state_bytes);
        memcpy(layer9_attn_state_score,
               layer9_attn_state_score_buffer.contents,
               layer3_compressor_state_bytes);
        memcpy(layer9_kqv_out_row0,
               layer9_kqv_out_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer9_kqv_back_row0,
               layer9_kqv_back_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer9_attn_low_row0,
               layer9_attn_low_row0_buffer.contents,
               8u*output_rank*sizeof(float));
        memcpy(layer9_attention_output,
               layer9_attention_output_buffer.contents, output_bytes);
        memcpy(layer9_after_attention_hc,
               layer9_after_attention_hc_buffer.contents, hc_bytes);
        memcpy(layer9_after_ffn_hc,
               layer9_after_ffn_hc_buffer.contents, hc_bytes);
        memcpy(layer9_ffn_cur_final_tile,
               (const uint8_t *)layer9_ffn_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer9_ffn_norm_final_tile,
               (const uint8_t *)layer9_ffn_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer9_router_selected_final_tile,
               (const uint8_t *)layer9_router_selected_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(int32_t));
        memcpy(layer9_router_weights_final_tile,
               (const uint8_t *)layer9_router_weights_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(float));
        memcpy(layer9_routed_out_final_tile,
               (const uint8_t *)layer9_routed_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer9_shared_out_final_tile,
               (const uint8_t *)layer9_shared_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer10_hc_attn_pre_final_tile,
               (const uint8_t *)layer10_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer10_attn_norm_final_tile,
               (const uint8_t *)layer10_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer10_q_lora_final_tile,
               (const uint8_t *)layer10_q_lora_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer10_q_lora_norm_final_tile,
               (const uint8_t *)layer10_q_norm_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer10_kv_raw_final_tile,
               (const uint8_t *)layer10_kv_raw_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer10_kv_norm_final_tile,
               (const uint8_t *)layer10_kv_norm_snapshot_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer10_q_raw_final_tile,
               (const uint8_t *)layer10_q_raw_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer10_q_cur_final_tile,
               (const uint8_t *)layer10_q_cur_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer10_kv_rope_final_tile,
               (const uint8_t *)layer10_kv_rope_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer10_kv_cur_final_tile,
               (const uint8_t *)layer10_kv_norm_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer10_attn_compressed,
               layer10_attn_compressed_buffer.contents,
               layer4_attn_compressed_bytes);
        memcpy(layer10_attn_state_kv,
               layer10_attn_state_kv_buffer.contents, layer4_attn_state_bytes);
        memcpy(layer10_attn_state_score,
               layer10_attn_state_score_buffer.contents, layer4_attn_state_bytes);
        memcpy(layer10_indexer_compressed,
               layer10_indexer_compressed_buffer.contents,
               layer4_indexer_compressed_bytes);
        memcpy(layer10_indexer_state_kv,
               layer10_indexer_state_kv_buffer.contents,
               layer4_indexer_state_bytes);
        memcpy(layer10_indexer_state_score,
               layer10_indexer_state_score_buffer.contents,
               layer4_indexer_state_bytes);
        memcpy(layer10_kqv_out_row0,
               layer10_kqv_out_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer10_kqv_back_row0,
               layer10_kqv_back_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer10_attn_low_row0,
               layer10_attn_low_row0_buffer.contents,
               8u*output_rank*sizeof(float));
        memcpy(layer10_attention_output,
               layer10_attention_output_buffer.contents, output_bytes);
        memcpy(layer10_after_attention_hc,
               layer10_after_attention_hc_buffer.contents, hc_bytes);
        memcpy(layer10_after_ffn_hc,
               layer10_after_ffn_hc_buffer.contents, hc_bytes);
        memcpy(layer10_ffn_cur_final_tile,
               (const uint8_t *)layer10_ffn_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer10_ffn_norm_final_tile,
               (const uint8_t *)layer10_ffn_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer10_router_selected_final_tile,
               (const uint8_t *)layer10_router_selected_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(int32_t));
        memcpy(layer10_router_weights_final_tile,
               (const uint8_t *)layer10_router_weights_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(float));
        memcpy(layer10_routed_out_final_tile,
               (const uint8_t *)layer10_routed_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer10_shared_out_final_tile,
               (const uint8_t *)layer10_shared_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));


        memcpy(layer11_hc_attn_pre_final_tile,
               (const uint8_t *)layer11_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer11_attn_norm_final_tile,
               (const uint8_t *)layer11_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer11_q_lora_final_tile,
               (const uint8_t *)layer11_q_lora_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer11_q_lora_norm_final_tile,
               (const uint8_t *)layer11_q_norm_buffer.contents+
                   layer4_q_rank_final_tile_offset,
               32u*1024u*sizeof(float));
        memcpy(layer11_kv_raw_final_tile,
               (const uint8_t *)layer11_kv_raw_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer11_kv_norm_final_tile,
               (const uint8_t *)layer11_kv_norm_snapshot_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer11_q_raw_final_tile,
               (const uint8_t *)layer11_q_raw_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer11_q_cur_final_tile,
               (const uint8_t *)layer11_q_cur_buffer.contents+
                   layer3_q_final_tile_offset,
               32u*q_dim*sizeof(float));
        memcpy(layer11_kv_rope_final_tile,
               (const uint8_t *)layer11_kv_rope_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer11_kv_cur_final_tile,
               (const uint8_t *)layer11_kv_norm_buffer.contents+
                   layer4_kv_final_tile_offset,
               32u*512u*sizeof(float));
        memcpy(layer11_attn_compressed,
               layer11_attn_compressed_buffer.contents, layer3_compressed_bytes);
        memcpy(layer11_attn_state_kv,
               layer11_attn_state_kv_buffer.contents,
               layer3_compressor_state_bytes);
        memcpy(layer11_attn_state_score,
               layer11_attn_state_score_buffer.contents,
               layer3_compressor_state_bytes);
        memcpy(layer11_kqv_out_row0,
               layer11_kqv_out_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer11_kqv_back_row0,
               layer11_kqv_back_row0_buffer.contents, q_dim*sizeof(float));
        memcpy(layer11_attn_low_row0,
               layer11_attn_low_row0_buffer.contents,
               8u*output_rank*sizeof(float));
        memcpy(layer11_attention_output,
               layer11_attention_output_buffer.contents, output_bytes);
        memcpy(layer11_after_attention_hc,
               layer11_after_attention_hc_buffer.contents, hc_bytes);
        memcpy(layer11_after_ffn_hc,
               layer11_after_ffn_hc_buffer.contents, hc_bytes);
        memcpy(layer11_ffn_cur_final_tile,
               (const uint8_t *)layer11_ffn_cur_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer11_ffn_norm_final_tile,
               (const uint8_t *)layer11_ffn_norm_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer11_router_selected_final_tile,
               (const uint8_t *)layer11_router_selected_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(int32_t));
        memcpy(layer11_router_weights_final_tile,
               (const uint8_t *)layer11_router_weights_buffer.contents+
                   final_selected_offset,
               32u*6u*sizeof(float));
        memcpy(layer11_routed_out_final_tile,
               (const uint8_t *)layer11_routed_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        memcpy(layer11_shared_out_final_tile,
               (const uint8_t *)layer11_shared_out_buffer.contents+final_tile_offset,
               32u*n_embd*sizeof(float));
        uint32_t pointer_matches = 0;
        for (uint32_t index = 0; index < 284u; index++) {
            pointer_matches += matches[index] ? 1u : 0u;
        ...
        result->dispatches = 547u;
        result->wrapped_model_ranges = 284u;
        result->pointer_matches = pointer_matches;
        result->layer3_compressed_kv_rows = layer3_compressed_rows;
        result->wall_ms = wall_end-wall_start;
        result->gpu_ms = gpu_elapsed_ms(command);
        context.prefillLayer3FullQ = layer3_q_cur_buffer;
        ...
        context.prefillLayer3AfterAttentionHc =
            layer3_after_attention_hc_buffer;
        context.prefillLayer3AfterFfnHc = layer3_after_ffn_hc_buffer;
        context.prefillLayer4FullQ = layer4_q_cur_buffer;
        context.prefillLayer4FullKv = layer4_kv_norm_buffer;
        context.prefillLayer4InputHc = layer3_after_ffn_hc_buffer;
        context.prefillLayer4AttnSplit = layer4_split_buffer;
        context.prefillLayer4AttnCompressed = layer4_attn_compressed_buffer;
        context.prefillLayer4AttnStateKv = layer4_attn_state_kv_buffer;
        context.prefillLayer4AttnStateScore = layer4_attn_state_score_buffer;
        context.prefillLayer4IndexerCompressed = layer4_indexer_compressed_buffer;
        context.prefillLayer4IndexerStateKv = layer4_indexer_state_kv_buffer;
        context.prefillLayer4IndexerStateScore = layer4_indexer_state_score_buffer;
        context.prefillLayer4AfterAttentionHc = layer4_after_attention_hc_buffer;
        context.prefillLayer4AfterFfnHc = layer4_after_ffn_hc_buffer;
        context.prefillLayer5FullQ = layer5_q_cur_buffer;
        context.prefillLayer5FullKv = layer5_kv_norm_buffer;
        context.prefillLayer5InputHc = layer4_after_ffn_hc_buffer;
        context.prefillLayer5AttnSplit = layer5_split_buffer;
        context.prefillLayer5AttnCompressed = layer5_attn_compressed_buffer;
        context.prefillLayer5AttnStateKv = layer5_attn_state_kv_buffer;
        context.prefillLayer5AttnStateScore = layer5_attn_state_score_buffer;
        context.prefillLayer5AfterAttentionHc =
            layer5_after_attention_hc_buffer;
        context.prefillLayer5AfterFfnHc = layer5_after_ffn_hc_buffer;
        context.prefillLayer6FullQ = layer6_q_cur_buffer;
        ...
        context.prefillLayer6AfterAttentionHc = layer6_after_attention_hc_buffer;
        context.prefillLayer6AfterFfnHc = layer6_after_ffn_hc_buffer;
        context.prefillLayer7FullQ = layer7_q_cur_buffer;
        context.prefillLayer7FullKv = layer7_kv_norm_buffer;
        context.prefillLayer7InputHc = layer6_after_ffn_hc_buffer;
        context.prefillLayer7AttnSplit = layer7_split_buffer;
        context.prefillLayer7AttnCompressed = layer7_attn_compressed_buffer;
        context.prefillLayer7AttnStateKv = layer7_attn_state_kv_buffer;
        context.prefillLayer7AttnStateScore = layer7_attn_state_score_buffer;
        context.prefillLayer7AfterAttentionHc =
            layer7_after_attention_hc_buffer;
        context.prefillLayer7AfterFfnHc = layer7_after_ffn_hc_buffer;
        context.prefillLayer8FullQ = layer8_q_cur_buffer;
        context.prefillLayer8FullKv = layer8_kv_norm_buffer;
        context.prefillLayer8InputHc = layer7_after_ffn_hc_buffer;
        context.prefillLayer8AttnSplit = layer8_split_buffer;
        context.prefillLayer8AttnCompressed = layer8_attn_compressed_buffer;
        context.prefillLayer8AttnStateKv = layer8_attn_state_kv_buffer;
        context.prefillLayer8AttnStateScore = layer8_attn_state_score_buffer;
        context.prefillLayer8IndexerCompressed = layer8_indexer_compressed_buffer;
        context.prefillLayer8IndexerStateKv = layer8_indexer_state_kv_buffer;
        context.prefillLayer8IndexerStateScore = layer8_indexer_state_score_buffer;
        context.prefillLayer8AfterAttentionHc = layer8_after_attention_hc_buffer;
        context.prefillLayer8AfterFfnHc = layer8_after_ffn_hc_buffer;
        context.prefillLayer9FullQ = layer9_q_cur_buffer;
        context.prefillLayer9FullKv = layer9_kv_norm_buffer;
        context.prefillLayer9InputHc = layer8_after_ffn_hc_buffer;
        context.prefillLayer9AttnSplit = layer9_split_buffer;
        context.prefillLayer9AttnCompressed = layer9_attn_compressed_buffer;
        context.prefillLayer9AttnStateKv = layer9_attn_state_kv_buffer;
        context.prefillLayer9AttnStateScore = layer9_attn_state_score_buffer;
        context.prefillLayer9AfterAttentionHc =
            layer9_after_attention_hc_buffer;
        context.prefillLayer9AfterFfnHc = layer9_after_ffn_hc_buffer;
        context.prefillLayer10FullQ = layer10_q_cur_buffer;
        context.prefillLayer10FullKv = layer10_kv_norm_buffer;
        context.prefillLayer10InputHc = layer9_after_ffn_hc_buffer;
        context.prefillLayer10AttnSplit = layer10_split_buffer;
        context.prefillLayer10AttnCompressed = layer10_attn_compressed_buffer;
        context.prefillLayer10AttnStateKv = layer10_attn_state_kv_buffer;
        context.prefillLayer10AttnStateScore = layer10_attn_state_score_buffer;
        context.prefillLayer10IndexerCompressed = layer10_indexer_compressed_buffer;
        context.prefillLayer10IndexerStateKv = layer10_indexer_state_kv_buffer;
        context.prefillLayer10IndexerStateScore = layer10_indexer_state_score_buffer;
        context.prefillLayer10AfterAttentionHc = layer10_after_attention_hc_buffer;
        context.prefillLayer10AfterFfnHc = layer10_after_ffn_hc_buffer;
        context.prefillLayer11FullQ = layer11_q_cur_buffer;
        context.prefillLayer11FullKv = layer11_kv_norm_buffer;
        context.prefillLayer11InputHc = layer10_after_ffn_hc_buffer;
        context.prefillLayer11AttnSplit = layer11_split_buffer;
        context.prefillLayer11AttnCompressed = layer11_attn_compressed_buffer;
        context.prefillLayer11AttnStateKv = layer11_attn_state_kv_buffer;
        context.prefillLayer11AttnStateScore = layer11_attn_state_score_buffer;
        context.prefillLayer11AfterAttentionHc =
            layer11_after_attention_hc_buffer;
        context.prefillLayer11AfterFfnHc = layer11_after_ffn_hc_buffer;
        return 1;
    }
}
    ...
    const rust_star_metal_layer0_extension *layer0)
{
    ...
    const uint32_t compressed_cache_rows = compressed_layer
        ? (position + 1u) / compressor_ratio : 0u;
    const BOOL sparse_indexed_attention = indexer_layer && compressed_cache_rows > 1024u;
    ...
    if (sparse_indexed_attention &&
        (layer0->indexer_q_bytes != 1024ull*8192ull*sizeof(uint16_t) ||
         layer0->indexer_weight_bytes != 4096ull*64ull*sizeof(uint16_t))) {
        return fail_with_message(error, error_bytes, @"sparse indexer projection tensor shapes are invalid");
    }
    ...
    @autoreleasepool {
        ...
        NSUInteger sparse_indexer_inner[2] = {0};
        id<MTLBuffer> sparse_indexer_q_weight = nil, sparse_indexer_weight = nil;
        if (extended) {
        ...
        if (sparse_indexed_attention) {
            sparse_indexer_q_weight = wrap_model_range(
                context, model_mapping, model_bytes,
                layer0->indexer_q_offset, layer0->indexer_q_bytes,
                &sparse_indexer_inner[0], &matches[33], error, error_bytes);
            sparse_indexer_weight = wrap_model_range(
                context, model_mapping, model_bytes,
                layer0->indexer_weight_offset, layer0->indexer_weight_bytes,
                &sparse_indexer_inner[1], &matches[34], error, error_bytes);
            if (!sparse_indexer_q_weight || !sparse_indexer_weight) return 0;
        }
        ...
        const NSUInteger sparse_partial_bytes = 64u*512u*12u*sizeof(float);
        const NSUInteger sparse_stats_bytes = 64u*12u*2u*sizeof(float);
        id<MTLBuffer> sparse_indexer_q = sparse_indexed_attention ? persistent_buffer(context, layer_buffer_key(@"sparse_indexer_q", YES, layer0->layer_index), 64u*128u*sizeof(float), error, error_bytes) : nil;
        ...
        if (sparse_indexed_attention && (!sparse_indexer_q || !sparse_indexer_weights ||
            !sparse_indexer_scores || !sparse_indexer_topk ||
            !sparse_indexer_topk_scratch || !sparse_attention_tmp)) {
            return fail_with_message(error, error_bytes, @"failed to allocate sparse indexed-attention state");
        }
        ...
        rust_star_q8_mv_args sparse_indexer_q_projection = {
            ...
            .nb02=layer0->indexer_q_bytes, .nb03=layer0->indexer_q_bytes,
            .ne10=1024, .ne11=1, .ne12=1,
            .nb10=sizeof(float), .nb11=1024u*sizeof(float),
            .nb12=1024u*sizeof(float), .nb13=1024u*sizeof(float),
            .ne0=8192, .ne1=1, .nr0=2, .r2=1, .r3=1,
        };
        rust_star_q8_mv_args sparse_indexer_weight_projection = {
            .ne00=4096, .ne01=64, .ne02=1,
            .nb00=sizeof(uint16_t), .nb01=4096ull*sizeof(uint16_t),
            .nb02=layer0->indexer_weight_bytes, .nb03=layer0->indexer_weight_bytes,
            .ne10=4096, .ne11=1, .ne12=1,
            .nb10=sizeof(float), .nb11=4096u*sizeof(float),
            .nb12=4096u*sizeof(float), .nb13=4096u*sizeof(float),
            .ne0=64, .ne1=1, .nr0=2, .r2=1, .r3=1,
        };
        rust_star_rope_tail_args sparse_indexer_rope = {
            .ne00=128, .ne01=64, .ne02=1, .ne03=1,
            .nb00=sizeof(float), .nb01=128u*sizeof(float),
            .nb02=8192u*sizeof(float), .nb03=8192u*sizeof(float),
            .nb0=sizeof(float), .nb1=128u*sizeof(float),
            .nb2=8192u*sizeof(float), .nb3=8192u*sizeof(float),
            .n_dims=64, .mode=0, .n_ctx_orig=65536, .inverse=0,
            .freq_base=160000.0f, .freq_scale=1.0f/16.0f,
            .ext_factor=1.0f, .attn_factor=1.0f/(1.0f+0.1f*logf(16.0f)),
            .beta_fast=32.0f, .beta_slow=1.0f, .src2=false,
        };
        rust_star_indexer_qat_args sparse_indexer_qat = {
            .n_rows=64, .head_dim=128, .row_stride=128u*sizeof(float),
        };
        rust_star_indexer_score_args sparse_score_args = {
            .n_comp=compressed_cache_rows, .n_tokens=1, .n_head=64, .head_dim=128,
            .pos0=position, .ratio=4,
            .q_token_stride=8192u*sizeof(float), .q_head_stride=128u*sizeof(float),
            .weights_token_stride=64u*sizeof(float),
            .index_row_stride=128u*sizeof(float),
            .score_token_stride=(uint64_t)compressed_cache_rows*sizeof(float),
            .scale=1.0f/sqrtf(8192.0f),
        };
        rust_star_argsort_args sparse_sort_args = {
            .ne00=(int32_t)compressed_cache_rows, .ne01=1, .ne02=1, .ne03=1,
        ...
        rust_star_indexed_attention_args sparse_attention_args = {
            ...
            .n_raw=visible_cache_rows, .raw_cap=cache_capacity_rows,
            .raw_start=raw_cache_start, .n_comp=compressed_cache_rows,
            .top_k=512, .pos0=position, .window=128, .ratio=4,
            .comp_kv_f16=1, .n_splits=12,
            .q_token_stride=32768u*sizeof(float),
            .q_head_stride=512u*sizeof(float),
            .raw_row_stride=512u*sizeof(float),
            .comp_row_stride=512u*sizeof(uint16_t),
            .topk_token_stride=512u*sizeof(int32_t),
            .dst_token_stride=32768u*sizeof(float),
            .dst_head_stride=512u*sizeof(float),
        ...
        if (rope_and_store) {
            ...
            if (sparse_indexed_attention && compressor_emit) {
                ...
                if (!sparse_commit) return fail_with_message(error, error_bytes,
                    @"failed to create sparse compressed-cache commit encoder");
                [sparse_commit copyFromBuffer:compressed_kv_buffer sourceOffset:0
                                     toBuffer:compressed_kv_cache
                            destinationOffset:compressed_row*kv_elements*sizeof(float)
                                        size:kv_elements*sizeof(float)];
                [sparse_commit copyFromBuffer:compressed_indexer_buffer sourceOffset:0
            ...
            if (attention_read) {
                ...
                const uint32_t prior_compressed_rows = compressed_cache_rows -
                    (compressor_emit && !sparse_indexed_attention ? 1u : 0u);
                ...
                if (sparse_indexed_attention) {
                    [encoder setComputePipelineState:context.f16ProjectionPipeline];
                    [encoder setBytes:&sparse_indexer_q_projection
                               length:sizeof(sparse_indexer_q_projection) atIndex:0];
                    [encoder setBuffer:sparse_indexer_q_weight
                                offset:sparse_indexer_inner[0] atIndex:1];
                    [encoder setBuffer:q_norm_buffer offset:0 atIndex:2];
                    [encoder setBuffer:sparse_indexer_q offset:0 atIndex:3];
                    [encoder setThreadgroupMemoryLength:32u*2u*sizeof(float) atIndex:0];
                    [encoder dispatchThreadgroups:MTLSizeMake(4096,1,1)
                         threadsPerThreadgroup:MTLSizeMake(32,8,1)];

                    [encoder setComputePipelineState:context.ropeTailPipeline];
                    [encoder setBytes:&sparse_indexer_rope
                               length:sizeof(sparse_indexer_rope) atIndex:0];
                    int32_t sparse_position = (int32_t)position;
                    [encoder setBuffer:sparse_indexer_q offset:0 atIndex:1];
                    [encoder setBytes:&sparse_position length:sizeof(sparse_position) atIndex:2];
                    [encoder setBuffer:sparse_indexer_q offset:0 atIndex:3];
                    [encoder setBuffer:sparse_indexer_q offset:0 atIndex:4];
                    [encoder dispatchThreadgroups:MTLSizeMake(64,1,1)
                         threadsPerThreadgroup:MTLSizeMake(128,1,1)];

                    [encoder setComputePipelineState:context.indexerQatPipeline];
                    [encoder setBytes:&sparse_indexer_qat
                               length:sizeof(sparse_indexer_qat) atIndex:0];
                    [encoder setBuffer:sparse_indexer_q offset:0 atIndex:1];
                    [encoder setThreadgroupMemoryLength:256u*sizeof(float) atIndex:0];
                    [encoder dispatchThreadgroups:MTLSizeMake(64,1,1)
                         threadsPerThreadgroup:MTLSizeMake(128,1,1)];
                    ...
                    [encoder setComputePipelineState:context.f16ProjectionPipeline];
                    [encoder setBytes:&sparse_indexer_weight_projection
                               length:sizeof(sparse_indexer_weight_projection) atIndex:0];
                    [encoder setBuffer:sparse_indexer_weight
                                offset:sparse_indexer_inner[1] atIndex:1];
                    [encoder setBuffer:norm_buffer offset:0 atIndex:2];
                    [encoder setBuffer:sparse_indexer_weights offset:0 atIndex:3];
                    [encoder setThreadgroupMemoryLength:32u*2u*sizeof(float) atIndex:0];
                    [encoder dispatchThreadgroups:MTLSizeMake(32,1,1)
                         threadsPerThreadgroup:MTLSizeMake(32,8,1)];

                    [encoder setComputePipelineState:context.indexerScorePipeline];
                    [encoder setBytes:&sparse_score_args length:sizeof(sparse_score_args) atIndex:0];
                    [encoder setBuffer:sparse_indexer_q offset:0 atIndex:1];
                    [encoder setBuffer:sparse_indexer_weights offset:0 atIndex:2];
                    [encoder setBuffer:compressed_indexer_cache offset:0 atIndex:3];
                    [encoder setBuffer:sparse_indexer_scores offset:0 atIndex:4];
                    [encoder setThreadgroupMemoryLength:(128u+4u)*sizeof(float) atIndex:0];
                    [encoder dispatchThreadgroups:MTLSizeMake(compressed_cache_rows,1,1)
                         threadsPerThreadgroup:MTLSizeMake(128,1,1)];
                    ...
                    [encoder setBuffer:staged_kv_buffer
                                 offset:visible_cache_rows*kv_elements*sizeof(uint16_t)
                                atIndex:3];
                    [encoder setBuffer:sparse_indexer_topk offset:0 atIndex:4];
                    [encoder setBuffer:sparse_attention_tmp offset:0 atIndex:5];
                    [encoder setThreadgroupMemoryLength:16u*128u*sizeof(uint16_t)*4u atIndex:0];
                    [encoder dispatchThreadgroups:MTLSizeMake(1,8,12)
                         threadsPerThreadgroup:MTLSizeMake(32,8,1)];

                    [encoder setComputePipelineState:context.indexedAttentionReducePipeline];
                    [encoder setBytes:&sparse_attention_args length:sizeof(sparse_attention_args) atIndex:0];
                    [encoder setBuffer:sparse_attention_tmp offset:0 atIndex:1];
                    [encoder setBuffer:sinks_weights offset:sinks_inner atIndex:2];
                    [encoder setBuffer:attention_raw_buffer offset:0 atIndex:3];
                    [encoder dispatchThreadgroups:MTLSizeMake(64,1,1)
                         threadsPerThreadgroup:MTLSizeMake(32,4,1)];
                } else {
        ...
        if (chained_submission) {
            ...
            result->wrapped_model_ranges = 25u + (compressed_layer ? 4u : 0u) +
                (indexer_layer ? 4u : 0u) + (sparse_indexed_attention ? 2u : 0u);
        ...
        result->wrapped_model_ranges = full_layer
            ? 25u + (compressed_layer ? 4u : 0u) + (indexer_layer ? 4u : 0u) +
                (sparse_indexed_attention ? 2u : 0u) :
    ...
    BOOL create_predecessors)
{
    ...
    @autoreleasepool {
        RustStarMetalContext *context = (__bridge RustStarMetalContext *)opaque_context;
        id<MTLBuffer> prior_hc = seed_input_hc ? persistent_buffer(
            context, layer_buffer_key(@"layer_hc_state", YES, layer_index-1u),
            4u*4096u*sizeof(float), error, error_bytes) : nil;
        ...
        id<MTLBuffer> indexer_state_score = persistent_buffer(
            ...
            8u*256u*sizeof(float), error, error_bytes);
        if ((seed_input_hc && !prior_hc) || !raw_cache || !attention_cache || !indexer_cache ||
        ...
        /* The legacy layer-2-only diagnostic requires contiguous lower-layer
         * command ownership. When requested, two empty queue-ordered
         * predecessors represent its captured HC boundary without pretending
         * that layers 0 and 1 executed. */
        if (create_predecessors) {
            [context.chainedCommands removeAllObjects];
            [context.chainedWallStarts removeAllObjects];
            context.chainedReady = NO;
            context.chainedWallEnd = 0.0;
...
static int seed_retained_raw_cache_prior(
    void *opaque_context,
    uint32_t layer_index,
    uint32_t position,
    const float *raw_cache_prior,
    ...
    size_t error_bytes)
{
    const uint32_t raw_capacity_rows = 128u;
    const uint32_t prior_raw_rows = 127u;
    if (!opaque_context || !raw_cache_prior || layer_index >= 2u) {
        return fail_with_message(error, error_bytes,
            @"retained predecessor raw-cache seed received invalid inputs");
    }
    @autoreleasepool {
        RustStarMetalContext *context = (__bridge RustStarMetalContext *)opaque_context;
        id<MTLBuffer> raw_cache = persistent_buffer(
        ...
        if (!raw_cache) {
            if (error && error_bytes != 0u && error[0] != '\0') return 0;
            return fail_with_message(error, error_bytes,
                @"retained predecessor raw-cache seed could not allocate state");
        }
        memset(raw_cache.contents, 0, raw_capacity_rows*512u*sizeof(float));
        for (uint32_t row = 0; row < prior_raw_rows; row++) {
            const uint32_t logical_position = position-prior_raw_rows+row;
...
int rust_star_metal_seed_retained_sparse_layers012_position8195(
    ...
    size_t error_bytes)
{
    if (!seed_retained_sparse_layer2_boundary(
            opaque_context, 8195u, 2048u, 2051u, NULL,
            layer2_raw_cache_prior, attention_compressed_prior,
            indexer_compressed_prior, attention_state_kv_pre,
            attention_state_score_pre, indexer_state_kv_pre,
            indexer_state_score_pre, error, error_bytes, NO, NO)) {
        return 0;
    }
    if (!seed_retained_raw_cache_prior(
            opaque_context, 0u, 8195u, layer0_raw_cache_prior,
            error, error_bytes)) {
        return 0;
    }
    return seed_retained_raw_cache_prior(
        opaque_context, 1u, 8195u, layer1_raw_cache_prior,
        error, error_bytes);
}
    ...
    size_t error_bytes)
{
    ...
    if (!((position == 2051u && compressed_rows == 513u) ||
          (position == 4099u && compressed_rows == 1025u))) {
        return fail_with_message(error, error_bytes,
            @"sparse indexed-attention fixture geometry is unsupported");
    }
    ...
    @autoreleasepool {
        ...
        const BOOL topk_needs_merge = compressed_rows > 1024u;
        const uint32_t topk_work_width = topk_needs_merge ? top_k + 1u : top_k;
        const NSUInteger topk_scratch_bytes = topk_work_width*sizeof(int32_t);
...
#define RS_NEW_OUTPUT(name, bytes) \
        ...
        RS_NEW_OUTPUT(topk_scratch_buffer, topk_scratch_bytes);
...
#undef RS_NEW_OUTPUT
        if (!q_lora_buffer || !attn_norm_buffer || !q_buffer || !raw_buffer ||
            ...
            !topk_buffer || !topk_scratch_buffer || !attention_buffer ||
            !back_buffer || !tmp_buffer) {
        ...
        rust_star_argsort_args sort_args = {
            ...
            .ne0=topk_work_width, .ne1=1, .ne2=1, .ne3=1, .top_k=top_k,
        };
        rust_star_argsort_merge_args merge_args = {
            .ne00=compressed_rows, .ne01=1, .ne02=1, .ne03=1,
            .nb00=sizeof(float), .nb01=score_bytes,
            .nb02=score_bytes, .nb03=score_bytes,
            .ne0=topk_work_width, .ne1=1, .ne2=1, .ne3=1,
            .top_k=top_k, .len=top_k,
        };
        ...
        [encoder setBuffer:topk_needs_merge ? topk_scratch_buffer : topk_buffer
                        offset:0 atIndex:2];
        [encoder setThreadgroupMemoryLength:1024u*(sizeof(int32_t)+sizeof(float)) atIndex:0];
        [encoder dispatchThreadgroups:MTLSizeMake(topk_needs_merge ? 2u : 1u,1,1)
             threadsPerThreadgroup:MTLSizeMake(1024,1,1)];
        ...
        if (topk_needs_merge) {
            ...
            [encoder setBuffer:score_buffer offset:0 atIndex:1];
            [encoder setBuffer:topk_scratch_buffer offset:0 atIndex:2];
            [encoder setBuffer:topk_buffer offset:0 atIndex:3];
            [encoder dispatchThreadgroups:MTLSizeMake(1,1,1)
        ...
        result->top_k = top_k;
        result->dispatches = topk_needs_merge ? 11 : 10;
