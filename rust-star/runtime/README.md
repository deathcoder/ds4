...
To complete native 2K prefill through layer 22:
...
attention/indexer compressors, dense mixed attention, routed/shared FFN, and
additive final HC update. Every retained layer-7 through layer-22 boundary,
full attention output, compressor state, and full HC identity matches fresh
DwarfStar processes exactly. The combined terminal schedule uses 1,202
dispatches and 616/616 no-copy model views.

Exactly 512 layer-2/layer-4/layer-6/layer-8/layer-10/layer-12/layer-14/layer-16/layer-18/layer-20/layer-22
compressed rows still use the dense path; each odd compressed layer through
layer 21 retains 16 ratio-128 rows. The pinned default
remains dense through 1,024 rows; sparse top-k first
applies at 1,025 rows. Layer-23 prefill, sparse post-prompt integration,
