...
`rust-star-long-prefill-continuation-bootstrap-probe-v23`. The same retained
...
complete retained layers 2 through 8, but not layers 9--42, the complete 8K transformer,
