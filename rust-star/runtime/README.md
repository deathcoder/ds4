...
To complete native 2K prefill through layer 23:
...
ratio-128 compressor, dense mixed attention, routed/shared FFN, and additive
final HC update. Every retained layer-7 through layer-23 boundary,
full attention output, compressor state, and full HC identity matches fresh
DwarfStar processes exactly. The combined terminal schedule uses 1,249
dispatches and 644/644 no-copy model views.
...
layer 23 retains 16 ratio-128 rows. The pinned default
remains dense through 1,024 rows; sparse top-k first
applies at 1,025 rows. Layer-24 prefill, sparse post-prompt integration,
