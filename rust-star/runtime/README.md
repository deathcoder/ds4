...
To complete native 2K prefill through layer 20:
...
attention/indexer compressors, dense mixed attention, routed/shared FFN, and
additive final HC update. Every retained layer-7 through layer-20 boundary,
full attention output, compressor state, and full HC identity matches fresh
DwarfStar processes exactly. The combined terminal schedule uses 1,085
dispatches and 556/556 no-copy model views.
...
applies at 1,025 rows. Layer-21 prefill, sparse post-prompt integration,
