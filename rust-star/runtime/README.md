...
attention/indexer compressors, dense mixed attention, routed/shared FFN, and
additive final HC update. Every retained layer-7 through layer-28 boundary,
full attention output, compressor state, and full HC identity matches fresh
DwarfStar processes exactly. The combined terminal schedule uses 1,553
dispatches and 796/796 no-copy model views.
...
applies at 1,025 rows. Layer-29 prefill, sparse post-prompt integration,
