...
To complete native 2K prefill through layer 21:
...
ratio-128 compressor, dense mixed attention, routed/shared FFN, and additive
final HC update. Every retained layer-7 through layer-21 boundary,
full attention output, compressor state, and full HC identity matches fresh
DwarfStar processes exactly. The combined terminal schedule uses 1,132
dispatches and 584/584 no-copy model views.

Exactly 512 layer-2/layer-4/layer-6/layer-8/layer-10/layer-12/layer-14/layer-16/layer-18/layer-20
...
applies at 1,025 rows. Layer-22 prefill, sparse post-prompt integration,
