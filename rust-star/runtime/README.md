...
To complete native 2K prefill through layer 16:
...
attention/indexer compressors, dense mixed attention, routed/shared FFN, and
additive final HC update. Every retained layer-7 through layer-16 boundary,
full attention output, compressor state, and full HC identity matches fresh
DwarfStar processes exactly. The combined terminal schedule uses 851
dispatches and 436/436 no-copy model views.

Exactly 512 layer-2/layer-4/layer-6/layer-8/layer-10/layer-12/layer-14/layer-16
...
applies at 1,025 rows. Layer-17 prefill, sparse post-prompt integration,
