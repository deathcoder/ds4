...
`rust-star-long-prefill-continuation-bootstrap-probe-v19`. The same retained
...
captures. The report therefore claims complete layer 5, but not layers 6--42, the
