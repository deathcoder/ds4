...
To complete native 2K prefill through layer 39:
...
ratio-128 compressor, dense mixed attention, routed/shared FFN, and additive
final HC update. Every retained layer-7 through layer-39 boundary, full
attention output, compressor state, and full HC identity matches fresh
DwarfStar processes exactly. The combined terminal schedule uses 2,185
dispatches and 1,124/1,124 no-copy model views.
...
applies at 1,025 rows. Layer-40 prefill, sparse post-prompt integration,
